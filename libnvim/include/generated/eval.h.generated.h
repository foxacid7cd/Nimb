...
DLLEXPORT void var_redir_str(char *value, int value_len);
...
DLLEXPORT int handle_subscript(const char **const arg, typval_T *rettv, int evaluate, int verbose, const char *const start_leader, const char **const end_leaderp);
