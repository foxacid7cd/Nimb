...
DLLEXPORT void nvim_create_user_command(String name, Object command, Dict(user_command) *opts, Error *err) FUNC_API_SINCE(9);
DLLEXPORT void nvim_del_user_command(String name, Error *err) FUNC_API_SINCE(9);
DLLEXPORT void nvim_buf_create_user_command(Buffer buffer, String name, Object command, Dict(user_command) *opts, Error *err) FUNC_API_SINCE(9);
DLLEXPORT void nvim_buf_del_user_command(Buffer buffer, String name, Error *err) FUNC_API_SINCE(9);
DLLEXPORT void create_user_command(String name, Object command, Dict(user_command) *opts, int flags, Error *err);
