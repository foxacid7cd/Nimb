# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/cmdhist.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/cmdhist.c" 2
...
# 7 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/cmdhist.c" 2
...
# 8 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/cmdhist.c" 2
...
# 6 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/cmdhist.h" 2
...
# 9 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/cmdhist.c" 2
...
# 10 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/cmdhist.c" 2
...
# 11 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/cmdhist.c" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/regexp.h" 1
# 12 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/cmdhist.c" 2
...
# 13 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/cmdhist.c" 2
...
# 14 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/cmdhist.c" 2
...
# 15 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/cmdhist.c" 2





static histentry_T *(history[(HIST_DEBUG + 1)]) = { ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0) };
...
{
  (__builtin_expect(!(p_hi >= 0 && p_hi <= 2147483647), 0) ? __assert_rtn(__func__, "cmdhist.c", 115, "p_hi >= 0 && p_hi <= INT_MAX") : (void)0);
  int newlen = (int)p_hi;
  int oldlen = hislen;
  ...
  if (newlen != oldlen) {
    for (int type = 0; type < (HIST_DEBUG + 1); type++) {
      ...
      if (j >= 0) {
        ...
        int l1 = ((j + 1) < (newlen) ? (j + 1) : (newlen));
        int l2 = ((newlen) < (oldlen) ? (newlen) : (oldlen)) - l1;
        int i1 = j + 1 - l1;
        int i2 = ((l1) > (oldlen - newlen + l1) ? (l1) : (oldlen - newlen + l1));


        if (newlen) {

          __builtin___memcpy_chk (&temp[0], &history[type][i2], (size_t)l2 * sizeof(*temp), __builtin_object_size (&temp[0], 0));

          __builtin___memcpy_chk (&temp[l2], &history[type][i1], (size_t)l1 * sizeof(*temp), __builtin_object_size (&temp[l2], 0));
        }
      ...
      int l3 = j < 0 ? 0 : ((newlen) < (oldlen) ? (newlen) : (oldlen));
      if (newlen) {
        __builtin___memset_chk (temp + l3, 0, (size_t)(newlen - l3) * sizeof(*temp), __builtin_object_size (temp + l3, 0));
      }
...
static inline void clear_hist_entry(histentry_T *hisptr)
  FUNC_ATTR_NONNULL_ALL
{
  __builtin___memset_chk ((hisptr), 0, sizeof(*(hisptr)), __builtin_object_size ((hisptr), 0));
}
...
static int in_history(int type, char *str, int move_to_front, int sep)
{
  ...
  int i = hisidx[type];
  do {
    if (history[type][i].hisstr == ((void*)0)) {
      return 0;
    }
  ...
  if (last_i >= 0) {
    ...
    history[type][i].additional_elements = ((void*)0);
    return 1;
  }
  return 0;
}
# 250 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/cmdhist.c"
static HistoryType get_histtype(const char *const name, const size_t len, const _Bool return_default)
  FUNC_ATTR_PURE FUNC_ATTR_WARN_UNUSED_RESULT
{
  ...
  for (HistoryType i = 0; history_names[i] != ((void*)0); i++) {
    if (strncasecmp((char *)(name), (char *)(history_names[i]), (size_t)(len)) == 0) {
      return i;
    }
  }

  if (vim_strchr(":=@>?/", name[0]) != ((void*)0) && len == 1) {
...
void add_to_history(int histype, char *new_entry, int in_map, int sep)
{
  ...
  (__builtin_expect(!(histype != HIST_DEFAULT), 0) ? __assert_rtn(__func__, "cmdhist.c", 286, "histype != HIST_DEFAULT") : (void)0);
  ...
  if (!in_history(histype, new_entry, 1, sep)) {
    ...
    hisptr->additional_elements = ((void*)0);
...
static int calc_hist_idx(int histype, int num)
{
  ...
  if (num > 0) {
    ...
    if (i >= 0 && hist[i].hisnum == num && hist[i].hisstr != ((void*)0)) {
      return i;
    }
  } else if (-num <= hislen) {
    i += num + 1;
...
static int del_history_entry(int histype, char_u *str)
{
  ...
  if (hislen != 0
      ...
      && (regmatch.regprog = vim_regcomp((char *)str, 1 + 2)) != ((void*)0)) {
    i = last = idx;
    do {
      hisptr = &history[histype][i];
      if (hisptr->hisstr == ((void*)0)) {
        break;
      }
    ...
    if (history[histype][idx].hisstr == ((void*)0)) {
      hisidx[histype] = -1;
    }
  }
...
void f_histadd(typval_T *argvars, typval_T *rettv, EvalFuncData fptr)
{
  ...
  if (histype != HIST_INVALID) {
    ...
    if (*str != '\000') {
      init_history();
      add_to_history(histype, (char *)str, 0, '\000');
...
void f_histnr(typval_T *argvars, typval_T *rettv, EvalFuncData fptr)
{
  ...
  HistoryType i = histname == ((void*)0)
    ? HIST_INVALID
    : get_histtype(histname, strlen(histname), 0);
  if (i != HIST_INVALID) {
    i = get_history_idx(i);
  }
...
void ex_history(exarg_T *eap)
{
  ...
  if (hislen == 0) {
    msg(libintl_gettext((char *)("'history' option is zero")));
    return;
  }
  ...
  if (!(ascii_isdigit(*arg) || *arg == '-' || *arg == ',')) {
    ...
    while ((((unsigned)(*end) >= 'A' && (unsigned)(*end) <= 'Z') || ((unsigned)(*end) >= 'a' && (unsigned)(*end) <= 'z'))
           || vim_strchr(":=@>/?", *end) != ((void*)0)) {
      end++;
    }
    histype1 = get_histtype((const char *)arg, (size_t)(end - (char *)arg), 0);
    if (histype1 == HIST_INVALID) {
      if (strncasecmp((char *)(arg), (char *)("all"), (size_t)(end - (char *)arg)) == 0) {
        histype1 = 0;
  ...
  for (; !got_int && histype1 <= histype2; histype1++) {
    __builtin___strcpy_chk ((char *)(IObuff), (char *)("\n      #  "), __builtin_object_size ((char *)(IObuff), 1 > 1 ? 1 : 0));
    (__builtin_expect(!(history_names[histype1] != ((void*)0)), 0) ? __assert_rtn(__func__, "cmdhist.c", 623, "history_names[histype1] != NULL") : (void)0);
    __builtin___strcat_chk ((char *)(__builtin___strcat_chk ((char *)(IObuff), (char *)(history_names[histype1]), __builtin_object_size ((char *)(IObuff), 1 > 1 ? 1 : 0))), (char *)(" history"), __builtin_object_size ((char *)(__builtin___strcat_chk ((char *)(IObuff), (char *)(history_names[histype1]), __builtin_object_size ((char *)(IObuff), 1 > 1 ? 1 : 0))), 1 > 1 ? 1 : 0));
    ...
    if (idx >= 0 && j <= k) {
      for (i = idx + 1; !got_int; i++) {
        ...
        if (hist[i].hisstr != ((void*)0)
          ...
          msg_putchar('\n');
          __builtin___snprintf_chk ((char *)IObuff, (1024 + 1), 0, __builtin_object_size ((char *)IObuff, 1 > 1 ? 1 : 0), "%c%6d  ", i == idx ? '>' : ' ', hist[i].hisnum);
          ...
          if (vim_strsize(hist[i].hisstr) > Columns - 10) {
            ...
            __builtin___strcat_chk ((char *)(IObuff), (char *)(hist[i].hisstr), __builtin_object_size ((char *)(IObuff), 1 > 1 ? 1 : 0));
          }
...
# 683 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/cmdhist.c"
const void *hist_iter(const void *const iter, const uint8_t history_type, const _Bool zero,
  ...
  FUNC_ATTR_WARN_UNUSED_RESULT FUNC_ATTR_NONNULL_ARG(4)
{
  ...
  *hist = *hiter;
  if (zero) {
    __builtin___memset_chk ((hiter), 0, sizeof(*(hiter)), __builtin_object_size ((hiter), 0));
  }
  if (hiter == hlast) {
    return ((void*)0);
  }
...
# 735 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/cmdhist.c"
