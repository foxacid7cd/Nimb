# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/match.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/match.c" 2
...
# 7 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/match.c" 2
...
# 6 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/buffer_defs.h" 2
...
# 8 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/buffer_defs.h" 2
...
# 9 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/match.c" 2
...
# 10 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/match.c" 2
...
# 11 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/match.c" 2
...
# 12 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/match.c" 2
...
# 13 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/match.c" 2
...
# 14 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/match.c" 2
...
# 16 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/match.c" 2
...
# 17 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/match.c" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/match.h" 1
# 18 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/match.c" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/memline.h" 1
# 19 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/match.c" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/profile.h" 1
# 20 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/match.c" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/regexp.h" 1
# 21 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/match.c" 2
...
# 41 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/match.c"
  ...
  FUNC_ATTR_NONNULL_ARG(1, 2)
{
  ...
  if (id < -1 || id == 0) {
    semsg(libintl_gettext((char *)("E799: Invalid ID: %" "ll" "d" " (must be greater than or equal to 1)")),
  ...
  if (id == -1) {
    ...
    for (cur = wp->w_match_head; cur != ((void*)0); cur = cur->mit_next) {
      if (cur->mit_id == id) {
        semsg(libintl_gettext((char *)("E801: ID already taken: %" "ll" "d")), (int64_t)id);
        return -1;
      }
    }
  ...
  if (pat != ((void*)0) && (regprog = vim_regcomp((char *)pat, 1)) == ((void*)0)) {
  ...
  m->mit_id = id;
  m->mit_priority = prio;
  m->mit_pattern = pat == ((void*)0) ? ((void*)0): xstrdup(pat);
  m->mit_hlg_id = hlg_id;
  ...
  if (pos_list != ((void*)0)) {
    ...
    int i = 0;
    do { list_T *const l_ = (pos_list); ; if (l_ != ((void*)0)) { for ( listitem_T *li = l_->lv_first; li != ((void*)0); li = li->li_next) { { linenr_T lnum = 0; colnr_T col = 0; int len = 1; _Bool error = 0; if ((&(li)->li_tv)->v_type == VAR_LIST) { const list_T *const subl = (&(li)->li_tv)->vval.v_list; const listitem_T *subli = tv_list_first(subl); if (subli == ((void*)0)) { semsg(libintl_gettext((char *)("E5030: Empty list at position %d")), (int)tv_list_idx_of_item(pos_list, li)); goto fail; } lnum = (linenr_T)tv_get_number_chk((&(subli)->li_tv), &error); if (error) { goto fail; } if (lnum <= 0) { continue; } m->mit_pos_array[i].lnum = lnum; subli = ((subli)->li_next); if (subli != ((void*)0)) { col = (colnr_T)tv_get_number_chk((&(subli)->li_tv), &error); if (error) { goto fail; } if (col < 0) { continue; } subli = ((subli)->li_next); if (subli != ((void*)0)) { len = (colnr_T)tv_get_number_chk((&(subli)->li_tv), &error); if (len < 0) { continue; } if (error) { goto fail; } } } m->mit_pos_array[i].col = col; m->mit_pos_array[i].len = len; } else if ((&(li)->li_tv)->v_type == VAR_NUMBER) { if ((&(li)->li_tv)->vval.v_number <= 0) { continue; } m->mit_pos_array[i].lnum = (linenr_T)(&(li)->li_tv)->vval.v_number; m->mit_pos_array[i].col = 0; m->mit_pos_array[i].len = 0; } else { semsg(libintl_gettext((char *)("E5031: List or number required at position %d")), (int)tv_list_idx_of_item(pos_list, li)); goto fail; } if (toplnum == 0 || lnum < toplnum) { toplnum = lnum; } if (botlnum == 0 || lnum >= botlnum) { botlnum = lnum + 1; } i++; } } } } while (0);
# 179 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/match.c"
    if (toplnum != 0) {
  ...
  cur = wp->w_match_head;
  prev = cur;
  while (cur != ((void*)0) && prio >= cur->mit_priority) {
    prev = cur;
    cur = cur->mit_next;
  }
  if (cur == prev) {
...
static int match_delete(win_T *wp, int id, _Bool perr)
{
  ...
  if (id < 1) {
    if (perr) {
      semsg(libintl_gettext((char *)("E802: Invalid ID: %" "ll" "d" " (must be greater than or equal to 1)")),
            (int64_t)id);
    }
    return -1;
  }
  while (cur != ((void*)0) && cur->mit_id != id) {
    prev = cur;
    cur = cur->mit_next;
  }
  if (cur == ((void*)0)) {
    if (perr) {
      semsg(libintl_gettext((char *)("E803: ID not found: %" "ll" "d")), (int64_t)id);
    }
    return -1;
  }
  if (cur == prev) {
...
# 401 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/match.c"
  ...
  FUNC_ATTR_NONNULL_ARG(2)
{
  ...
  for (;;) {
    ...
    if (shl->lnum == 0) {
      ...
      ml = (char_u *)ml_get_buf(shl->buf, lnum, 0) + matchcol;
      if (*ml == '\000') {
        matchcol++;
        shl->lnum = 0;
        break;
    ...
    if (shl->rm.regprog != ((void*)0)) {
      ...
      _Bool regprog_is_copy = (shl != search_hl && cur != ((void*)0)
                              && shl == &cur->mit_hl
    ...
    if (shl->rm.regprog != ((void*)0)
      ...
      if (shl->first_lnum == 0) {
        for (shl->first_lnum = lnum;
             ...
             shl->first_lnum--) {
          if (hasFoldingWin(wp, shl->first_lnum - 1, ((void*)0), ((void*)0), 1, ((void*)0))) {
            break;
          }
        }
      }
      ...
      while (shl->first_lnum < lnum && (shl->rm.regprog != ((void*)0)
        ...
        pos_inprogress = !(cur == ((void*)0) || cur->mit_pos_cur == 0);
        if (shl->lnum != 0) {
...
_Bool prepare_search_hl_line(win_T *wp, linenr_T lnum, colnr_T mincol, char_u **line,
                            match_T *search_hl, int *search_attr, _Bool *search_attr_from_match)
{
  matchitem_T *cur = wp->w_match_head;
  match_T *shl;
  _Bool shl_flag = 0;
  ...
  while (cur != ((void*)0) || !shl_flag) {
    ...
    while (shl->rm.regprog != ((void*)0)
      ...
      if (shl->startcol != MAXCOL
        ...
        if (shl == search_hl && shl->has_cursor && (hl_attr_active[(int)(HLF_LC)] || win_hl_attr(wp, HLF_LC))) {
          shl->attr_cur = win_hl_attr(wp, HLF_LC) ? win_hl_attr(wp, HLF_LC) : hl_attr_active[(int)(HLF_LC)];
        } else {
          shl->attr_cur = shl->attr;
        }
...
_Bool get_prevcol_hl_flag(win_T *wp, match_T *search_hl, long curcol)
{
  long prevcol = curcol;
  matchitem_T *cur;
...
static int matchadd_dict_arg(typval_T *tv, const char **conceal_char, win_T **win)
{
  ...
  if ((di = tv_dict_find(tv->vval.v_dict, ("conceal"), (sizeof("conceal") - 1))) != ((void*)0)) {
    *conceal_char = tv_get_string(&di->di_tv);
  }

  if ((di = tv_dict_find(tv->vval.v_dict, ("window"), (sizeof("window") - 1))) != ((void*)0)) {
  ...
  while (cur != ((void*)0)) {
    ...
    if (cur->mit_match.regprog == ((void*)0)) {
      ...
      for (i = 0; i < cur->mit_pos_count; i++) {
        ...
        (__builtin_expect(!((size_t)len < sizeof(buf)), 0) ? __assert_rtn(__func__, "match.c", 915, "(size_t)len < sizeof(buf)") : (void)0);
        tv_dict_add_list(dict, buf, (size_t)len, l);
      }
    } else {
      tv_dict_add_str(dict, ("pattern"), (sizeof("pattern") - 1), (const char *)cur->mit_pattern);
    }
...
void f_setmatches(typval_T *argvars, typval_T *rettv, EvalFuncData fptr)
{
  ...
  int li_idx = 0;
  do { const list_T *const l_ = (l); ; if (l_ != ((void*)0)) { for (const listitem_T *li = l_->lv_first; li != ((void*)0); li = li->li_next) { { if ((&(li)->li_tv)->v_type != VAR_DICT || (d = (&(li)->li_tv)->vval.v_dict) == ((void*)0)) { semsg(libintl_gettext((char *)("E474: List item %d is either not a dictionary " "or an empty one")), li_idx); return; } if (!(tv_dict_find(d, ("group"), (sizeof("group") - 1)) != ((void*)0) && (tv_dict_find(d, ("pattern"), (sizeof("pattern") - 1)) != ((void*)0) || tv_dict_find(d, ("pos1"), (sizeof("pos1") - 1)) != ((void*)0)) && tv_dict_find(d, ("priority"), (sizeof("priority") - 1)) != ((void*)0) && tv_dict_find(d, ("id"), (sizeof("id") - 1)) != ((void*)0))) { semsg(libintl_gettext((char *)("E474: List item %d is missing one of the required keys")), li_idx); return; } li_idx++; } } } } while (0);
# 977 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/match.c"
  clear_matches(win);
  _Bool match_add_failed = 0;
  do { const list_T *const l_ = (l); ; if (l_ != ((void*)0)) { for (const listitem_T *li = l_->lv_first; li != ((void*)0); li = li->li_next) { { int i = 0; d = (&(li)->li_tv)->vval.v_dict; dictitem_T *const di = tv_dict_find(d, ("pattern"), (sizeof("pattern") - 1)); if (di == ((void*)0)) { if (s == ((void*)0)) { s = tv_list_alloc(9); } for (i = 1; i < 9; i++) { char buf[30]; __builtin___snprintf_chk (buf, sizeof(buf), 0, __builtin_object_size (buf, 1 > 1 ? 1 : 0), "pos%d", i); dictitem_T *const pos_di = tv_dict_find(d, buf, -1); if (pos_di != ((void*)0)) { if (pos_di->di_tv.v_type != VAR_LIST) { return; } tv_list_append_tv(s, &pos_di->di_tv); tv_list_ref(s); } else { break; } } } char group_buf[NUMBUFLEN]; const char *const group = tv_dict_get_string_buf(d, "group", group_buf); const int priority = (int)tv_dict_get_number(d, "priority"); const int id = (int)tv_dict_get_number(d, "id"); dictitem_T *const conceal_di = tv_dict_find(d, ("conceal"), (sizeof("conceal") - 1)); const char *const conceal = (conceal_di != ((void*)0) ? tv_get_string(&conceal_di->di_tv) : ((void*)0)); if (i == 0) { if (match_add(win, group, tv_dict_get_string(d, "pattern", 0), priority, id, ((void*)0), conceal) != id) { match_add_failed = 1; } } else { if (match_add(win, group, ((void*)0), priority, id, s, conceal) != id) { match_add_failed = 1; } tv_list_unref(s); s = ((void*)0); } } } } } while (0);
# 1036 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/match.c"
  if (!match_add_failed) {
...
void f_matchadd(typval_T *argvars, typval_T *rettv, EvalFuncData fptr)
{
  ...
  if (id >= 1 && id <= 3) {
    semsg(libintl_gettext((char *)("E798: ID is reserved for \":match\": %" "ll" "d")), (int64_t)id);
    return;
  }

  rettv->vval.v_number = match_add(win, grp, pat, prio, id, ((void*)0), conceal_char);
}
...
void f_matchaddpos(typval_T *argvars, typval_T *rettv, EvalFuncData fptr)
{
  ...
  if (argvars[1].v_type != VAR_LIST) {
    semsg(libintl_gettext((char *)(e_listarg)), "matchaddpos()");
    return;
  }
  ...
  rettv->vval.v_number = match_add(win, group, ((void*)0), prio, id, l, conceal_char);
}
