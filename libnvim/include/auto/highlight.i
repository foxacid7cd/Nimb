# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/highlight.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/highlight.c" 2
...
# 7 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/highlight.c" 2
...
# 8 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/highlight.c" 2
...
# 9 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/highlight.c" 2
...
# 10 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/highlight.c" 2
...
# 11 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/highlight.c" 2
...
# 13 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/highlight.c" 2
...
# 14 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/highlight.c" 2
...
# 17 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/highlight.c" 2
...
# 18 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/highlight.c" 2
...
static Map_HlEntry_int attr_entry_ids = { { 0, 0, 0, 0, ((void*)0), ((void*)0), ((void*)0) } };
static Map_int_int combine_attr_entries = { { 0, 0, 0, 0, ((void*)0), ((void*)0), ((void*)0) } };
static Map_int_int blend_attr_entries = { { 0, 0, 0, 0, ((void*)0), ((void*)0), ((void*)0) } };
static Map_int_int blendthrough_attr_entries = { { 0, 0, 0, 0, ((void*)0), ((void*)0), ((void*)0) } };
...
static int get_attr_entry(HlEntry entry)
{
  ...
  if (((attr_entries).size) > 65535) {
    ...
    if (recursive) {
      emsg(libintl_gettext((char *)("E424: Too many different highlighting attributes in use")));
      return 0;
    }
    recursive = 1;
  ...
  if (next_id > 2147483647) {
    logmsg(4, ((void*)0), __func__, 98, 1, "The index on attr_entries has overflowed");
    return 0;
  }
  id = (int)next_id;
...
{
  if (ns_id == 0) {
    (__builtin_expect(!(dict), 0) ? __assert_rtn(__func__, "highlight.c", 153, "dict") : (void)0);
...
int ns_get_hl(NS *ns_hl, int hl_id, _Bool link, _Bool nodefault)
{
  ...
  _Bool valid_item = it.version >= p->hl_valid;
  ...
  if (!valid_item && p->hl_def != (-2) && !recursive) {
    ...
    (*((args).items + ((args).size++)) = (((Object) { .type = kObjectTypeString, .data.string = cstr_to_string((char *)syn_id2name(hl_id)) })));
    ...
    if (ret.type == kObjectTypeDictionary) {
      ...
      if (api_dict_to_keydict(&dict, KeyDict_highlight_get_field,
        ...
        fallback = api_object_to_bool(dict.fallback, "fallback", 1, &err);
        tmp = api_object_to_bool(dict.fallback, "tmp", 0, &err);
        if (it.link_id >= 0) {
          fallback = 1;
        }
      }
...
int hl_get_ui_attr(int ns_id, int idx, int final_id, _Bool optional)
{
  HlAttrs attrs = (HlAttrs) { .rgb_ae_attr = 0, .cterm_ae_attr = 0, .rgb_fg_color = -1, .rgb_bg_color = -1, .rgb_sp_color = -1, .cterm_fg_color = 0, .cterm_bg_color = 0, .hl_blend = -1, };
  _Bool available = 0;
...
void update_window_hl(win_T *wp, _Bool invalid)
{
  ...
  update_ns_hl(ns_id);
  if (ns_id != wp->w_ns_hl_active || wp->w_ns_hl_attr == ((void*)0)) {
    ...
    for (int i = 0; i < 8; i++) {
      ...
      if (wp->w_float_config.border_hl_ids[i]) {
        attr = hl_get_ui_attr(ns_id, HLF_BORDER,
                              wp->w_float_config.border_hl_ids[i], 0);
...
void update_ns_hl(int ns_id)
{
  ...
  NSHlAttr **alloc = (NSHlAttr **)map_handle_T_ptr_t_ref(&ns_hl_attr, ns_id, 1);
  if (*alloc == ((void*)0)) {
  ...
  for (int hlf = 0; hlf < HLF_COUNT; hlf++) {
    ...
    _Bool optional = (hlf == HLF_INACTIVE || hlf == HLF_NFLOAT);
  ...
  hl_attrs[HLF_COUNT] = hl_get_ui_attr(ns_id, -1, normality, 1);


  p = get_decor_provider(ns_id, 1);
  p->hl_cached = 1;
}
...
void hlattrs2dict(Dictionary *dict, HlAttrs ae, _Bool use_rgb)
{
  (__builtin_expect(!(dict->capacity >= 16), 0) ? __assert_rtn(__func__, "highlight.c", 816, "dict->capacity >= HLATTRS_DICT_SIZE") : (void)0);
  Dictionary hl = *dict;
  int mask = use_rgb ? ae.rgb_ae_attr : ae.cterm_ae_attr;

  if (mask & HL_BOLD) {
    (*((hl).items + ((hl).size++)) = (((KeyValuePair) { .key = cstr_as_string("bold"), .value = ((Object) { .type = kObjectTypeBoolean, .data.boolean = 1 }) })));
  }

  if (mask & HL_STANDOUT) {
    (*((hl).items + ((hl).size++)) = (((KeyValuePair) { .key = cstr_as_string("standout"), .value = ((Object) { .type = kObjectTypeBoolean, .data.boolean = 1 }) })));
  }

  if (mask & HL_UNDERLINE) {
    (*((hl).items + ((hl).size++)) = (((KeyValuePair) { .key = cstr_as_string("underline"), .value = ((Object) { .type = kObjectTypeBoolean, .data.boolean = 1 }) })));
  }

  if (mask & HL_UNDERCURL) {
    (*((hl).items + ((hl).size++)) = (((KeyValuePair) { .key = cstr_as_string("undercurl"), .value = ((Object) { .type = kObjectTypeBoolean, .data.boolean = 1 }) })));
  }

  if (mask & HL_UNDERDOUBLE) {
    (*((hl).items + ((hl).size++)) = (((KeyValuePair) { .key = cstr_as_string("underdouble"), .value = ((Object) { .type = kObjectTypeBoolean, .data.boolean = 1 }) })));
  }

  if (mask & HL_UNDERDOTTED) {
    (*((hl).items + ((hl).size++)) = (((KeyValuePair) { .key = cstr_as_string("underdotted"), .value = ((Object) { .type = kObjectTypeBoolean, .data.boolean = 1 }) })));
  }

  if (mask & HL_UNDERDASHED) {
    (*((hl).items + ((hl).size++)) = (((KeyValuePair) { .key = cstr_as_string("underdashed"), .value = ((Object) { .type = kObjectTypeBoolean, .data.boolean = 1 }) })));
  }

  if (mask & HL_ITALIC) {
    (*((hl).items + ((hl).size++)) = (((KeyValuePair) { .key = cstr_as_string("italic"), .value = ((Object) { .type = kObjectTypeBoolean, .data.boolean = 1 }) })));
  }

  if (mask & HL_INVERSE) {
    (*((hl).items + ((hl).size++)) = (((KeyValuePair) { .key = cstr_as_string("reverse"), .value = ((Object) { .type = kObjectTypeBoolean, .data.boolean = 1 }) })));
  }

  if (mask & HL_STRIKETHROUGH) {
    (*((hl).items + ((hl).size++)) = (((KeyValuePair) { .key = cstr_as_string("strikethrough"), .value = ((Object) { .type = kObjectTypeBoolean, .data.boolean = 1 }) })));
  }

  if (mask & HL_NOCOMBINE) {
    (*((hl).items + ((hl).size++)) = (((KeyValuePair) { .key = cstr_as_string("nocombine"), .value = ((Object) { .type = kObjectTypeBoolean, .data.boolean = 1 }) })));
  }

  if (use_rgb) {
    if (mask & HL_FG_INDEXED) {
      (*((hl).items + ((hl).size++)) = (((KeyValuePair) { .key = cstr_as_string("fg_indexed"), .value = ((Object) { .type = kObjectTypeBoolean, .data.boolean = 1 }) })));
    }

    if (mask & HL_BG_INDEXED) {
      (*((hl).items + ((hl).size++)) = (((KeyValuePair) { .key = cstr_as_string("bg_indexed"), .value = ((Object) { .type = kObjectTypeBoolean, .data.boolean = 1 }) })));
    }

    if (ae.rgb_fg_color != -1) {
      (*((hl).items + ((hl).size++)) = (((KeyValuePair) { .key = cstr_as_string("foreground"), .value = ((Object) { .type = kObjectTypeInteger, .data.integer = ae.rgb_fg_color }) })));
    }

    if (ae.rgb_bg_color != -1) {
      (*((hl).items + ((hl).size++)) = (((KeyValuePair) { .key = cstr_as_string("background"), .value = ((Object) { .type = kObjectTypeInteger, .data.integer = ae.rgb_bg_color }) })));
    }

    if (ae.rgb_sp_color != -1) {
      (*((hl).items + ((hl).size++)) = (((KeyValuePair) { .key = cstr_as_string("special"), .value = ((Object) { .type = kObjectTypeInteger, .data.integer = ae.rgb_sp_color }) })));
    }
  } else {
    if (ae.cterm_fg_color != 0) {
      (*((hl).items + ((hl).size++)) = (((KeyValuePair) { .key = cstr_as_string("foreground"), .value = ((Object) { .type = kObjectTypeInteger, .data.integer = ae.cterm_fg_color - 1 }) })));
    }

    if (ae.cterm_bg_color != 0) {
      (*((hl).items + ((hl).size++)) = (((KeyValuePair) { .key = cstr_as_string("background"), .value = ((Object) { .type = kObjectTypeInteger, .data.integer = ae.cterm_bg_color - 1 }) })));
    }
  }
...
HlAttrs dict2hlattrs(Dict(highlight) *dict, _Bool use_rgb, int *link_id, Error *err)
{
  ...
  if (api_object_to_bool(dict->bold, "bold", 0, err)) { mask = mask | HL_BOLD; };
  if (api_object_to_bool(dict->standout, "standout", 0, err)) { mask = mask | HL_STANDOUT; };
  if (api_object_to_bool(dict->underline, "underline", 0, err)) { mask = mask | HL_UNDERLINE; };
  if (api_object_to_bool(dict->undercurl, "undercurl", 0, err)) { mask = mask | HL_UNDERCURL; };
  if (api_object_to_bool(dict->underdouble, "underdouble", 0, err)) { mask = mask | HL_UNDERDOUBLE; };
  if (api_object_to_bool(dict->underdotted, "underdotted", 0, err)) { mask = mask | HL_UNDERDOTTED; };
  if (api_object_to_bool(dict->underdashed, "underdashed", 0, err)) { mask = mask | HL_UNDERDASHED; };
  if (api_object_to_bool(dict->italic, "italic", 0, err)) { mask = mask | HL_ITALIC; };
  if (api_object_to_bool(dict->reverse, "reverse", 0, err)) { mask = mask | HL_INVERSE; };
  if (api_object_to_bool(dict->strikethrough, "strikethrough", 0, err)) { mask = mask | HL_STRIKETHROUGH; };
  if (api_object_to_bool(dict->nocombine, "nocombine", 0, err)) { mask = mask | HL_NOCOMBINE; };
  if (api_object_to_bool(dict->default_, "default", 0, err)) { mask = mask | HL_DEFAULT; };

  if (((dict->fg).type != kObjectTypeNil)) {
    fg = object_to_color(dict->fg, "fg", 1, err);
  } else if (((dict->foreground).type != kObjectTypeNil)) {
    fg = object_to_color(dict->foreground, "foreground", 1, err);
  }
  ...
  if (((dict->bg).type != kObjectTypeNil)) {
    bg = object_to_color(dict->bg, "bg", 1, err);
  } else if (((dict->background).type != kObjectTypeNil)) {
    bg = object_to_color(dict->background, "background", 1, err);
  }
  if (((err)->type != kErrorTypeNone)) {
    return hlattrs;
  }
  ...
  if (((dict->sp).type != kObjectTypeNil)) {
    sp = object_to_color(dict->sp, "sp", 1, err);
  } else if (((dict->special).type != kObjectTypeNil)) {
    sp = object_to_color(dict->special, "special", 1, err);
  }
  if (((err)->type != kErrorTypeNone)) {
    return hlattrs;
  }
  ...
  } else if (((dict->blend).type != kObjectTypeNil)) {
  ...
  if (dict->cterm.type == kObjectTypeDictionary) {
    ...
    cterm_mask_provided = 1;
    if (api_object_to_bool(cterm->bold, "bold", 0, err)) { cterm_mask = cterm_mask | HL_BOLD; };
    if (api_object_to_bool(cterm->standout, "standout", 0, err)) { cterm_mask = cterm_mask | HL_STANDOUT; };
    if (api_object_to_bool(cterm->underline, "underline", 0, err)) { cterm_mask = cterm_mask | HL_UNDERLINE; };
    if (api_object_to_bool(cterm->undercurl, "undercurl", 0, err)) { cterm_mask = cterm_mask | HL_UNDERCURL; };
    if (api_object_to_bool(cterm->italic, "italic", 0, err)) { cterm_mask = cterm_mask | HL_ITALIC; };
    if (api_object_to_bool(cterm->reverse, "reverse", 0, err)) { cterm_mask = cterm_mask | HL_INVERSE; };
    if (api_object_to_bool(cterm->strikethrough, "strikethrough", 0, err)) { cterm_mask = cterm_mask | HL_STRIKETHROUGH; };
    if (api_object_to_bool(cterm->nocombine, "nocombine", 0, err)) { cterm_mask = cterm_mask | HL_NOCOMBINE; };
  ...
  if (((dict->ctermfg).type != kObjectTypeNil)) {
    ctermfg = object_to_color(dict->ctermfg, "ctermfg", 0, err);
    if (((err)->type != kErrorTypeNone)) {
      return hlattrs;
    }
  }
  ...
  if (((dict->ctermbg).type != kObjectTypeNil)) {
    ctermbg = object_to_color(dict->ctermbg, "ctermbg", 0, err);
    if (((err)->type != kErrorTypeNone)) {
      return hlattrs;
    }
  }
...
int object_to_color(Object val, char *key, _Bool rgb, Error *err)
{
