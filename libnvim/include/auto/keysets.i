# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/build/src/nvim/auto/keysets.generated.h"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/build/src/nvim/auto/keysets.generated.h" 2
...
int highlight_hash(const char *str, size_t len)
{
  ...
  switch (len) {
    ...
    break;
    case 13: low = 24; break;
    default: break;
  }
  if (low < 0 || memcmp(str, highlight_table[low].str, len)) {
    return -1;
  }
  return low;
}
