# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/regexp_bt.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/regexp_bt.c" 2
# 129 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/regexp_bt.c"
...
# 130 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/regexp_bt.c" 2
...
# 131 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/regexp_bt.c" 2
...
# 132 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/regexp_bt.c" 2
...
# 133 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/regexp_bt.c" 2
...
# 135 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/regexp_bt.c" 2
...
# 5 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/regexp.h" 2
# 136 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/regexp_bt.c" 2
# 242 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/regexp_bt.c"
...
# 413 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/regexp_bt.c"
static char_u *reg(int paren, int *flagp);
# 430 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/regexp_bt.c"
...
static void reginsert_nr(int op, long val, char_u *opnd)
{
  ...
  *place++ = NUL;
  *place++ = NUL;
  (__builtin_expect(!(val >= 0 && (uintmax_t)val <= 4294967295U), 0) ? __assert_rtn(__func__, "regexp_bt.c", 1600, "val >= 0 && (uintmax_t)val <= UINT32_MAX") : (void)0);
...
static void reginsert_limits(int op, long minval, long maxval, char_u *opnd)
{
  ...
  *place++ = NUL;
  *place++ = NUL;
  (__builtin_expect(!(minval >= 0 && (uintmax_t)minval <= 4294967295U), 0) ? __assert_rtn(__func__, "regexp_bt.c", 1629, "minval >= 0 && (uintmax_t)minval <= UINT32_MAX") : (void)0);
  place = re_put_uint32(place, (uint32_t)minval);
  (__builtin_expect(!(maxval >= 0 && (uintmax_t)maxval <= 4294967295U), 0) ? __assert_rtn(__func__, "regexp_bt.c", 1631, "maxval >= 0 && (uintmax_t)maxval <= UINT32_MAX") : (void)0);
...
static int seen_endbrace(int refnum)
{
  if (!had_endbrace[refnum]) {
    ...
    if (*p == NUL) {
      emsg(libintl_gettext((char *)("E65: Illegal back reference")));
      rc_did_emsg = 1;
      return 0;
    }
  }
...
static char_u *regatom(int *flagp)
{
  ...
  *flagp = 0;
  ...
  case Magic('U'):
    ...
    if (p == ((void*)0)) {
      EMSG_RET_NULL(libintl_gettext((char *)("E63: invalid use of \\_")));
    }
  ...
  case Magic(')'):
    ...
    IEMSG_RET_NULL(libintl_gettext((char *)(e_internal)));
  ...
  case Magic('*'):
    c = no_Magic(c);
    EMSG3_RET_NULL(libintl_gettext((char *)("E64: %s%c follows nothing")),
  ...
  case Magic('~'):
    if (reg_prev_sub != ((void*)0)) {
      ...
      EMSG_RET_NULL(libintl_gettext((char *)(e_nopresub)));
    }
    break;
  ...
  case Magic('z'):
    ...
    case '(':
      if ((reg_do_extmatch & 1) == 0) {
        EMSG_RET_NULL(libintl_gettext((char *)(e_z_not_allowed)));
      }
      if (one_exactly) {
        EMSG_ONE_RET_NULL;
      }
    ...
    case '9':
      if ((reg_do_extmatch & 2) == 0) {
        EMSG_RET_NULL(libintl_gettext((char *)(e_z1_not_allowed)));
      }
      ret = regnode(130 + c - '0');
      re_has_z = 2;
      break;
    ...
    default:
      EMSG_RET_NULL(libintl_gettext((char *)("E68: Invalid character after \\z")));
    }
    break;
  ...
  case Magic('%'):
    ...
    case '#':
      if (regparse[0] == '=' && regparse[1] >= 48 && regparse[1] <= 50) {
        ...
        semsg(libintl_gettext((char *)(e_atom_engine_must_be_at_start_of_pattern)), regparse[1]);
        return FAIL;
      }
      ret = regnode(203);
      break;
    ...
    case '[':
      ...
      }
      {
        ...
        while ((c = getchr()) != ']') {
          if (c == NUL) {
            EMSG2_RET_NULL(libintl_gettext((char *)(e_missing_sb)),
                           reg_magic == MAGIC_ALL);
          }
          br = regnode(3);
          if (ret == ((void*)0)) {
        ...
        if (ret == ((void*)0)) {
          EMSG2_RET_NULL(libintl_gettext((char *)(e_empty_sb)),
                         reg_magic == MAGIC_ALL);
        }
    ...
    case 'U':
    {
      ...
      if (i < 0 || i > 2147483647) {
        EMSG2_RET_NULL(libintl_gettext((char *)("E678: Invalid character after %s%%[dxouU]")),
                       reg_magic == MAGIC_ALL);
      }
    ...
    default:
      if (ascii_isdigit(c) || c == '<' || c == '>' || c == '\'' || c == '.') {
        ...
        if (c == '\'' && n == 0) {
          ...
          if (cur && n) {
            semsg(libintl_gettext((char *)(e_regexp_number_after_dot_pos_search_chr)), no_Magic(c));
            rc_did_emsg = 1;
            return ((void*)0);
          }
          if (c == 'l') {
      ...
      EMSG2_RET_NULL(libintl_gettext((char *)("E71: Invalid character after %s%%")),
                     reg_magic == MAGIC_ALL);
    }
    break;
...
collection:
    {
      ...
      if (*lp == ']') {
        ...
        while (*regparse != NUL && *regparse != ']') {
          if (*regparse == '-') {
            ...
            if (*regparse == ']' || *regparse == NUL
              ...
              if (startc > endc) {
                EMSG_RET_NULL(libintl_gettext((char *)(e_reverse_range)));
              }
              if (utf_char2len(startc) > 1
                  || utf_char2len(endc) > 1) {

                if (endc > startc + 256) {
                  EMSG_RET_NULL(libintl_gettext((char *)(e_large_class)));
                }
                while (++startc <= endc) {
                  regmbc(startc);
                }
        ...
        prevchr_len = 1;
        if (*regparse != ']') {
          EMSG_RET_NULL(libintl_gettext((char *)(e_toomsbra)));
        }
        skipchr();
        *flagp |= 0x1 | 0x2;
        break;
      } else if (reg_strict) {
        EMSG2_RET_NULL(libintl_gettext((char *)(e_missingbracket)), reg_magic > MAGIC_OFF);
      }
    }
    {} __attribute__((fallthrough));
...
do_multibyte:
    ...
    ret = regnode(5);
# 2418 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/regexp_bt.c"
...
# 2462 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/regexp_bt.c"
static char_u *regpiece(int *flagp)
{
  ...
  *flagp = (0 | 0x4 | (flags & (0x8 | 0x10)));
  ...
  case Magic('@'): {
    ...
    if (lop == 0) {
      EMSG2_RET_NULL(libintl_gettext((char *)("E59: invalid character after %s@")),
                     reg_magic == MAGIC_ALL);
    }
  ...
  case Magic('{'):
    ...
    if (flags & 0x2) {
      ...
      if (num_complex_braces >= 10) {
        EMSG2_RET_NULL(libintl_gettext((char *)("E60: Too many complex %s{...}s")),
                       reg_magic == MAGIC_ALL);
      }
  ...
  if (re_multi_type(peekchr()) != NOT_MULTI) {
    ...
    if (peekchr() == Magic('*')) {
      EMSG2_RET_NULL(libintl_gettext((char *)("E61: Nested %s*")), reg_magic >= MAGIC_ON);
    }
    EMSG3_RET_NULL(libintl_gettext((char *)("E62: Nested %s%c")), reg_magic == MAGIC_ALL, no_Magic(peekchr()));
  }
...
# 2724 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/regexp_bt.c"
static char_u *reg(int paren, int *flagp)
{
  char_u *ret;
  char_u *br;
  ...
  *flagp = 0x1;
  ...
  if (paren == REG_ZPAREN) {
    ...
    if (regnzpar >= 10) {
      EMSG_RET_NULL(libintl_gettext((char *)("E50: Too many \\z(")));
    }
    parno = regnzpar;
    regnzpar++;
    ...
    if (regnpar >= 10) {
      EMSG2_RET_NULL(libintl_gettext((char *)("E51: Too many %s(")), reg_magic == MAGIC_ALL);
    }
    parno = regnpar;
    regnpar++;
  ...
  *flagp |= flags & (0x4 | 0x8 | 0x10);
  ...
  if (paren != REG_NOPAREN && getchr() != Magic(')')) {
    if (paren == REG_ZPAREN) {
      EMSG_RET_NULL(libintl_gettext((char *)("E52: Unmatched \\z(")));
    } else if (paren == REG_NPAREN) {
      EMSG2_RET_NULL(libintl_gettext((char *)(e_unmatchedpp)), reg_magic == MAGIC_ALL);
    } else {
      EMSG2_RET_NULL(libintl_gettext((char *)(e_unmatchedp)), reg_magic == MAGIC_ALL);
    }
  } else if (paren == REG_NOPAREN && peekchr() != NUL) {
    if (curchr == Magic(')')) {
      EMSG2_RET_NULL(libintl_gettext((char *)(e_unmatchedpar)), reg_magic == MAGIC_ALL);
    } else {
      EMSG_RET_NULL(libintl_gettext((char *)(e_trailing)));
    }
...
# 2842 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/regexp_bt.c"
static regprog_T *bt_regcomp(char_u *expr, int re_flags)
{
  ...
  if (expr == ((void*)0)) {
    IEMSG_RET_NULL(libintl_gettext((char *)(e_null)));
  }
  ...
  regcode = ((char_u *)-1);
  regc(REGMAGIC);
  if (reg(REG_NOPAREN, &flags) == ((void*)0)) {
    return ((void*)0);
  }
  ...
  regcode = r->program;
  regc(REGMAGIC);
  if (reg(REG_NOPAREN, &flags) == ((void*)0) || reg_toolong) {
    xfree(r);
    if (reg_toolong) {
      EMSG_RET_NULL(libintl_gettext((char *)("E339: Pattern too long")));
    }
    return ((void*)0);
  }
...
# 2925 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/regexp_bt.c"
    if ((flags & 0x4 || ((int)(*(scan))) == 15 || ((int)(*(scan))) == 16)
        && !(flags & 0x8)) {
      longest = ((void*)0);
      len = 0;
      for (; scan != ((void*)0); scan = regnext(scan)) {
        if (((int)(*(scan))) == 5 && STRLEN(((scan) + 3)) >= (size_t)len) {
          longest = ((scan) + 3);
          len = (int)STRLEN(((scan) + 3));
        }
      }
      r->regmust = longest;
      r->regmlen = len;
...
# 3052 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/regexp_bt.c"
...
do_class:
  ...
  case 22 + 30:
    while (count < maxcount) {
      ...
      if (*scan == NUL) {
        ...
        if ((cstrchr(opnd, utf_ptr2char((char *)scan)) == ((void*)0)) == testval) {
          break;
        }
        scan += len;
      } else {
  ...
  default:
    iemsg(libintl_gettext((char *)(e_re_corr)));
...
static regitem_T *regstack_push(regstate_T state, char_u *scan)
{
  ...
  if ((long)((unsigned)regstack.ga_len >> 10) >= p_mmp) {
    emsg(libintl_gettext((char *)(e_maxmempat)));
    return ((void*)0);
  }
...
# 3518 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/regexp_bt.c"
static _Bool regmatch(char_u *scan, proftime_T *tm, int *timed_out)
{
  ...
  for (;;) {
    ...
    fast_breakcheck();
# 3548 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/regexp_bt.c"
    for (;;) {
      ...
      status = RA_CONT;
# 3584 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/regexp_bt.c"
      next = regnext(scan);
      ...
      if (!rex.reg_line_lbr && ((op) >= 20 + 30 && (op) <= 48 + 30) && REG_MULTI
...

        {
          ...
          fmark_T *fm = mark_get(rex.reg_buf, curwin, ((void*)0), kMarkBufLocal, mark);
        ...
        case 204:
          (__builtin_expect(!(rex.lnum + rex.reg_firstlnum >= 0 && (uintmax_t)(rex.lnum + rex.reg_firstlnum) <= 4294967295U), 0) ? __assert_rtn(__func__, "regexp_bt.c", 3686, "rex.lnum + rex.reg_firstlnum >= 0 && (uintmax_t)(rex.lnum + rex.reg_firstlnum) <= UINT32_MAX") : (void)0);
        ...
        case 205:
          (__builtin_expect(!(rex.input - rex.line + 1 >= 0 && (uintmax_t)(rex.input - rex.line + 1) <= 4294967295U), 0) ? __assert_rtn(__func__, "regexp_bt.c", 3695, "rex.input - rex.line + 1 >= 0 && (uintmax_t)(rex.input - rex.line + 1) <= UINT32_MAX") : (void)0);
        ...
        case 4: {
          ...
          (__builtin_expect(!(status != RA_FAIL), 0) ? __assert_rtn(__func__, "regexp_bt.c", 4086, "status != RA_FAIL") : (void)0);
          if (status != RA_NOMATCH) {
...
# 4937 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/regexp_bt.c"
static long bt_regexec_both(char_u *line, colnr_T col, proftime_T *tm, int *timed_out)
{
  ...
  if (prog == ((void*)0) || line == ((void*)0)) {
    iemsg(libintl_gettext((char *)(e_null)));
    goto theend;
  }
  ...
  if (prog->regmust != ((void*)0)) {
    ...
    if (!rex.reg_ic) {
      while ((s = (char_u *)vim_strchr((char *)s, c)) != ((void*)0)) {
...
# 5134 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/regexp_bt.c"
static int bt_regexec_nl(regmatch_T *rmp, char_u *line, colnr_T col, _Bool line_lbr)
{
  ...
  (__builtin_expect(!(r <= 2147483647), 0) ? __assert_rtn(__func__, "regexp_bt.c", 5147, "r <= INT_MAX") : (void)0);
  return (int)r;
}
# 5163 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/regexp_bt.c"
