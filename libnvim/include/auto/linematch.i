# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/linematch.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/linematch.c" 2
...
# 2 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/linematch.c" 2
...
# 66 "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.0.sdk/usr/include/time.h" 3 4
...
# 67 "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.0.sdk/usr/include/time.h" 2 3 4
...
# 69 "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.0.sdk/usr/include/time.h" 2 3 4
...
# 3 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/linematch.c" 2
...
# 4 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/linematch.c" 2
...
# 94 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/linematch.c"
static int matching_chars(const char *s1, const char *s2)
{
  size_t s1len = ((500) < (line_len(s1)) ? (500) : (line_len(s1)));
  size_t s2len = ((500) < (line_len(s2)) ? (500) : (line_len(s2)));
  int matrix[2][500] = { 0 };
  _Bool icur = 1;
...
# 171 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/linematch.c"
...
# 253 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/linematch.c"
...
# 337 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/linematch.c"
size_t linematch_nbuffers(const char **diff_blk, const int *diff_len, const size_t ndiffs,
                          int **decisions, _Bool iwhite)
{
  (__builtin_expect(!(ndiffs <= 8), 0) ? __assert_rtn(__func__, "linematch.c", 340, "ndiffs <= LN_MAX_BUFS") : (void)0);

  size_t memsize = 1;
  size_t memsize_decisions = 0;
  for (size_t i = 0; i < ndiffs; i++) {
    (__builtin_expect(!(diff_len[i] >= 0), 0) ? __assert_rtn(__func__, "linematch.c", 345, "diff_len[i] >= 0") : (void)0);
