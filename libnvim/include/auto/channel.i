# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/channel.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/channel.c" 2
...
# 5 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/channel.c" 2
...
# 6 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/channel.c" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/ui.h" 1
# 7 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/channel.c" 2
...
# 9 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/channel.c" 2
...
# 10 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/channel.c" 2
...
# 11 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/channel.c" 2
...
# 13 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/channel.c" 2
...
# 14 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/channel.c" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/server.h" 1
# 15 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/channel.c" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/os/fs.h" 1
# 16 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/channel.c" 2
...
# 17 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/channel.c" 2
  ...
  FUNC_ATTR_NONNULL_RET
{
  ...
  (__builtin_expect(!(chan->id <= 9223372036854775807LL), 0) ? __assert_rtn(__func__, "channel.c", 185, "chan->id <= VARNUMBER_MAX") : (void)0);
...
{
# 216 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/channel.c"
  (void)ext_source;
...
# 313 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/channel.c"
Channel *channel_job_start(char **argv, CallbackReader on_stdout, CallbackReader on_stderr,
                           Callback on_exit, _Bool pty, _Bool rpc, _Bool overlapped, _Bool detach,
                           ...
                           uint16_t pty_height, dict_T *env, varnumber_T *status_out)
{
  ...
  if (pty) {
    if (detach) {
      semsg(libintl_gettext((char *)(e_invarg2)), "terminal/pty job cannot be detached");
  ...
  if (status) {
    semsg(libintl_gettext((char *)(e_jobspawn)), uv_strerror(status), cmd);
    xfree(cmd);
    if (proc->env) {
...
uint64_t channel_connect(_Bool tcp, const char *address, _Bool rpc, CallbackReader on_output,
...
uint64_t channel_from_stdio(_Bool rpc, CallbackReader on_output, const char **error)
  FUNC_ATTR_NONNULL_ALL
{
  ...
  int stdin_dup_fd = 0;
  int stdout_dup_fd = 1;
# 505 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/channel.c"
...
static void on_channel_output(Stream *stream, Channel *chan, RBuffer *buf, size_t count, _Bool eof,
    ...
    if (reader->eof) {
      if (reader->self) {
        if (tv_dict_find(reader->self, reader->type, -1) == ((void*)0)) {
          ...
          semsg(libintl_gettext((char *)(e_streamkey)), reader->type, chan->id);
        }
      } else {
...
Dictionary channel_info(uint64_t id)
{
  ...
  case kChannelStreamProc: {
    ...
    Array argv = { .size = 0, .capacity = 0, .items = ((void*)0) };
    if (p != ((void*)0)) {
      while (*p != ((void*)0)) {
