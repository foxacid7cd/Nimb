# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/decoration_provider.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/decoration_provider.c" 2
...
# 5 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/decoration_provider.c" 2
...
# 6 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/decoration_provider.c" 2
...
# 7 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/decoration_provider.c" 2
...
# 8 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/decoration_provider.c" 2
...
# 10 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/decoration_provider.c" 2
...
# 11 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/decoration_provider.c" 2
...
# 12 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/decoration_provider.c" 2

static struct { size_t size; size_t capacity; DecorProvider *items; } decor_providers = { .size = 0, .capacity = 0, .items = ((void*)0) };
...
static _Bool decor_provider_invoke(NS ns_id, const char *name, LuaRef ref, Array args,
                                  _Bool default_true, char **perr)
{
  Error err = { .type = kErrorTypeNone, .msg = ((void*)0) };

  textlock++;
  provider_active = 1;
  Object ret = nlua_call_ref(ref, name, args, 1, &err);
  provider_active = 0;
  textlock--;
  ...
  if (((&err)->type != kErrorTypeNone)) {
    ...
    logmsg(4, ((void*)0), __func__, 38, 1, "error in provider %s:%s: %s", ns_name, name, err.msg);
    _Bool verbose_errs = 1;
    if (verbose_errs && perr && *perr == ((void*)0)) {
      static char errbuf[(1024 + 1)];
      __builtin___snprintf_chk (errbuf, sizeof errbuf, 0, __builtin_object_size (errbuf, 1 > 1 ? 1 : 0), "%s: %s", ns_name, err.msg);
      *perr = xstrdup(errbuf);
    }
  }
                                  ...
                                  char **err)
{
  for (size_t i = 0; i < ((decor_providers).size); i++) {
    ...
    if (p->spell_nav != (-2)) {
      Array args = { .size = 0, .capacity = 0, .items = ((void*)0) }; Object args__items[6]; args.capacity = 6; args.items = args__items;;
      ...
      decor_provider_invoke(p->ns_id, "spell", p->spell_nav, args, 1, err);
    }
  }
}
...
void decor_providers_start(DecorProviders *providers, char **err)
{
  ...
  for (size_t i = 0; i < ((decor_providers).size); i++) {
    ...
    _Bool active;
    if (p->redraw_start != (-2)) {
      Array args = { .size = 0, .capacity = 0, .items = ((void*)0) }; Object args__items[2]; args.capacity = 2; args.items = args__items;;
      (*((args).items + ((args).size++)) = (((Object) { .type = kObjectTypeInteger, .data.integer = (int)display_tick })));
      active = decor_provider_invoke(p->ns_id, "start", p->redraw_start, args, 1, err);
    } else {
      active = 1;
    }

    if (active) {
      (*((((*providers).size == (*providers).capacity) ? (((*providers).capacity = (((*providers).capacity << 1) > ((sizeof((*providers).init_array)/sizeof(((*providers).init_array)[0])) / ((size_t)(!(sizeof((*providers).init_array) % sizeof(((*providers).init_array)[0]))))) ? ((*providers).capacity << 1) : ((sizeof((*providers).init_array)/sizeof(((*providers).init_array)[0])) / ((size_t)(!(sizeof((*providers).init_array) % sizeof(((*providers).init_array)[0])))))), (*providers).items = ((*providers).capacity == ((sizeof((*providers).init_array)/sizeof(((*providers).init_array)[0])) / ((size_t)(!(sizeof((*providers).init_array) % sizeof(((*providers).init_array)[0]))))) ? ((*providers).items == (*providers).init_array ? (*providers).items : _memcpy_free((*providers).init_array, (*providers).items, (*providers).size * sizeof((*providers).items[0]))) : ((*providers).items == (*providers).init_array ? __builtin___memcpy_chk (xmalloc((*providers).capacity * sizeof((*providers).items[0])), (*providers).items, (*providers).size * sizeof((*providers).items[0]), __builtin_object_size (xmalloc((*providers).capacity * sizeof((*providers).items[0])), 0)) : xrealloc((*providers).items, (*providers).capacity * sizeof((*providers).items[0]))))), 0) : 0), ((*providers).items + ((*providers).size++))) = (p));
    }
  }
}
# 109 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/decoration_provider.c"
                                ...
                                DecorProviders *line_providers, char **err)
{
  ...
  for (size_t k = 0; k < ((*providers).size); k++) {
    ...
    if (p && p->redraw_win != (-2)) {
      Array args = { .size = 0, .capacity = 0, .items = ((void*)0) }; Object args__items[4]; args.capacity = 4; args.items = args__items;;
                                 ...
                                 char **err)
{
  for (size_t k = 0; k < ((*providers).size); k++) {
    ...
    if (p && p->redraw_line != (-2)) {
      ...
      if (decor_provider_invoke(p->ns_id, "line", p->redraw_line, args, 1, err)) {
        *has_decor = 1;
      } else {

        ((*providers).items[(k)]) = ((void*)0);
      }
...
void decor_providers_invoke_buf(buf_T *buf, DecorProviders *providers, char **err)
{
  for (size_t i = 0; i < ((*providers).size); i++) {
    ...
    if (p && p->redraw_buf != (-2)) {
      ...
      decor_provider_invoke(p->ns_id, "buf", p->redraw_buf, args, 1, err);
    }
  }
}
...
void decor_providers_invoke_end(DecorProviders *providers, char **err)
{
  for (size_t i = 0; i < ((*providers).size); i++) {
    ...
    if (p && p->active && p->redraw_end != (-2)) {
      Array args = { .size = 0, .capacity = 0, .items = ((void*)0) }; Object args__items[1]; args.capacity = 1; args.items = args__items;;
      (*((args).items + ((args).size++)) = (((Object) { .type = kObjectTypeInteger, .data.integer = (int)display_tick })));
      decor_provider_invoke(p->ns_id, "end", p->redraw_end, args, 1, err);
    }
  }
}
...
{
  (__builtin_expect(!(ns_id > 0), 0) ? __assert_rtn(__func__, "decoration_provider.c", 199, "ns_id > 0") : (void)0);
  size_t i;
