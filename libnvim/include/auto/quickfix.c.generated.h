...
static void qf_parse_fmt_plus(const char *linebuf, size_t linelen, qffields_T *fields) FUNC_ATTR_NONNULL_ALL;
...
static void qf_fmt_text(const char *restrict text, char *restrict buf, int bufsize) FUNC_ATTR_NONNULL_ALL;
