# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/buffer_updates.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/buffer_updates.c" 2
...
# 5 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/buffer_updates.c" 2
...
# 7 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/buffer_updates.c" 2
...
# 8 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/buffer_updates.c" 2
...
# 10 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/buffer_updates.c" 2
...
# 12 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/buffer_updates.c" 2
                              ...
                              int64_t num_removed)
{
  ...
  _Bool send_tick = !(cmdpreview && buf == curbuf);
  ...
  if (badchannelid != 0) {
    logmsg(4, ((void*)0), __func__, 250, 1, "Disabling buffer updates for dead channel %" "ll" "u", badchannelid);
  ...
  for (size_t i = 0; i < ((buf->update_callbacks).size); i++) {
    ...
    if (cb.on_lines != (-2) && (cb.preview || !cmdpreview)) {
      ...
      textlock++;
      Object res = nlua_call_ref(cb.on_lines, "lines", args, 0, ((void*)0));
      textlock--;
                             ...
                             colnr_T new_col, bcount_t new_byte)
{
  ...
  for (size_t i = 0; i < ((buf->update_callbacks).size); i++) {
    ...
    if (cb.on_bytes != (-2) && (cb.preview || !cmdpreview)) {
      Array args = { .size = 0, .capacity = 0, .items = ((void*)0) }; Object args__items[11]; args.capacity = 11; args.items = args__items;;
      ...
      textlock++;
      Object res = nlua_call_ref(cb.on_bytes, "bytes", args, 0, ((void*)0));
      textlock--;
