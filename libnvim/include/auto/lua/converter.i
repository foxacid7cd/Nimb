# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/converter.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/converter.c" 2
...
# 5 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/converter.c" 2
...
# 6 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/converter.c" 2
...
# 8 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/converter.c" 2
...
# 9 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/converter.c" 2
...
# 12 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/converter.c" 2
...
# 13 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/converter.c" 2

# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/func_attr.h" 1
# 15 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/converter.c" 2
...
# 21 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/converter.c" 2
...
# 23 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/converter.c" 2
...
# 25 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/converter.c" 2
...
# 26 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/converter.c" 2
...
# 52 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/converter.c"
  ...
  FUNC_ATTR_NONNULL_ALL FUNC_ATTR_WARN_UNUSED_RESULT
{
  ...
  if (!lua_checkstack(lstate, lua_gettop(lstate) + 3)) {
    semsg(libintl_gettext((char *)("E1502: Lua failed to grow stack to %i")), lua_gettop(lstate) + 2);
  ...
  while (lua_next(lstate, -2)) {
    ...
    case 3: {
      const lua_Number n = lua_tonumberx(lstate,(-2),((void*)0));
    ...
    case 1: {
      ...
      if (b == 1) {
        if (lua_type(lstate, -1) == 3) {
          lua_Number n = lua_tonumberx(lstate,(-1),((void*)0));
        ...
        if (val_type == 3) {
          ret.val = lua_tonumberx(lstate,(-1),((void*)0));
        }
      }
      break;
    }
...
# 191 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/converter.c"
_Bool nlua_pop_typval(lua_State *lstate, typval_T *ret_tv)
{
  _Bool ret = 1;
  const int initial_size = lua_gettop(lstate);
  struct { size_t size; size_t capacity; TVPopStackItem *items; TVPopStackItem init_array[2]; } stack = { .size = 0, .capacity = 0, .items = ((void*)0) };
  ...
  while (ret && ((stack).size)) {
    ...
    if (cur.container) {
      if (cur.special || cur.tv->v_type == VAR_DICT) {
        (__builtin_expect(!(cur.tv->v_type == (cur.special ? VAR_LIST : VAR_DICT)), 0) ? __assert_rtn(__func__, "converter.c", 207, "cur.tv->v_type == (cur.special ? VAR_LIST : VAR_DICT)") : (void)0);
        ...
        (__builtin_expect(!(cur.tv->v_type == VAR_LIST), 0) ? __assert_rtn(__func__, "converter.c", 255, "cur.tv->v_type == VAR_LIST") : (void)0);
    ...
    (__builtin_expect(!(!cur.container), 0) ? __assert_rtn(__func__, "converter.c", 275, "!cur.container") : (void)0);
    *cur.tv = (typval_T) {
      .v_type = VAR_NUMBER,
      .v_lock = VAR_UNLOCKED,
      .vval = { .v_number = 0 },
    ...
    case 3: {
      const lua_Number n = lua_tonumberx(lstate,(-1),((void*)0));
    ...
    case 5: {
      ...
      case kObjectTypeDictionary:
        if (table_props.string_keys_num == 0) {
          ...
          if (table_props.has_string_with_nul) {
            ...
            (__builtin_expect(!(cur.tv->v_type == VAR_DICT), 0) ? __assert_rtn(__func__, "converter.c", 352, "cur.tv->v_type == VAR_DICT") : (void)0);
            dictitem_T *const val_di = tv_dict_find(cur.tv->vval.v_dict,
                                                    ("_VAL"), (sizeof("_VAL") - 1));
            (__builtin_expect(!(val_di != ((void*)0)), 0) ? __assert_rtn(__func__, "converter.c", 355, "val_di != NULL") : (void)0);
            cur.tv = &val_di->di_tv;
            cur.tv->vval.v_list->lua_table_ref = table_ref;
            (__builtin_expect(!(cur.tv->v_type == VAR_LIST), 0) ? __assert_rtn(__func__, "converter.c", 358, "cur.tv->v_type == VAR_LIST") : (void)0);
          } else {
            cur.tv->v_type = VAR_DICT;
            cur.tv->vval.v_dict = tv_dict_alloc();
            cur.tv->vval.v_dict->dv_refcount++;
      ...
      case kObjectTypeFloat:
        ...
        break;
      case kObjectTypeNil:
        emsg(libintl_gettext((char *)("E5100: Cannot convert given lua table: table " "should either have a sequence of positive integer keys " "or contain only string keys")));
...
nlua_pop_typval_table_processing_end:
    ...
    case 7: {
      ...
      if (is_nil) {
        ...
        emsg(libintl_gettext((char *)("E5101: Cannot convert given lua type")));
        ret = 0;
      }
      break;
    }
  ...
  do { if ((stack).items != (stack).init_array) { do { void **ptr_ = (void **)&((stack).items); xfree(*ptr_); *ptr_ = ((void*)0); (void)(*ptr_); } while (0); } } while (0);
  if (!ret) {
    tv_clear(ret_tv);
    *ret_tv = (typval_T) {
      .v_type = VAR_NUMBER,
  ...
  (__builtin_expect(!(lua_gettop(lstate) == initial_size - 1), 0) ? __assert_rtn(__func__, "converter.c", 429, "lua_gettop(lstate) == initial_size - 1") : (void)0);
  return ret;
}

static _Bool typval_conv_special = 0;
# 567 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/converter.c"
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/typval_encode.c.h" 1
# 245 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/typval_encode.c.h"
# 1 "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.0.sdk/usr/include/assert.h" 1 3 4
# 82 "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.0.sdk/usr/include/assert.h" 3 4
void __assert_rtn(const char *, const char *, int, const char *) __attribute__((__noreturn__)) __attribute__((__cold__)) __attribute__((__disable_tail_calls__));
# 246 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/typval_encode.c.h" 2

# 1 "/Applications/Xcode-14.1.0.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/14.0.0/include/stddef.h" 1 3
# 248 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/typval_encode.c.h" 2
...
# 8 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/encode.h" 2
...
# 250 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/typval_encode.c.h" 2

# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/typval_encode.h" 1
...
# 82 "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.0.sdk/usr/include/assert.h" 3 4
void __assert_rtn(const char *, const char *, int, const char *) __attribute__((__noreturn__)) __attribute__((__cold__)) __attribute__((__disable_tail_calls__));
# 9 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/typval_encode.h" 2

# 1 "/Applications/Xcode-14.1.0.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/14.0.0/include/stddef.h" 1 3
# 11 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/typval_encode.h" 2




# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/func_attr.h" 1
# 16 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/typval_encode.h" 2
...
# 74 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/typval_encode.h"
...
# 85 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/typval_encode.h"
static inline size_t tv_strlen(const typval_T *const tv)
{
  (__builtin_expect(!(tv->v_type == VAR_STRING), 0) ? __assert_rtn(__func__, "typval_encode.h", 87, "tv->v_type == VAR_STRING") : (void)0);
  return (tv->vval.v_string == ((void*)0) ? 0 : strlen(tv->vval.v_string));
}
# 252 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/typval_encode.c.h" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/func_attr.h" 1
# 253 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/typval_encode.c.h" 2
...
__attribute__((nonnull(2, 3, 4, 7))) __attribute__((warn_unused_result))
  __attribute__((always_inline));
# 286 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/typval_encode.c.h"
static inline int _typval_encode_lua_check_self_reference(
...
# 323 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/typval_encode.c.h"
static int _typval_encode_lua_convert_one_value(
                                           ...
                                           MPConvStackVal *const cur_mpsv, typval_T *const tv, const int copyID, const char *const objname)
{
  ...
  case VAR_FLOAT:
    ...
    break;
  case VAR_BLOB:
    do { const blob_T *const blob_ = (tv->vval.v_blob); lua_pushlstring(lstate, blob_ != ((void*)0) ? (const char *)blob_->bv_ga.ga_data : "", (size_t)(tv_blob_len(tv->vval.v_blob))); } while (0);

    break;
  case VAR_FUNC:
    do { ufunc_T *fp = find_func((char_u *)tv->vval.v_string); if (fp != ((void*)0) && fp->uf_flags & 0x800) { nlua_pushref(lstate, fp->uf_luaref); } else { do { if (typval_conv_special) { lua_pushnil(lstate); } else { nlua_pushref(lstate, nlua_global_refs->nil_ref); } } while (0); } goto typval_encode_stop_converting_one_item; } while (0);
                                              ;
                                               ;
                                   ;
    break;
  case VAR_PARTIAL: {
    ...
    (void)pt;
    do { ufunc_T *fp = find_func((pt == ((void*)0) ? ((void*)0) : (char_u *)partial_name(pt))); if (fp != ((void*)0) && fp->uf_flags & 0x800) { nlua_pushref(lstate, fp->uf_luaref); } else { do { if (typval_conv_special) { lua_pushnil(lstate); } else { nlua_pushref(lstate, nlua_global_refs->nil_ref); } } while (0); } goto typval_encode_stop_converting_one_item; } while (0);
...
# 362 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/typval_encode.c.h"
    break;
  }
  case VAR_LIST: {
    ...
    do { if (!lua_checkstack(lstate, lua_gettop(lstate) + 3)) { semsg(libintl_gettext((char *)("E5102: Lua failed to grow stack to %i")), lua_gettop(lstate) + 3); return 0; } lua_createtable(lstate, (int)(tv_list_len(tv->vval.v_list)), 0); lua_pushnumber(lstate, 1); } while (0);
    (__builtin_expect(!(saved_copyID != copyID), 0) ? __assert_rtn(__func__, "typval_encode.c.h", 373, "saved_copyID != copyID") : (void)0);
    (*((((*mpstack).size == (*mpstack).capacity) ? (((*mpstack).capacity = (((*mpstack).capacity << 1) > ((sizeof((*mpstack).init_array)/sizeof(((*mpstack).init_array)[0])) / ((size_t)(!(sizeof((*mpstack).init_array) % sizeof(((*mpstack).init_array)[0]))))) ? ((*mpstack).capacity << 1) : ((sizeof((*mpstack).init_array)/sizeof(((*mpstack).init_array)[0])) / ((size_t)(!(sizeof((*mpstack).init_array) % sizeof(((*mpstack).init_array)[0])))))), (*mpstack).items = ((*mpstack).capacity == ((sizeof((*mpstack).init_array)/sizeof(((*mpstack).init_array)[0])) / ((size_t)(!(sizeof((*mpstack).init_array) % sizeof(((*mpstack).init_array)[0]))))) ? ((*mpstack).items == (*mpstack).init_array ? (*mpstack).items : _memcpy_free((*mpstack).init_array, (*mpstack).items, (*mpstack).size * sizeof((*mpstack).items[0]))) : ((*mpstack).items == (*mpstack).init_array ? __builtin___memcpy_chk (xmalloc((*mpstack).capacity * sizeof((*mpstack).items[0])), (*mpstack).items, (*mpstack).size * sizeof((*mpstack).items[0]), __builtin_object_size (xmalloc((*mpstack).capacity * sizeof((*mpstack).items[0])), 0)) : xrealloc((*mpstack).items, (*mpstack).capacity * sizeof((*mpstack).items[0]))))), 0) : 0), ((*mpstack).items + ((*mpstack).size++))) = (((MPConvStackVal) { .type = kMPConvList, .tv = tv, .saved_copyID = saved_copyID, .data = { .l = { .list = tv->vval.v_list, .li = tv_list_first(tv->vval.v_list), }, }, })));
# 385 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/typval_encode.c.h"
                                                                    ;
    break;
  }
  case VAR_BOOL:
  ...
  case VAR_DICT: {
    ...
    if (1
      ...
      case kMPArray: {
        ...
        do { if (!lua_checkstack(lstate, lua_gettop(lstate) + 3)) { semsg(libintl_gettext((char *)("E5102: Lua failed to grow stack to %i")), lua_gettop(lstate) + 3); return 0; } lua_createtable(lstate, (int)(tv_list_len(val_di->di_tv.vval.v_list)), 0); lua_pushnumber(lstate, 1); } while (0);
        (__builtin_expect(!(saved_copyID != copyID && saved_copyID != copyID - 1), 0) ? __assert_rtn(__func__, "typval_encode.c.h", 528, "saved_copyID != copyID && saved_copyID != copyID - 1") : (void)0);
...
# 540 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/typval_encode.c.h"
        break;
      }
      case kMPMap: {
        if (val_di->di_tv.v_type != VAR_LIST) {
        ...
        do { if (!lua_checkstack(lstate, lua_gettop(lstate) + 3)) { semsg(libintl_gettext((char *)("E5102: Lua failed to grow stack to %i")), lua_gettop(lstate) + 3); return 0; } lua_createtable(lstate, 0, (int)(tv_list_len(val_list))); } while (0);

        (__builtin_expect(!(saved_copyID != copyID && saved_copyID != copyID - 1), 0) ? __assert_rtn(__func__, "typval_encode.c.h", 563, "saved_copyID != copyID && saved_copyID != copyID - 1") : (void)0);
        (*((((*mpstack).size == (*mpstack).capacity) ? (((*mpstack).capacity = (((*mpstack).capacity << 1) > ((sizeof((*mpstack).init_array)/sizeof(((*mpstack).init_array)[0])) / ((size_t)(!(sizeof((*mpstack).init_array) % sizeof(((*mpstack).init_array)[0]))))) ? ((*mpstack).capacity << 1) : ((sizeof((*mpstack).init_array)/sizeof(((*mpstack).init_array)[0])) / ((size_t)(!(sizeof((*mpstack).init_array) % sizeof(((*mpstack).init_array)[0])))))), (*mpstack).items = ((*mpstack).capacity == ((sizeof((*mpstack).init_array)/sizeof(((*mpstack).init_array)[0])) / ((size_t)(!(sizeof((*mpstack).init_array) % sizeof(((*mpstack).init_array)[0]))))) ? ((*mpstack).items == (*mpstack).init_array ? (*mpstack).items : _memcpy_free((*mpstack).init_array, (*mpstack).items, (*mpstack).size * sizeof((*mpstack).items[0]))) : ((*mpstack).items == (*mpstack).init_array ? __builtin___memcpy_chk (xmalloc((*mpstack).capacity * sizeof((*mpstack).items[0])), (*mpstack).items, (*mpstack).size * sizeof((*mpstack).items[0]), __builtin_object_size (xmalloc((*mpstack).capacity * sizeof((*mpstack).items[0])), 0)) : xrealloc((*mpstack).items, (*mpstack).capacity * sizeof((*mpstack).items[0]))))), 0) : 0), ((*mpstack).items + ((*mpstack).size++))) = (((MPConvStackVal) { .tv = tv, .type = kMPConvPairs, .saved_copyID = saved_copyID, .data = { .l = { .list = val_list, .li = tv_list_first(val_list), }, }, })));
# 575 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/typval_encode.c.h"
        break;
      }
      case kMPExt: {
        const list_T *val_list;
...
_convert_one_value_regular_dict: {}
    ...
    do { if (!lua_checkstack(lstate, lua_gettop(lstate) + 3)) { semsg(libintl_gettext((char *)("E5102: Lua failed to grow stack to %i")), lua_gettop(lstate) + 3); return 0; } lua_createtable(lstate, 0, (int)(tv->vval.v_dict->dv_hashtab.ht_used)); } while (0);

    (__builtin_expect(!(saved_copyID != copyID), 0) ? __assert_rtn(__func__, "typval_encode.c.h", 612, "saved_copyID != copyID") : (void)0);
...
# 627 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/typval_encode.c.h"
                                                                ;
    break;
  }
  case VAR_UNKNOWN:
...
# 654 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/typval_encode.c.h"
static int encode_vim_to_lua(
  ...
  while (((mpstack).size)) {
    ...
    case kMPConvList:
      if (cur_mpsv->data.l.li == ((void*)0)) {
        ...
        do { lua_Number idx = lua_tonumberx(lstate,(-2),((void*)0)); lua_rawset(lstate, -3); lua_pushnumber(lstate, idx + 1); } while (0);
      }
    ...
    case kMPConvPartial: {
      ...
      case kMPConvPartialArgs:
        ...
        if (pt != ((void*)0) && pt->pt_argc > 0) {
          do { if (!lua_checkstack(lstate, lua_gettop(lstate) + 3)) { semsg(libintl_gettext((char *)("E5102: Lua failed to grow stack to %i")), lua_gettop(lstate) + 3); return 0; } lua_createtable(lstate, (int)(pt->pt_argc), 0); lua_pushnumber(lstate, 1); } while (0);
          (*((((mpstack).size == (mpstack).capacity) ? (((mpstack).capacity = (((mpstack).capacity << 1) > ((sizeof((mpstack).init_array)/sizeof(((mpstack).init_array)[0])) / ((size_t)(!(sizeof((mpstack).init_array) % sizeof(((mpstack).init_array)[0]))))) ? ((mpstack).capacity << 1) : ((sizeof((mpstack).init_array)/sizeof(((mpstack).init_array)[0])) / ((size_t)(!(sizeof((mpstack).init_array) % sizeof(((mpstack).init_array)[0])))))), (mpstack).items = ((mpstack).capacity == ((sizeof((mpstack).init_array)/sizeof(((mpstack).init_array)[0])) / ((size_t)(!(sizeof((mpstack).init_array) % sizeof(((mpstack).init_array)[0]))))) ? ((mpstack).items == (mpstack).init_array ? (mpstack).items : _memcpy_free((mpstack).init_array, (mpstack).items, (mpstack).size * sizeof((mpstack).items[0]))) : ((mpstack).items == (mpstack).init_array ? __builtin___memcpy_chk (xmalloc((mpstack).capacity * sizeof((mpstack).items[0])), (mpstack).items, (mpstack).size * sizeof((mpstack).items[0]), __builtin_object_size (xmalloc((mpstack).capacity * sizeof((mpstack).items[0])), 0)) : xrealloc((mpstack).items, (mpstack).capacity * sizeof((mpstack).items[0]))))), 0) : 0), ((mpstack).items + ((mpstack).size++))) = (((MPConvStackVal) { .type = kMPConvPartialList, .tv = ((void*)0), .saved_copyID = copyID - 1, .data = { .a = { .arg = pt->pt_argv, .argv = pt->pt_argv, .todo = (size_t)pt->pt_argc, }, }, })));
# 762 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/typval_encode.c.h"
        }
        break;
      case kMPConvPartialSelf: {
        ...
        if (dict != ((void*)0)) {
          ...
          do { if (!lua_checkstack(lstate, lua_gettop(lstate) + 3)) { semsg(libintl_gettext((char *)("E5102: Lua failed to grow stack to %i")), lua_gettop(lstate) + 3); return 0; } lua_createtable(lstate, 0, (int)(dict->dv_hashtab.ht_used)); } while (0);

          (__builtin_expect(!(saved_copyID != copyID && saved_copyID != copyID - 1), 0) ? __assert_rtn(__func__, "typval_encode.c.h", 787, "saved_copyID != copyID && saved_copyID != copyID - 1") : (void)0);
...
# 802 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/typval_encode.c.h"
                                                                     ;
        } else {
                                                     ;
        }
    ...
    (__builtin_expect(!(tv != ((void*)0)), 0) ? __assert_rtn(__func__, "typval_encode.c.h", 827, "tv != NULL") : (void)0);
    if (_typval_encode_lua_convert_one_value(lstate, &mpstack,
...
# 568 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/converter.c" 2
# 610 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/converter.c"
_Bool nlua_push_typval(lua_State *lstate, typval_T *const tv, _Bool special)
{
  ...
  if (!lua_checkstack(lstate, initial_size + 2)) {
    semsg(libintl_gettext((char *)("E1502: Lua failed to grow stack to %i")), initial_size + 4);
    return 0;
  }
  if (encode_vim_to_lua(lstate, tv, "nlua_push_typval argument") == 0) {
    return 0;
  }
  (__builtin_expect(!(lua_gettop(lstate) == initial_size + 1), 0) ? __assert_rtn(__func__, "converter.c", 622, "lua_gettop(lstate) == initial_size + 1") : (void)0);
  return 1;
}
...
void nlua_push_Dictionary(lua_State *lstate, const Dictionary dict, _Bool special)
  FUNC_ATTR_NONNULL_ALL
{
...
# 758 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/converter.c"
  ...
  FUNC_ATTR_NONNULL_ALL FUNC_ATTR_WARN_UNUSED_RESULT
{
  ...
  (__builtin_expect(!(ret.data != ((void*)0)), 0) ? __assert_rtn(__func__, "converter.c", 820, "ret.data != NULL") : (void)0);
...
# 866 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/converter.c"
...
{
  if (lua_type(lstate, -1) == 3) {
    const Float ret = (Float)lua_tonumberx(lstate,(-1),((void*)0));
    lua_settop(lstate, -(1)-1);
    return ret;
  }
...
# 971 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/converter.c"
...
Object nlua_pop_Object(lua_State *const lstate, _Bool ref, Error *const err)
{
  ...
  const int initial_size = lua_gettop(lstate);
  struct { size_t size; size_t capacity; ObjPopStackItem *items; ObjPopStackItem init_array[2]; } stack = { .size = 0, .capacity = 0, .items = ((void*)0) };
  ((stack).capacity = ((sizeof((stack).init_array)/sizeof(((stack).init_array)[0])) / ((size_t)(!(sizeof((stack).init_array) % sizeof(((stack).init_array)[0]))))), (stack).size = 0, (stack).items = (stack).init_array);
  (*((((stack).size == (stack).capacity) ? (((stack).capacity = (((stack).capacity << 1) > ((sizeof((stack).init_array)/sizeof(((stack).init_array)[0])) / ((size_t)(!(sizeof((stack).init_array) % sizeof(((stack).init_array)[0]))))) ? ((stack).capacity << 1) : ((sizeof((stack).init_array)/sizeof(((stack).init_array)[0])) / ((size_t)(!(sizeof((stack).init_array) % sizeof(((stack).init_array)[0])))))), (stack).items = ((stack).capacity == ((sizeof((stack).init_array)/sizeof(((stack).init_array)[0])) / ((size_t)(!(sizeof((stack).init_array) % sizeof(((stack).init_array)[0]))))) ? ((stack).items == (stack).init_array ? (stack).items : _memcpy_free((stack).init_array, (stack).items, (stack).size * sizeof((stack).items[0]))) : ((stack).items == (stack).init_array ? __builtin___memcpy_chk (xmalloc((stack).capacity * sizeof((stack).items[0])), (stack).items, (stack).size * sizeof((stack).items[0]), __builtin_object_size (xmalloc((stack).capacity * sizeof((stack).items[0])), 0)) : xrealloc((stack).items, (stack).capacity * sizeof((stack).items[0]))))), 0) : 0), ((stack).items + ((stack).size++))) = (((ObjPopStackItem) { &ret, 0 })));
  while (!((err)->type != kErrorTypeNone) && ((stack).size)) {
    ...
    (__builtin_expect(!(!cur.container), 0) ? __assert_rtn(__func__, "converter.c", 1114, "!cur.container") : (void)0);
...
type_error:
  ...
  (__builtin_expect(!(lua_gettop(lstate) == initial_size - 1), 0) ? __assert_rtn(__func__, "converter.c", 1215, "lua_gettop(lstate) == initial_size - 1") : (void)0);
  return ret;
}
...
# 1241 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/converter.c"
Buffer nlua_pop_Buffer(lua_State *lstate, Error *err) FUNC_ATTR_NONNULL_ALL FUNC_ATTR_WARN_UNUSED_RESULT { Buffer ret; if (lua_type(lstate, -1) != 3) { api_set_error(err, kErrorTypeValidation, "Expected Lua number"); ret = (Buffer) - 1; } else { ret = (Buffer)lua_tonumberx(lstate,(-1),((void*)0)); } lua_settop(lstate, -(1)-1); return ret; }
Window nlua_pop_Window(lua_State *lstate, Error *err) FUNC_ATTR_NONNULL_ALL FUNC_ATTR_WARN_UNUSED_RESULT { Window ret; if (lua_type(lstate, -1) != 3) { api_set_error(err, kErrorTypeValidation, "Expected Lua number"); ret = (Window) - 1; } else { ret = (Window)lua_tonumberx(lstate,(-1),((void*)0)); } lua_settop(lstate, -(1)-1); return ret; }
Tabpage nlua_pop_Tabpage(lua_State *lstate, Error *err) FUNC_ATTR_NONNULL_ALL FUNC_ATTR_WARN_UNUSED_RESULT { Tabpage ret; if (lua_type(lstate, -1) != 3) { api_set_error(err, kErrorTypeValidation, "Expected Lua number"); ret = (Tabpage) - 1; } else { ret = (Tabpage)lua_tonumberx(lstate,(-1),((void*)0)); } lua_settop(lstate, -(1)-1); return ret; }
# 1257 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/converter.c"
