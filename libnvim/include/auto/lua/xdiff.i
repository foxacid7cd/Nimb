# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/xdiff.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/xdiff.c" 2
...
# 5 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/xdiff.c" 2
...
# 6 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/xdiff.c" 2
...
# 8 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/xdiff.c" 2
...
# 10 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/xdiff.c" 2
...
# 11 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/xdiff.c" 2
...
# 13 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/xdiff.c" 2
...
# 14 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/xdiff.c" 2
...
# 15 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/xdiff.c" 2
...
# 16 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/xdiff.c" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/xdiff.h" 1
# 17 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/xdiff.c" 2
...
# 19 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/xdiff.c" 2
...
static void get_linematch_results(lua_State *lstate, mmfile_t *ma, mmfile_t *mb, long start_a,
                                  long count_a, long start_b, long count_b, _Bool iwhite)
{
...
static int write_string(void *priv, mmbuffer_t *mb, int nbuf)
{
  ...
  for (int i = 0; i < nbuf; i++) {
    ...
    for (long total = 0; total < size; total += ((int)(0x80 * sizeof(void*) * sizeof(lua_Integer)))) {
      const int tocopy = (((int)(size - total)) < (((int)(0x80 * sizeof(void*) * sizeof(lua_Integer)))) ? ((int)(size - total)) : (((int)(0x80 * sizeof(void*) * sizeof(lua_Integer)))));
      char *p = luaL_prepbuffsize(buf, ((int)(0x80 * sizeof(void*) * sizeof(lua_Integer))));
      if (!p) {
        return -1;
      }
      __builtin___memcpy_chk (p, mb[i].ptr + total, (unsigned)tocopy, __builtin_object_size (p, 0));
      ((buf)->n += ((unsigned)tocopy));
    }
  }
  return 0;
}
...
static int call_on_hunk_cb(long start_a, long count_a, long start_b, long count_b, void *cb_data)
{
  ...
  if (lua_pcallk(lstate, (4), (1), (0), 0, ((void*)0)) != 0) {
    api_set_error(err, kErrorTypeException,
                  "error running function on_hunk: %s",
                  lua_tolstring(lstate, (-1), ((void*)0)));
    return -1;
  }

  int r = 0;
  if (lua_isnumber(lstate, -1)) {
    r = (int)lua_tonumberx(lstate,(-1),((void*)0));
  }
...
static NluaXdiffMode process_xdl_diff_opts(lua_State *lstate, xdemitconf_t *cfg, xpparam_t *params,
                                           _Bool *linematch, Error *err)
{
  const DictionaryOf(LuaRef) opts = nlua_pop_Dictionary(lstate, 1, err);

  NluaXdiffMode mode = kNluaXdiffModeUnified;

  _Bool had_on_hunk = 0;
  _Bool had_result_type_indices = 0;
  for (size_t i = 0; i < opts.size; i++) {
    ...
    if (strequal("on_hunk", k.data)) {
      ...
      *linematch = api_object_to_bool(*v, "linematch", 0, err);
...
int nlua_xdl_diff(lua_State *lstate)
{
  ...
  __builtin___memset_chk (&(cfg), 0, sizeof(cfg), __builtin_object_size (&(cfg), 0));
  __builtin___memset_chk (&(params), 0, sizeof(params), __builtin_object_size (&(params), 0));
  __builtin___memset_chk (&(ecb), 0, sizeof(ecb), __builtin_object_size (&(ecb), 0));
