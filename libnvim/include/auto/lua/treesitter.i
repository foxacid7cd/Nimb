# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/treesitter.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/treesitter.c" 2
...
# 9 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/treesitter.c" 2
...
# 10 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/treesitter.c" 2
...
# 11 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/treesitter.c" 2
...
# 13 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/treesitter.c" 2
...
# 14 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/treesitter.c" 2
...
# 16 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/treesitter.c" 2
...
# 17 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/treesitter.c" 2
...
# 18 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/treesitter.c" 2
...
# 20 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/treesitter.c" 2
...
# 21 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/treesitter.c" 2
...
# 22 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/treesitter.c" 2
...
# 24 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/treesitter.c" 2
# 35 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/treesitter.c"
typedef struct {
...
static struct { size_t size; size_t capacity; TSQueryCursor * *items; } cursors = { .size = 0, .capacity = 0, .items = ((void*)0) };
static Map_cstr_t_ptr_t langs = { { 0, 0, 0, 0, ((void*)0), ((void*)0), ((void*)0) } };
...
int tslua_add_language(lua_State *L)
{
  ...
  if (lua_gettop(L) >= 3 && !(lua_type(L, (3)) == 0)) {
    symbol_name = (luaL_checklstring(L, (3), ((void*)0)));
  }
  ...
  char symbol_buf[128];
  __builtin___snprintf_chk (symbol_buf, 128, 0, __builtin_object_size (symbol_buf, 1 > 1 ? 1 : 0), "tree_sitter_%s", symbol_name);
...
{
  const char *lang_name = (luaL_checklstring(L, (1), ((void*)0)));
  _Bool present = map_cstr_t_ptr_t_has(&langs, lang_name);
  if (present) {
...
int tslua_inspect_lang(lua_State *L)
{
  ...
  (__builtin_expect(!(nsymbols < 2147483647), 0) ? __assert_rtn(__func__, "treesitter.c", 243, "nsymbols < INT_MAX") : (void)0);
...
int tslua_push_parser(lua_State *L)
{
  ...
  *parser = ts_parser_new();
  ...
  lua_getfield(L, (-1000000 - 1000), "treesitter_parser");
                            ...
                            uint32_t *bytes_read)
{
  ...
  char *line = ml_get_buf(bp, (linenr_T)position.row + 1, 0);
...
static int parser_parse(lua_State *L)
{
  ...
  case 3:
    bufnr = lua_tointegerx(L,(3),((void*)0));
    buf = map_handle_T_ptr_t_get(&buffer_handles, ((handle_T)bufnr));

    if (!buf) {

      char ebuf[256] = { 0 };
      vim_snprintf(ebuf, 256, "invalid buffer handle: %ld", bufnr);
  ...
  uint32_t n_ranges = 0;
  TSRange *changed = old_tree ? ts_tree_get_changed_ranges(old_tree, new_tree, &n_ranges) : ((void*)0);
...
void push_tree(lua_State *L, TSTree *tree, _Bool do_copy)
{
  ...
  lua_getfield(L, (-1000000 - 1000), "treesitter_tree");
  lua_setmetatable(L, -2);
...
# 667 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/treesitter.c"
static void push_node(lua_State *L, TSNode node, int uindex)
{
  (__builtin_expect(!(uindex > 0 || uindex < -20), 0) ? __assert_rtn(__func__, "treesitter.c", 669, "uindex > 0 || uindex < -LUA_MINSTACK") : (void)0);
  ...
  *ud = node;
  lua_getfield(L, (-1000000 - 1000), "treesitter_node");
  lua_setmetatable(L, -2);
...
static int node_field(lua_State *L)
{
  ...
  if (ts_tree_cursor_goto_first_child(&cursor)) {
    do {
      ...
      if (current_field != ((void*)0) && !strcmp(field_name, current_field)) {
...
static int node_child(lua_State *L)
{
  ...
  long num = lua_tointegerx(L,(2),((void*)0));
...
static int node_descendant_for_range(lua_State *L)
{
  ...
  TSPoint start = { (uint32_t)lua_tointegerx(L,(2),((void*)0)),
                    (uint32_t)lua_tointegerx(L,(3),((void*)0)) };
  TSPoint end = { (uint32_t)lua_tointegerx(L,(4),((void*)0)),
                  (uint32_t)lua_tointegerx(L,(5),((void*)0)) };
...
{
  TSTreeCursor *ud = luaL_checkudata(L, ((-1000000 - 1000) - (1)), "treesitter_treecursor");
  if (!ud) {
    return 0;
  }

  TSNode source;
  if (!node_check(L, ((-1000000 - 1000) - (2)), &source)) {
    return 0;
  }
...
static int node_iter_children(lua_State *L)
{
  ...
  *ud = ts_tree_cursor_new(source);
  ...
  lua_getfield(L, (-1000000 - 1000), "treesitter_treecursor");
  lua_setmetatable(L, -2);
  lua_pushvalue(L, 1);
...
{
  TSLua_cursor *ud = lua_touserdata(L, ((-1000000 - 1000) - (1)));
  TSQueryCursor *cursor = ud->cursor;

  TSQuery *query = query_check(L, ((-1000000 - 1000) - (3)));
  TSQueryMatch match;
  if (ts_query_cursor_next_match(cursor, &match)) {
    lua_pushinteger(L, match.pattern_index + 1);
    lua_createtable(L, (int)ts_query_capture_count(query), 2);
    set_match(L, &match, ((-1000000 - 1000) - (2)));
    return 2;
  }
  return 0;
}
...
static int query_next_capture(lua_State *L)
{
  ...
  if (ud->predicated_match > -1) {
    lua_getfield(L, ((-1000000 - 1000) - (4)), "active");
  ...
  if (ts_query_cursor_next_capture(cursor, &match, &capture_index)) {
    ...
    push_node(L, capture.node, ((-1000000 - 1000) - (2)));
    ...
    if (n_pred > 0 && (ud->max_match_id < (int)match.id)) {
      ...
      lua_pushvalue(L, ((-1000000 - 1000) - (4)));
      set_match(L, &match, ((-1000000 - 1000) - (2)));
      lua_pushinteger(L, match.pattern_index + 1);
...
static int node_rawquery(lua_State *L)
{
  ...
  lua_getfield(L, (-1000000 - 1000), "treesitter_querycursor");
  lua_setmetatable(L, -2);
  lua_pushvalue(L, 1);
...
int tslua_parse_query(lua_State *L)
{
  ...
  *ud = query;
  lua_getfield(L, (-1000000 - 1000), "treesitter_query");
  lua_setmetatable(L, -2);
  return 1;
}
