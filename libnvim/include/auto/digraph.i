# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/digraph.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/digraph.c" 2
...
# 9 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/digraph.c" 2
...
# 10 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/digraph.c" 2
...
# 11 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/digraph.c" 2
...
# 13 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/digraph.c" 2
...
# 14 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/digraph.c" 2
...
# 5 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/digraph.h" 2
# 15 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/digraph.c" 2
...
# 16 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/digraph.c" 2
...
# 18 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/digraph.c" 2
...
# 19 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/digraph.c" 2
...
# 21 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/digraph.c" 2
...
# 22 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/digraph.c" 2




# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/os/input.h" 1
# 27 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/digraph.c" 2
...
int get_digraph(_Bool cmdline)
{
  ...
  if (c != '\033') {
    ...
    if (cc != '\033') {
      ...
      return digraph_get(c, cc, 1);
    }
  }
  return '\000';
}
# 1557 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/digraph.c"
...
# 1608 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/digraph.c"
int digraph_get(int char1, int char2, _Bool meta_char)
  FUNC_ATTR_PURE
{
  int retval;
...
_Bool check_digraph_chars_valid(int char1, int char2)
{
  if (char2 == 0) {
    char_u msg[21 + 1];
    msg[utf_char2bytes(char1, (char *)msg)] = '\000';
    semsg(libintl_gettext((char *)(e_digraph_must_be_just_two_characters_str)), msg);
    return 0;
  }
  if (char1 == '\033' || char2 == '\033') {
    emsg(libintl_gettext((char *)("E104: Escape not allowed in digraph")));
    return 0;
  }
  return 1;
}
...
void digraph_getlist_common(_Bool list_all, typval_T *rettv)
{
  ...
  FUNC_ATTR_NONNULL_ARG(1)
{
  ...
  if (dp->result != 0) {
    ...
    *p = '\000';
    msg_outtrans_attr((char *)buf, hl_attr_active[(int)(HLF_8)]);
    p = buf;
    if (char2cells(dp->result) == 1) {
      *p++ = ' ';
    }
    (__builtin_expect(!(p >= buf), 0) ? __assert_rtn(__func__, "digraph.c", 1863, "p >= buf") : (void)0);
...
static int get_digraph_chars(const typval_T *arg, int *char1, int *char2)
{
  ...
  semsg(libintl_gettext((char *)(e_digraph_must_be_just_two_characters_str)), chars);
  return 0;
}
...
static _Bool digraph_set_common(const typval_T *argchars, const typval_T *argdigraph)
{
  ...
  if (*p != '\000') {
    semsg(libintl_gettext((char *)(e_digraph_argument_must_be_one_character_str)), digraph);
    return 0;
  }
...
void f_digraph_get(typval_T *argvars, typval_T *rettv, EvalFuncData fptr)
{
  ...
  if (strlen(digraphs) != 2) {
    semsg(libintl_gettext((char *)(e_digraph_must_be_just_two_characters_str)), digraphs);
    return;
  }
  int code = digraph_get(digraphs[0], digraphs[1], 0);
...
void f_digraph_setlist(typval_T *argvars, typval_T *rettv, EvalFuncData fptr)
{
  ...
  if (argvars[0].v_type != VAR_LIST) {
    emsg(libintl_gettext((char *)(e_digraph_setlist_argument_must_be_list_of_lists_with_two_items)));
    return;
  }
  ...
  do { const list_T *const l_ = (pl); ; if (l_ != ((void*)0)) { for (const listitem_T *pli = l_->lv_first; pli != ((void*)0); pli = pli->li_next) { { if ((&(pli)->li_tv)->v_type != VAR_LIST) { emsg(libintl_gettext((char *)(e_digraph_setlist_argument_must_be_list_of_lists_with_two_items))); return; } list_T *l = (&(pli)->li_tv)->vval.v_list; if (l == ((void*)0) || tv_list_len(l) != 2) { emsg(libintl_gettext((char *)(e_digraph_setlist_argument_must_be_list_of_lists_with_two_items))); return; } if (!digraph_set_common((&(tv_list_first(l))->li_tv), (&(((tv_list_first(l))->li_next))->li_tv))) { return; } } } } } while (0);
# 2007 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/digraph.c"
  rettv->vval.v_bool = kBoolVarTrue;
}
...
# 2023 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/digraph.c"
...
void ex_loadkeymap(exarg_T *eap)
{
  ...
  if (!getline_equal(eap->getline, eap->cookie, getsourceline)) {
    emsg(libintl_gettext((char *)("E105: Using :loadkeymap not in a sourced file")));
    return;
  }
  ...
  for (;;) {
    char *line = eap->getline(0, eap->cookie, 0, 1);
    ...
    if ((*p != '"') && (*p != '\000')) {
      ...
      if ((strlen(kp->from) + strlen(kp->to) >= 200)
          ...
          || (*kp->to == '\000')) {
        if (*kp->to == '\000') {
          emsg(libintl_gettext((char *)("E791: Empty keymap entry")));
        }
        xfree(kp->from);
        xfree(kp->to);
  ...
  for (int i = 0; i < curbuf->b_kmap_ga.ga_len; i++) {
    ...
    (void)do_map(0, (char_u *)buf, 0x20, 0);
  }
...
static void keymap_unload(void)
{
  ...
  for (int i = 0; i < curbuf->b_kmap_ga.ga_len; i++) {
    ...
    (void)do_map(1, (char_u *)buf, 0x20, 0);
  }
