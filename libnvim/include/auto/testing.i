# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/testing.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/testing.c" 2
...
# 7 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/testing.c" 2
...
# 8 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/testing.c" 2
...
# 9 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/testing.c" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/os/os.h" 1
# 10 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/testing.c" 2

# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/testing.h" 1
# 12 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/testing.c" 2
...
static void prepare_assert_error(garray_T *gap)
{
  ...
  if ((((estack_T *)exestack.ga_data)[exestack.ga_len - 1].es_lnum) > 0) {
    vim_snprintf(buf, ((sizeof(buf)/sizeof((buf)[0])) / ((size_t)(!(sizeof(buf) % sizeof((buf)[0]))))), "line %" "ll" "d", (int64_t)(((estack_T *)exestack.ga_data)[exestack.ga_len - 1].es_lnum));
    ga_concat(gap, buf);
  }
  if (sname != ((void*)0) || (((estack_T *)exestack.ga_data)[exestack.ga_len - 1].es_lnum) > 0) {
    ga_concat(gap, ": ");
  }
  xfree(sname);
}
  ...
  FUNC_ATTR_NONNULL_ALL
{
  ...
  if (clen > 1) {
    __builtin___memmove_chk (buf, p, (size_t)clen, __builtin_object_size (buf, 0));
    buf[clen] = '\000';
  ...
  FUNC_ATTR_NONNULL_ARG(1)
{
  ...
  for (const char_u *p = str; *p != '\000'; p++) {
    int same_len = 1;
    const char_u *s = p;
    const int c = mb_ptr2char_adv(&s);
    const int clen = (int)(s - p);
    while (*s != '\000' && c == utf_ptr2char((char *)s)) {
      same_len++;
      s += clen;
    }
    if (same_len > 20) {
                              ...
                              typval_T *exp_tv_arg, typval_T *got_tv_arg, assert_type_T atype)
{
  ...
  if (opt_msg_tv->v_type != VAR_UNKNOWN
      && !(opt_msg_tv->v_type == VAR_STRING
           && (opt_msg_tv->vval.v_string == ((void*)0)
               || *opt_msg_tv->vval.v_string == '\000'))) {
    tofree = (char_u *)encode_tv2echo(opt_msg_tv, ((void*)0));
  ...
  if (exp_str == ((void*)0)) {
    ...
    if (atype != ASSERT_NOTEQUAL
        ...
        && exp_tv->vval.v_dict != ((void*)0) && got_tv->vval.v_dict != ((void*)0)) {
      ...
      for (const hashitem_T *hi = exp_d->dv_hashtab.ht_array; todo > 0; hi++) {
        if (!((hi)->hi_key == ((void*)0) || (hi)->hi_key == (char_u *)&hash_removed)) {
          ...
          if (item2 == ((void*)0)
              || !tv_equal(&((dictitem_T *)((hi)->hi_key - __builtin_offsetof(dictitem_T, di_key)))->di_tv, &item2->di_tv, 0, 0)) {

            const size_t key_len = strlen((char *)(hi->hi_key));
            tv_dict_add_tv(exp_tv->vval.v_dict, (const char *)hi->hi_key, key_len,
                           &((dictitem_T *)((hi)->hi_key - __builtin_offsetof(dictitem_T, di_key)))->di_tv);
            if (item2 != ((void*)0)) {
  ...
  FUNC_ATTR_NONNULL_ALL
{
  ...
  if (called_emsg == called_emsg_before
      && pattern_match(pat, text, 0) != (atype == ASSERT_MATCH)) {
    garray_T ga;
    prepare_assert_error(&ga);
...
static int assert_bool(typval_T *argvars, _Bool is_true)
  FUNC_ATTR_NONNULL_ALL
{
  _Bool error = 0;
  garray_T ga;
  ...
  FUNC_ATTR_NONNULL_ALL
{
  if (argvars[1].v_type != VAR_UNKNOWN && argvars[2].v_type != VAR_UNKNOWN) {
    char *const tofree = encode_tv2echo(&argvars[2], ((void*)0));
...
static int assert_beeps(typval_T *argvars, _Bool no_beep)
  FUNC_ATTR_NONNULL_ALL
{
...
{
  rettv->vval.v_number = assert_beeps(argvars, 0);
}


void f_assert_nobeep(typval_T *argvars, typval_T *rettv, EvalFuncData fptr)
{
  rettv->vval.v_number = assert_beeps(argvars, 1);
}
  ...
  FUNC_ATTR_NONNULL_ALL
{
  ...
  ptrdiff_t lineidx = 0;
  if (fd1 == ((void*)0)) {
    __builtin___snprintf_chk ((char *)IObuff, (1024 + 1), 0, __builtin_object_size ((char *)IObuff, 1 > 1 ? 1 : 0), (char *)e_notread, fname1);
  } else {
    FILE *const fd2 = os_fopen(fname2, "rb");
    if (fd2 == ((void*)0)) {
      fclose(fd1);
      __builtin___snprintf_chk ((char *)IObuff, (1024 + 1), 0, __builtin_object_size ((char *)IObuff, 1 > 1 ? 1 : 0), (char *)e_notread, fname2);
    } else {
      int64_t linecount = 1;
      for (int64_t count = 0;; count++) {
        ...
        if (c1 == (-1)) {
          if (c2 != (-1)) {
            __builtin___strcpy_chk ((char *)(IObuff), (char *)("first file is shorter"), __builtin_object_size ((char *)(IObuff), 1 > 1 ? 1 : 0));
          }
          break;
        } else if (c2 == (-1)) {
          __builtin___strcpy_chk ((char *)(IObuff), (char *)("second file is shorter"), __builtin_object_size ((char *)(IObuff), 1 > 1 ? 1 : 0));
          break;
        } else {
          ...
          lineidx++;
          if (c1 != c2) {
            __builtin___snprintf_chk ((char *)IObuff, (1024 + 1), 0, __builtin_object_size ((char *)IObuff, 1 > 1 ? 1 : 0), "difference at byte %" "ll" "d" ", line %" "ll" "d", count, linecount);
        ...
        if (c1 == '\012') {
          ...
          __builtin___memmove_chk (line1, line1 + 100, (size_t)(lineidx - 100), __builtin_object_size (line1, 0));
          __builtin___memmove_chk (line2, line2 + 100, (size_t)(lineidx - 100), __builtin_object_size (line2, 0));
          lineidx -= 100;
        }
      }
      fclose(fd1);
...
void f_assert_exception(typval_T *argvars, typval_T *rettv, EvalFuncData fptr)
{
  ...
  if (*get_vim_var_str(VV_EXCEPTION) == '\000') {
    ...
    rettv->vval.v_number = 1;
             ...
             && strstr(get_vim_var_str(VV_EXCEPTION), error) == ((void*)0)) {
    prepare_assert_error(&ga);
...
void f_assert_fails(typval_T *argvars, typval_T *rettv, EvalFuncData fptr)
{
  ...
  const int called_emsg_before = called_emsg;
  char *wrong_arg_msg = ((void*)0);


  trylevel = 0;
  suppress_errthrow = 1;
  emsg_silent = 1;
  emsg_assert_fails_used = 1;
  ...
  if (called_emsg == called_emsg_before) {
    ...
    char *actual = emsg_assert_fails_msg == ((void*)0) ? "[unknown]" : emsg_assert_fails_msg;

    if (argvars[1].v_type == VAR_STRING) {
      expected = tv_get_string_buf_chk(&argvars[1], buf);
      error_found = expected == ((void*)0) || strstr(actual, expected) == ((void*)0);
    } else if (argvars[1].v_type == VAR_LIST) {
      const list_T *const list = argvars[1].vval.v_list;
      if (list == ((void*)0) || tv_list_len(list) < 1 || tv_list_len(list) > 2) {
        wrong_arg_msg = e_assert_fails_second_arg;
        goto theend;
      }
      const typval_T *tv = (&(tv_list_first(list))->li_tv);
      expected = tv_get_string_buf_chk(tv, buf);
      if (!pattern_match(expected, actual, 0)) {
        error_found = 1;
    ...
    if (!error_found && argvars[2].v_type != VAR_UNKNOWN
      ...
      if (!error_found && argvars[4].v_type != VAR_UNKNOWN) {
        if (argvars[4].v_type != VAR_STRING) {
          ...
          goto theend;
        } else if (argvars[4].vval.v_string != ((void*)0)
                   && !pattern_match(argvars[4].vval.v_string,
                                     emsg_assert_fails_context, 0)) {
          error_found = 1;
          error_found_index = 4;
        }
      }
...
theend:
  ...
  emsg_silent = 0;
  emsg_on_display = 0;
  emsg_assert_fails_used = 0;
  do { void **ptr_ = (void **)&(emsg_assert_fails_msg); xfree(*ptr_); *ptr_ = ((void*)0); (void)(*ptr_); } while (0);
  set_vim_var_string(VV_ERRMSG, ((void*)0), 0);
  if (wrong_arg_msg != ((void*)0)) {
    emsg(libintl_gettext((char *)(wrong_arg_msg)));
  }
}
...
{
  rettv->vval.v_number = assert_bool(argvars, 0);
}
  ...
  if (argvars[0].v_type == VAR_FLOAT
    ...
    if (factual < flower || factual > fupper) {
      ...
      if (argvars[3].v_type != VAR_UNKNOWN) {
        char_u *const tofree = (char_u *)encode_tv2string(&argvars[3], ((void*)0));
...
{
  rettv->vval.v_number = assert_bool(argvars, 1);
}
...
void f_test_garbagecollect_now(typval_T *argvars, typval_T *rettv, EvalFuncData fptr)
{
  ...
  if (!get_vim_var_nr(VV_TESTING)) {
    emsg(libintl_gettext((char *)(e_calling_test_garbagecollect_now_while_v_testing_is_not_set)));
  } else {
    garbage_collect(1);
  }
}
