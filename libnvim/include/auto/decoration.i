# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/decoration.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/decoration.c" 2
...
# 5 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/ui.h" 2
...
# 7 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/ui.h" 2
...
# 8 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/ui.h" 2
# 5 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/decoration.c" 2
...
# 6 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/decoration.c" 2
...
# 7 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/decoration.c" 2
...
# 8 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/decoration.c" 2
...
# 9 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/decoration.c" 2
...
# 10 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/decoration.c" 2
...
# 11 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/decoration.c" 2
...
# 12 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/decoration.c" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/move.h" 1
# 13 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/decoration.c" 2
# 32 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/decoration.c"
                             ...
                             colnr_T offset)
{
  ...
  for (linenr_T lnum = pos_start.lnum; lnum <= pos_end.lnum; lnum++) {
    ...
    extmark_set(buf, (uint32_t)src_id, ((void*)0),
...
void decor_redraw(buf_T *buf, int row1, int row2, Decoration *decor)
{
  ...
  if (decor && decor_virt_pos(*decor)) {
    redraw_buf_line_later(buf, row1 + 1, 0);
  }

  if (decor && ((decor->virt_lines).size)) {
    redraw_buf_line_later(buf, row1 + 1 + (decor->virt_lines_above?0:1), 1);
  }
}
...
void decor_remove(buf_T *buf, int row, int row2, Decoration *decor)
{
  ...
  if (decor) {
    if (((decor->virt_lines).size)) {
      (__builtin_expect(!(buf->b_virt_line_blocks > 0), 0) ? __assert_rtn(__func__, "decoration.c", 91, "buf->b_virt_line_blocks > 0") : (void)0);
      buf->b_virt_line_blocks--;
    }
    if (decor_has_sign(decor)) {
      (__builtin_expect(!(buf->b_signs > 0), 0) ? __assert_rtn(__func__, "decoration.c", 95, "buf->b_signs > 0") : (void)0);
      buf->b_signs--;
    }
...
Decoration get_decor(mtkey_t mark)
{
  if (mark.decor_full) {
    ...
    Decoration fake = { { .size = 0, .capacity = 0, .items = ((void*)0) }, { .size = 0, .capacity = 0, .items = ((void*)0) }, 0, kVTEndOfLine, kHlModeUnknown, 0, 0, 0, 0, 0, 0x1000, 0, 0, ((void*)0), 0, 0, 0, 0, 0, 0 };
...
_Bool decor_redraw_start(buf_T *buf, int top_row, DecorState *state)
{
  ...
  while (1) {
    ...
    mtpos_t altpos = marktree_get_altpos(buf->b_marktree, mark, ((void*)0));
...
static void decor_add(DecorState *state, int start_row, int start_col, int end_row, int end_col,
                      Decoration *decor, _Bool owned, uint64_t ns_id, uint64_t mark_id)
{
...
int decor_redraw_col(buf_T *buf, int col, int win_col, _Bool hidden, DecorState *state)
{
  ...
  while (1) {
    ...
    mtpos_t endpos = marktree_get_altpos(buf->b_marktree, mark, ((void*)0));
  ...
  for (size_t i = 0; i < ((state->active).size); i++) {
    ...
    if (active && item.decor.conceal) {
      ...
      if (item.start_row == state->row && item.start_col == col && item.decor.conceal_char) {
        ...
        state->col_until = ((state->col_until) < (item.start_col) ? (state->col_until) : (item.start_col));
...
_Bool decor_redraw_eol(buf_T *buf, DecorState *state, int *eol_attr, int eol_col)
{
                         ...
                         uint64_t ns_id, uint64_t mark_id)
{
  ...
  decor_add(&decor_state, start_row, start_col, end_row, end_col, decor, 1, ns_id, mark_id);
}
...
int decor_virt_lines(win_T *wp, linenr_T lnum, VirtLines *lines)
{
  ...
  while (1) {
    ...
    _Bool above = mark.pos.row > (lnum - 2);
    Decoration *decor = mark.decor_full;
    if (decor && decor->virt_lines_above == above) {
      virt_lines += (int)((decor->virt_lines).size);
      if (lines) {
        do { do { if ((*lines).capacity < (*lines).size + (decor->virt_lines).size) { (*lines).capacity = (*lines).size + (decor->virt_lines).size; ((--((*lines).capacity)), (((*lines).capacity)|=((*lines).capacity)>>1, ((*lines).capacity)|=((*lines).capacity)>>2, ((*lines).capacity)|=((*lines).capacity)>>4, ((*lines).capacity)|=((*lines).capacity)>>8, ((*lines).capacity)|=((*lines).capacity)>>16), (++((*lines).capacity))); (((*lines)).capacity = ((*lines).capacity), ((*lines)).items = xrealloc(((*lines)).items, sizeof(((*lines)).items[0]) * ((*lines)).capacity)); } } while (0); __builtin___memcpy_chk ((*lines).items + (*lines).size, (decor->virt_lines).items, sizeof((*lines).items[0]) * (decor->virt_lines).size, __builtin_object_size ((*lines).items + (*lines).size, 0)); (*lines).size = (*lines).size + (decor->virt_lines).size; } while (0);
      }
    }
next_mark:
    marktree_itr_next(buf->b_marktree, itr);
