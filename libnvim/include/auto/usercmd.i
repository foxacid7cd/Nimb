# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/usercmd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/usercmd.c" 2
...
# 7 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/usercmd.c" 2
...
# 8 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/usercmd.c" 2
...
# 9 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/usercmd.c" 2
...
# 10 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/usercmd.c" 2
...
# 11 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/usercmd.c" 2
...
# 13 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/usercmd.c" 2
...
# 15 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/usercmd.c" 2
...
# 16 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/usercmd.c" 2
...
# 17 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/usercmd.c" 2
...
# 19 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/usercmd.c" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/os/input.h" 1
# 20 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/usercmd.c" 2
...
# 23 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/usercmd.c" 2





garray_T ucmds = { 0, 0, sizeof(ucmd_T), 4, ((void*)0) };
...
static struct {
  ...
  { ADDR_OTHER, "other", "?" },
  { ADDR_NONE, ((void*)0), ((void*)0) }
};
# 109 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/usercmd.c"
...
{
  return get_user_commands(((void*)0), idx - CMD_SIZE);
}
...
static void uc_list(char *name, size_t name_len)
{
    ...
    for (i = 0; i < gap->ga_len; i++) {
      ...
      if (a & (0x001u | 0x400u)) {
        if (a & 0x400u) {
          ...
          __builtin___snprintf_chk ((char *)IObuff + len, (1024 + 1), 0, __builtin_object_size ((char *)IObuff + len, 1 > 1 ? 1 : 0), "%" "ll" "d" "c", (int64_t)cmd->uc_def);
          ...
          __builtin___snprintf_chk ((char *)IObuff + len, (1024 + 1), 0, __builtin_object_size ((char *)IObuff + len, 1 > 1 ? 1 : 0), "%" "ll" "d" "", (int64_t)cmd->uc_def);
      ...
      for (j = 0; addr_type_complete[j].expand != ADDR_NONE; j++) {
        if (addr_type_complete[j].expand != ADDR_LINES
          ...
          __builtin___strcpy_chk ((char *)(IObuff + len), (char *)(addr_type_complete[j].shortname), __builtin_object_size ((char *)(IObuff + len), 1 > 1 ? 1 : 0));
          len += (int)strlen(IObuff + len);
          break;
        }
      }
      ...
      if (cmd_compl != ((void*)0)) {
        __builtin___strcpy_chk ((char *)(IObuff + len), (char *)(get_command_complete(cmd->uc_compl)), __builtin_object_size ((char *)(IObuff + len), 1 > 1 ? 1 : 0));
        len += (int)strlen(IObuff + len);
      }
  ...
  if (!found) {
    msg(libintl_gettext((char *)("No user-defined commands found")));
  }
}
  ...
  FUNC_ATTR_NONNULL_ALL
{
  ...
  if (addr_type_complete[i].expand == ADDR_NONE) {
    ...
    err[i] = '\000';
    semsg(libintl_gettext((char *)("E180: Invalid address type value: %s")), err);
    return 0;
  }
  ...
  FUNC_ATTR_NONNULL_ALL
{
  ...
  for (i = 0; i < (int)((sizeof(command_complete)/sizeof((command_complete)[0])) / ((size_t)(!(sizeof(command_complete) % sizeof((command_complete)[0]))))); i++) {
    if (get_command_complete(i) == ((void*)0)) {
      continue;
    }
  ...
  if (i == (int)((sizeof(command_complete)/sizeof((command_complete)[0])) / ((size_t)(!(sizeof(command_complete) % sizeof((command_complete)[0])))))) {
    semsg(libintl_gettext((char *)("E180: Invalid complete value: %s")), value);
    return 0;
  }

  if (*complp != EXPAND_USER_DEFINED && *complp != EXPAND_USER_LIST
      && arg != ((void*)0)) {
    emsg(libintl_gettext((char *)("E468: Completion argument only allowed for custom completion")));
    return 0;
  }

  if ((*complp == EXPAND_USER_DEFINED || *complp == EXPAND_USER_LIST)
      && arg == ((void*)0)) {
    emsg(libintl_gettext((char *)("E467: Custom completion requires a function argument")));
    return 0;
  }
  ...
  FUNC_ATTR_NONNULL_ALL
{
  ...
  if (len == 0) {
    emsg(libintl_gettext((char *)("E175: No attribute specified")));
    return 0;
  }
...
wrong_nargs:
        emsg(libintl_gettext((char *)("E176: Invalid number of arguments")));
        return 0;
      }
      ...
      *argt |= 0x001u;
      if (vallen == 1 && *val == '%') {
        *argt |= 0x020u;
        ...
        if (*def >= 0) {
two_count:
          emsg(libintl_gettext((char *)("E177: Count cannot be specified twice")));
          return 0;
        }

        *def = getdigits_long(&p, 1, 0);
        *argt |= 0x1000u;

        if (p != val + vallen || vallen == 0) {
invalid_count:
          emsg(libintl_gettext((char *)("E178: Invalid default value for count")));
          return 0;
        }
      }
      ...
      *argt |= (0x400u | 0x1000u | 0x001u);
      ...
      if (val == ((void*)0)) {
        emsg(libintl_gettext((char *)("E179: argument required for -complete")));
        return 0;
      }
      ...
      *argt |= 0x001u;
      if (val == ((void*)0)) {
        emsg(libintl_gettext((char *)("E179: argument required for -addr")));
        return 0;
      }
      ...
      char ch = attr[len];
      attr[len] = '\0';
      semsg(libintl_gettext((char *)("E181: Invalid attribute: %s")), attr);
      attr[len] = ch;
      return 0;
    }
  }
...
int uc_add_command(char *name, size_t name_len, const char *rep, uint32_t argt, long def, int flags,
                   ...
                   cmd_addr_T addr_type, LuaRef luaref, _Bool force)
  FUNC_ATTR_NONNULL_ARG(1, 3)
{
  ...
  replace_termcodes(rep, strlen(rep), &rep_buf, 0, ((void*)0), ((vim_strchr((char *)p_cpo, 'B') == ((void*)0)) ? 0 : 0x01));
  if (rep_buf == ((void*)0)) {
  ...
  for (i = 0; i < gap->ga_len; i++) {
    ...
    if (cmp == 0) {
      ...
      if (!force
        ...
        semsg(libintl_gettext((char *)("E174: Command already exists: add ! to replace it: %s")),
              name);
        goto fail;
      }

      do { void **ptr_ = (void **)&(cmd->uc_rep); xfree(*ptr_); *ptr_ = ((void*)0); (void)(*ptr_); } while (0);
      do { void **ptr_ = (void **)&(cmd->uc_compl_arg); xfree(*ptr_); *ptr_ = ((void*)0); (void)(*ptr_); } while (0);
  ...
  if (cmp != 0) {
    ...
    cmd = (&((ucmd_T *)((gap)->ga_data))[i]);
    __builtin___memmove_chk (cmd + 1, cmd, (size_t)(gap->ga_len - i) * sizeof(ucmd_T), __builtin_object_size (cmd + 1, 0));
...
void ex_command(exarg_T *eap)
{
  ...
  if (!end) {
    emsg(libintl_gettext((char *)("E182: Invalid command name")));
    return;
  }
  ...
  if (!has_attr && ends_excmd(*p)) {
    ...
    emsg(libintl_gettext((char *)("E183: User defined commands must start with an uppercase letter")));
  } else if (name_len <= 4 && strncmp((char *)(name), (char *)("Next"), (size_t)(name_len)) == 0) {
    emsg(libintl_gettext((char *)("E841: Reserved name, cannot be used for user defined command")));
  } else if (compl > 0 && (argt & 0x004u) == 0) {
    emsg(libintl_gettext((char *)(e_complete_used_without_allowing_arguments)));
  } else {
    uc_add_command(name, name_len, p, argt, def, flags, compl, compl_arg, (-2), (-2),
...
{
  do { garray_T *_gap = (gap); if (_gap->ga_data != ((void*)0)) { for (int i = 0; i < _gap->ga_len; i++) { ucmd_T *_item = &(((ucmd_T *)_gap->ga_data)[i]); free_ucmd(_item); } } ga_clear(_gap); } while (0);
}
...
void ex_delcommand(exarg_T *eap)
{
  ...
  if (strncmp((char *)(arg), (char *)("-buffer"), (size_t)(7)) == 0 && ascii_iswhite(arg[7])) {
    buffer_only = 1;
    arg = skipwhite(arg + 7);
  }
  ...
  if (res != 0) {
    semsg(libintl_gettext((char *)(buffer_only ? e_no_such_user_defined_command_in_current_buffer_str : e_no_such_user_defined_command_str)),
...
# 1044 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/usercmd.c"
_Bool uc_split_args_iter(const char *arg, size_t arglen, size_t *end, char *buf, size_t *len)
{
  if (!arglen) {
    return 1;
  }
...
static size_t add_cmd_modifier(char *buf, char *mod_str, _Bool *multi_mods)
{
  ...
  if (buf != ((void*)0)) {
    if (*multi_mods) {
      __builtin___strcat_chk ((char *)(buf), (char *)(" "), __builtin_object_size ((char *)(buf), 1 > 1 ? 1 : 0));
    }
    __builtin___strcat_chk ((char *)(buf), (char *)(mod_str), __builtin_object_size ((char *)(buf), 1 > 1 ? 1 : 0));
  }
...
size_t add_win_cmd_modifiers(char *buf, const cmdmod_T *cmod, _Bool *multi_mods)
{
  size_t result = 0;
  ...
  if (cmod->cmod_tab > 0) {
    ...
    if (tabnr == tabpage_index(curtab)) {
      ...
      __builtin___snprintf_chk (tab_buf, sizeof(tab_buf), 0, __builtin_object_size (tab_buf, 1 > 1 ? 1 : 0), "%dtab", tabnr);
...
size_t uc_mods(char *buf, const cmdmod_T *cmod, _Bool quote)
{
  size_t result = 0;
  _Bool multi_mods = 0;
  ...
  if (cmod->cmod_verbose > 0) {
    ...
    if (verbose_value == 1) {
      ...
      __builtin___snprintf_chk (verbose_buf, sizeof(verbose_buf), 0, __builtin_object_size (verbose_buf, 1 > 1 ? 1 : 0), "%dverbose", verbose_value);
...
# 1343 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/usercmd.c"
                            ...
                            char **split_buf, size_t *split_len)
{
  ...
  if ((vim_strchr("qQfF", *p) != ((void*)0)) && p[1] == '-') {
    quote = (*p == 'q' || *p == 'Q') ? 1 : 2;
    p += 2;
    l -= 2;
  }
  ...
  case ct_ARGS:
    ...
    case 0:
      ...
      if (buf != ((void*)0)) {
        __builtin___strcpy_chk ((char *)(buf), (char *)(eap->arg), __builtin_object_size ((char *)(buf), 1 > 1 ? 1 : 0));
      }
      break;
    case 1:
    ...
    case 2:
      ...
      if (buf != ((void*)0) && result != 0) {
        __builtin___strcpy_chk ((char *)(buf), (char *)(*split_buf), __builtin_object_size ((char *)(buf), 1 > 1 ? 1 : 0));
      }
  ...
  case ct_COUNT: {
    ...
    __builtin___snprintf_chk (num_buf, sizeof(num_buf), 0, __builtin_object_size (num_buf, 1 > 1 ? 1 : 0), "%" "ll" "d", (int64_t)num);
    ...
    if (buf != ((void*)0)) {
      ...
      __builtin___strcpy_chk ((char *)(buf), (char *)(num_buf), __builtin_object_size ((char *)(buf), 1 > 1 ? 1 : 0));
      buf += num_len;
      if (quote) {
        *buf = '"';
      }
...
int do_ucmd(exarg_T *eap, _Bool preview)
{
  char *buf;
  char *p;
  char *q;
  ...
  if (preview) {
    (__builtin_expect(!(cmd->uc_preview_luaref > 0), 0) ? __assert_rtn(__func__, "usercmd.c", 1569, "cmd->uc_preview_luaref > 0") : (void)0);
    return nlua_do_ucmd(cmd, eap, 1);
  }

  if (cmd->uc_luaref > 0) {
    nlua_do_ucmd(cmd, eap, 0);
    return 0;
  }
  ...
  for (;;) {
    ...
    for (;;) {
      ...
      if (buf != ((void*)0)) {
        for (ksp = p; *ksp != '\000' && (char_u)(*ksp) != (0x80); ksp++) {}
        if ((char_u)(*ksp) == (0x80)
            && (start == ((void*)0) || ksp < start || end == ((void*)0))
            && ((char_u)ksp[1] == 254 && ksp[2] == ('X'))) {



          len = (size_t)(ksp - p);
          if (len > 0) {
            __builtin___memmove_chk (q, p, len, __builtin_object_size (q, 0));
            q += len;
          }
          *q++ = (char)(0x80);
          p = ksp + 3;
    ...
    if (buf != ((void*)0)) {
      __builtin___strcpy_chk ((char *)(q), (char *)(p), __builtin_object_size ((char *)(q), 1 > 1 ? 1 : 0));
      break;
    }
  ...
  _Bool restore_current_sctx = 0;
  if ((cmd->uc_argt & 0x4000000u) == 0) {
    restore_current_sctx = 1;
...
Dictionary commands_array(buf_T *buf)
{
  ...
  char str[20];
  garray_T *gap = (buf == ((void*)0)) ? &ucmds : &buf->b_ucmds;

  for (int i = 0; i < gap->ga_len; i++) {
    char arg[2] = { 0, 0 };
    Dictionary d = { .size = 0, .capacity = 0, .items = ((void*)0) };
    ...
    char *cmd_compl = get_command_complete(cmd->uc_compl);
    (*((((d).size == (d).capacity) ? (((d).capacity = ((d).capacity ? (d).capacity << 1 : 8), (d).items = xrealloc((d).items, sizeof((d).items[0]) * (d).capacity)), 0) : 0), ((d).items + ((d).size++))) = (((KeyValuePair) { .key = cstr_to_string("complete"), .value = (cmd_compl == ((void*)0) ? ((Object){ .type = kObjectTypeNil }) : ((Object) { .type = kObjectTypeString, .data.string = cstr_to_string(cmd_compl) })) })));

    (*((((d).size == (d).capacity) ? (((d).capacity = ((d).capacity ? (d).capacity << 1 : 8), (d).items = xrealloc((d).items, sizeof((d).items[0]) * (d).capacity)), 0) : 0), ((d).items + ((d).size++))) = (((KeyValuePair) { .key = cstr_to_string("complete_arg"), .value = cmd->uc_compl_arg == ((void*)0) ? ((Object){ .type = kObjectTypeNil }) : ((Object) { .type = kObjectTypeString, .data.string = cstr_to_string((char *)cmd->uc_compl_arg) }) })));


    Object obj = ((Object){ .type = kObjectTypeNil });
    if (cmd->uc_argt & 0x400u) {
      if (cmd->uc_def >= 0) {
        __builtin___snprintf_chk (str, sizeof(str), 0, __builtin_object_size (str, 1 > 1 ? 1 : 0), "%" "ll" "d", (int64_t)cmd->uc_def);
