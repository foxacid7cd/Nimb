# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/context.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/context.c" 2
...
# 7 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/context.c" 2
...
# 8 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/context.c" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/vim.h" 1
# 9 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/context.c" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/vimscript.h" 1
# 10 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/context.c" 2
...
extern int kCtxAll;
# 11 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/context.c" 2
...
# 12 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/context.c" 2
...
# 13 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/context.c" 2
...
# 14 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/context.c" 2
...
# 15 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/context.c" 2
...
# 16 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/context.c" 2
...
# 83 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/context.c"
...
# 122 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/context.c"
_Bool ctx_restore(Context *ctx, const int flags)
{
  ...
  char *op_shada;
  get_option_value("shada", ((void*)0), &op_shada, ((void*)0), OPT_GLOBAL);
...
static inline msgpack_sbuffer array_to_sbuf(Array array)
{
  ...
  if (!encode_vim_list_to_buf(list_tv.vval.v_list, &sbuf.size, &sbuf.data)) {
    emsg(libintl_gettext((char *)("E474: Failed to convert list to msgpack string buffer")));
  }
...
Dictionary ctx_to_dict(Context *ctx)
  FUNC_ATTR_NONNULL_ALL
{
  (__builtin_expect(!(ctx != ((void*)0)), 0) ? __assert_rtn(__func__, "context.c", 340, "ctx != NULL") : (void)0);
  ...
  (*((((rv).size == (rv).capacity) ? (((rv).capacity = ((rv).capacity ? (rv).capacity << 1 : 8), (rv).items = xrealloc((rv).items, sizeof((rv).items[0]) * (rv).capacity)), 0) : 0), ((rv).items + ((rv).size++))) = (((KeyValuePair) { .key = cstr_to_string("funcs"), .value = ((Object) { .type = kObjectTypeArray, .data.array = copy_array(ctx->funcs, ((void*)0)) }) })));
...
int ctx_from_dict(Dictionary dict, Context *ctx)
  FUNC_ATTR_NONNULL_ALL
{
  (__builtin_expect(!(ctx != ((void*)0)), 0) ? __assert_rtn(__func__, "context.c", 362, "ctx != NULL") : (void)0);
  ...
  for (size_t i = 0; i < dict.size; i++) {
    ...
    if (strequal(item.key.data, "regs")) {
      ...
      types |= kCtxFuncs;
      ctx->funcs = copy_object(item.value, ((void*)0)).data.array;
    }
  }
