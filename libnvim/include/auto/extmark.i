# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/extmark.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/extmark.c" 2
# 31 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/extmark.c"
...
# 32 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/extmark.c" 2

# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/klib/kbtree.h" 1
# 37 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/klib/kbtree.h"
# 1 "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.0.sdk/usr/include/assert.h" 1 3 4
# 82 "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.0.sdk/usr/include/assert.h" 3 4
void __assert_rtn(const char *, const char *, int, const char *) __attribute__((__noreturn__)) __attribute__((__cold__)) __attribute__((__disable_tail_calls__));
# 38 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/klib/kbtree.h" 2
...
# 39 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/klib/kbtree.h" 2
...
# 40 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/klib/kbtree.h" 2
...
# 41 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/klib/kbtree.h" 2
...
# 43 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/klib/kbtree.h" 2
# 34 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/extmark.c" 2
...
# 35 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/extmark.c" 2
...
# 36 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/extmark.c" 2
...
# 37 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/extmark.c" 2
...
# 38 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/extmark.c" 2
...
# 41 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/extmark.c" 2



# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/undo.h" 1
# 45 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/extmark.c" 2
...
# 46 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/extmark.c" 2
...
void extmark_set(buf_T *buf, uint32_t ns_id, uint32_t *idp, int row, colnr_T col, int end_row,
                 colnr_T end_col, Decoration *decor, _Bool right_gravity, _Bool end_right_gravity,
                 ExtmarkOp op)
{
  uint32_t *ns = buf_ns_ref(buf, ns_id, 1);
  ...
  if (id == 0) {
    ...
    mtkey_t old_mark = marktree_lookup_ns(buf->b_marktree, ns_id, id, 0, itr);
    if (old_mark.id) {
      if (mt_paired(old_mark) || end_row > -1) {
        extmark_del(buf, ns_id, id);
      } else {

        (__builtin_expect(!(itr->node), 0) ? __assert_rtn(__func__, "extmark.c", 94, "itr->node") : (void)0);
        if (old_mark.pos.row == row && old_mark.pos.col == col) {
          if (marktree_decor_level(old_mark) > kDecorLevelNone) {
            decor_remove(buf, row, row, old_mark.decor_full);
            old_mark.decor_full = ((void*)0);
          }
          old_mark.flags = 0;
          if (decor_full) {
  ...
  mtkey_t mark = { { row, col }, ns_id, id, 0,
                   mt_flags(right_gravity, decor_level), 0, ((void*)0) };
  if (decor_full) {
...
revised:
  if (op != kExtmarkNoUndo) {
    ...
    uint64_t mark_id = mt_lookup_id(ns_id, id, 0);
  ...
  if (decor) {
    ...
    if (decor->sign_text) {
      ...
      buf_signcols_add_check(buf, ((void*)0));
    }
...
_Bool extmark_del(buf_T *buf, uint32_t ns_id, uint32_t id)
{
  MarkTreeIter itr[1] = { 0 };
  mtkey_t key = marktree_lookup_ns(buf->b_marktree, ns_id, id, 0, itr);
  if (!key.id) {
    return 0;
  }
  (__builtin_expect(!(key.pos.row >= 0), 0) ? __assert_rtn(__func__, "extmark.c", 191, "key.pos.row >= 0") : (void)0);
  marktree_del_itr(buf->b_marktree, itr, 0);

  mtkey_t key2 = key;

  if (mt_paired(key)) {
    key2 = marktree_lookup_ns(buf->b_marktree, ns_id, id, 1, itr);
    (__builtin_expect(!(key2.pos.row >= 0), 0) ? __assert_rtn(__func__, "extmark.c", 198, "key2.pos.row >= 0") : (void)0);
    marktree_del_itr(buf->b_marktree, itr, 0);
  }
...
_Bool extmark_clear(buf_T *buf, uint32_t ns_id, int l_row, colnr_T l_col, int u_row, colnr_T u_col)
{
  ...
  static Map_uint64_t_ssize_t delete_set = { { 0, 0, 0, 0, ((void*)0), ((void*)0), ((void*)0) } };
  ...
  while (1) {
    ...
    (__builtin_expect(!(mark.ns > 0 && mark.id > 0), 0) ? __assert_rtn(__func__, "extmark.c", 256, "mark.ns > 0 && mark.id > 0") : (void)0);
  ...
  uint64_t id;
  ssize_t decor_id;
  { khint_t __i; for (__i = (khint_t)(0); __i != ((&(&delete_set)->table)->n_buckets); ++__i) { if (!(!(((&(&delete_set)->table)->flags[(__i)>>4]>>(((__i)&0xfU)<<1))&3))) continue; (id) = ((&(&delete_set)->table)->keys[__i]); (decor_id) = ((&(&delete_set)->table)->vals[__i]); { mtkey_t mark = marktree_lookup(buf->b_marktree, id, itr); (__builtin_expect(!(itr->node), 0) ? __assert_rtn(__func__, "extmark.c", 282, "itr->node") : (void)0); marktree_del_itr(buf->b_marktree, itr, 0); if (decor_id >= 0) { DecorItem it = ((decors).items[(decor_id)]); decor_remove(buf, it.row1, mark.pos.row, mark.decor_full); } }; } };
# 289 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/extmark.c"
  map_uint64_t_ssize_t_clear(&delete_set);
  ((decors).size) = 0;
  return marks_cleared;
}
# 301 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/extmark.c"
ExtmarkInfoArray extmark_get(buf_T *buf, uint32_t ns_id, int l_row, colnr_T l_col, int u_row,
                             colnr_T u_col, int64_t amount, _Bool reverse)
{
  ...
  while ((int64_t)((array).size) < amount) {
    ...
    if (mark.ns == ns_id) {
      mtkey_t end = marktree_get_alt(buf->b_marktree, mark, ((void*)0));
...
{
  ExtmarkInfo ret = { 0, 0, -1, -1, -1, -1, 0, 0, { { .size = 0, .capacity = 0, .items = ((void*)0) }, { .size = 0, .capacity = 0, .items = ((void*)0) }, 0, kVTEndOfLine, kHlModeUnknown, 0, 0, 0, 0, 0, 0x1000, 0, 0, ((void*)0), 0, 0, 0, 0, 0, 0 } };
  mtkey_t mark = marktree_lookup_ns(buf->b_marktree, ns_id, id, 0, ((void*)0));
  if (!mark.id) {
    return ret;
  }
  (__builtin_expect(!(mark.pos.row >= 0), 0) ? __assert_rtn(__func__, "extmark.c", 350, "mark.pos.row >= 0") : (void)0);
  mtkey_t end = marktree_get_alt(buf->b_marktree, mark, ((void*)0));
...
void extmark_free_all(buf_T *buf)
{
  ...
  do { *(buf->b_extmark_ns) = (Map_uint32_t_uint32_t) { { 0, 0, 0, 0, ((void*)0), ((void*)0), ((void*)0) } }; } while (0);
}
                    ...
                    linenr_T amount_after, ExtmarkOp undo)
{
  ...
  if (amount == MAXLNUM) {
    ...
    (__builtin_expect(!(line2 == MAXLNUM), 0) ? __assert_rtn(__func__, "extmark.c", 524, "line2 == MAXLNUM") : (void)0);
    old_row = 0;
    new_row = (int)amount;
  }
  if (new_row > 0) {
...
# 555 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/extmark.c"
