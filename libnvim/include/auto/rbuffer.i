# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/rbuffer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/rbuffer.c" 2
...
# 5 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/rbuffer.c" 2
...
# 6 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/rbuffer.c" 2
...
# 7 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/rbuffer.c" 2
...
# 7 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/memory.h" 2
...
# 9 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/rbuffer.c" 2
...
# 10 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/rbuffer.c" 2
...
# 11 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/rbuffer.c" 2
...
{
  (__builtin_expect(!(count && count <= rbuffer_space(buf)), 0) ? __assert_rtn(__func__, "rbuffer.c", 100, "count && count <= rbuffer_space(buf)") : (void)0);
...
void rbuffer_consumed(RBuffer *buf, size_t count)
  FUNC_ATTR_NONNULL_ALL
{
  (__builtin_expect(!(count && count <= buf->size), 0) ? __assert_rtn(__func__, "rbuffer.c", 143, "count && count <= buf->size") : (void)0);
...
void rbuffer_consumed_compact(RBuffer *buf, size_t count)
  FUNC_ATTR_NONNULL_ALL
{
  (__builtin_expect(!(buf->read_ptr <= buf->write_ptr), 0) ? __assert_rtn(__func__, "rbuffer.c", 164, "buf->read_ptr <= buf->write_ptr") : (void)0);
  rbuffer_consumed(buf, count);
  if (buf->read_ptr > buf->start_ptr) {
    (__builtin_expect(!((size_t)(buf->read_ptr - buf->write_ptr) == buf->size), 0) ? __assert_rtn(__func__, "rbuffer.c", 167, "(size_t)(buf->read_ptr - buf->write_ptr) == buf->size") : (void)0);
    __builtin___memmove_chk (buf->start_ptr, buf->read_ptr, buf->size, __builtin_object_size (buf->start_ptr, 0));
...
{
  (__builtin_expect(!(index < buf->size), 0) ? __assert_rtn(__func__, "rbuffer.c", 219, "index < buf->size") : (void)0);
...
int rbuffer_cmp(RBuffer *buf, const char *str, size_t count)
  FUNC_ATTR_NONNULL_ALL
{
  (__builtin_expect(!(count <= buf->size), 0) ? __assert_rtn(__func__, "rbuffer.c", 230, "count <= buf->size") : (void)0);
  size_t rcnt;
