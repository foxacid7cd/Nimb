# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/socket.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/socket.c" 2
...
# 5 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/socket.c" 2
...
# 6 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/socket.c" 2
...
# 7 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/socket.c" 2
...
# 9 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/socket.c" 2
...
# 10 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/socket.c" 2
...
# 11 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/socket.c" 2
...
# 12 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/socket.c" 2
...
# 9 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/socket.h" 2
...
# 13 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/socket.c" 2
...
# 17 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/socket.c" 2
...
# 19 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/socket.c" 2
  ...
  if (host_end && addr != host_end) {
    ...
    *host_end = '\0';
    ...
    if (!ok || iport < 0 || iport > 65535) {
      logmsg(4, ((void*)0), __func__, 43, 1, "Invalid port: %s", port);
      return UV_EINVAL;
    }
    ...
    int retval = uv_getaddrinfo(&loop->uv, &request, ((void*)0), addr, port,
                                &(struct addrinfo){ .ai_family = 0,
                                                    .ai_socktype = 1, });
    if (retval != 0) {
      logmsg(4, ((void*)0), __func__, 59, 1, "Host lookup failed: %s", endpoint);
      return retval;
    }
  ...
  FUNC_ATTR_NONNULL_ALL
{
    ...
    for (; ai; ai = ai->ai_next) {
      ...
      if (result == 0) {
        ...
        uv_tcp_getsockname(&watcher->uv.tcp.handle, (struct sockaddr *)&sas,
                           &(int){ sizeof(sas) });
        uint16_t port = (uint16_t)((sas.ss_family == 2)
  ...
  (__builtin_expect(!(result <= 0), 0) ? __assert_rtn(__func__, "socket.c", 122, "result <= 0") : (void)0);
  if (result < 0) {
    if (result == UV_EACCES) {
...
_Bool socket_connect(Loop *loop, Stream *stream, _Bool is_tcp, const char *address, int timeout,
                    const char **error)
{
  _Bool success = 0;
  int status;
