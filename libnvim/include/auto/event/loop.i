# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/loop.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/loop.c" 2
...
# 5 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/loop.c" 2
...
# 6 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/loop.c" 2
...
# 7 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/loop.c" 2
...
# 9 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/loop.c" 2
...
# 10 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/loop.c" 2
...
# 43 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/loop.c"
_Bool loop_uv_run(Loop *loop, int ms, _Bool once)
{
  if (loop->recursive++) {
    abort();
  }
  ...
  _Bool *timeout_expired = loop->poll_timer.data;
  *timeout_expired = 0;
...
# 82 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/loop.c"
_Bool loop_poll_events(Loop *loop, int ms)
{
  _Bool timeout_expired = loop_uv_run(loop, ms, 1);
  multiqueue_process_events(loop->fast_events);
  return timeout_expired;
}
# 97 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/loop.c"
...
# 149 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/loop.c"
_Bool loop_close(Loop *loop, _Bool wait)
{
  ...
  uv_close((uv_handle_t *)&loop->exit_delay_timer, ((void*)0));
  ...
  while (1) {
    ...
    if (elapsed_s >= 2) {
      ...
      rv = 0;
      logmsg(4, ((void*)0), __func__, 171, 1, "uv_loop_close() hang?");
