# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/multiqueue.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/multiqueue.c" 2
# 48 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/multiqueue.c"
...
# 49 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/multiqueue.c" 2
...
# 50 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/multiqueue.c" 2
...
# 51 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/multiqueue.c" 2
...
# 52 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/multiqueue.c" 2
...
# 53 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/multiqueue.c" 2
...
# 55 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/multiqueue.c" 2
...
# 56 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/multiqueue.c" 2
...
# 57 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/multiqueue.c" 2
...
{
  (__builtin_expect(!(!parent->parent), 0) ? __assert_rtn(__func__, "multiqueue.c", 99, "!parent->parent") : (void)0);
  parent->size++;
...
{
  (__builtin_expect(!(this), 0) ? __assert_rtn(__func__, "multiqueue.c", 117, "this") : (void)0);
  QUEUE *q;
...
# 129 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/multiqueue.c"
  xfree(this);
}
...
{
  (__builtin_expect(!(this), 0) ? __assert_rtn(__func__, "multiqueue.c", 140, "this") : (void)0);
...
{
  (__builtin_expect(!(this), 0) ? __assert_rtn(__func__, "multiqueue.c", 149, "this") : (void)0);
...
{
  (__builtin_expect(!(this), 0) ? __assert_rtn(__func__, "multiqueue.c", 161, "this") : (void)0);
  while (!multiqueue_empty(this)) {
...
{
  (__builtin_expect(!(this), 0) ? __assert_rtn(__func__, "multiqueue.c", 169, "this") : (void)0);
  return QUEUE_EMPTY(&this->headtail);
}

void multiqueue_replace_parent(MultiQueue *this, MultiQueue *new_parent)
{
  (__builtin_expect(!(multiqueue_empty(this)), 0) ? __assert_rtn(__func__, "multiqueue.c", 175, "multiqueue_empty(this)") : (void)0);
...
{
  (__builtin_expect(!(item != ((void*)0)), 0) ? __assert_rtn(__func__, "multiqueue.c", 190, "item != NULL") : (void)0);
  Event ev;
  if (item->link) {

    MultiQueue *linked = item->data.queue;
    (__builtin_expect(!(!multiqueue_empty(linked)), 0) ? __assert_rtn(__func__, "multiqueue.c", 195, "!multiqueue_empty(linked)") : (void)0);
...
{
  (__builtin_expect(!(!multiqueue_empty(this)), 0) ? __assert_rtn(__func__, "multiqueue.c", 218, "!multiqueue_empty(this)") : (void)0);
  QUEUE *h = (&this->headtail)->next;
  QUEUE_REMOVE(h);
  MultiQueueItem *item = multiqueue_node_data(h);
  (__builtin_expect(!(!item->link || !this->parent), 0) ? __assert_rtn(__func__, "multiqueue.c", 222, "!item->link || !this->parent") : (void)0);
...
# 260 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/event/multiqueue.c"
