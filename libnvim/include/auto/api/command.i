# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/command.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/command.c" 2
...
# 5 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/command.c" 2
...
# 32 "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.0.sdk/usr/include/sys/_types.h" 3 4
...
# 33 "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.0.sdk/usr/include/sys/_types.h" 2 3 4
...
# 6 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/command.c" 2
...
# 7 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/command.c" 2

# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/command.h" 1
...
# 5 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/command.h" 2
...
# 6 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/command.h" 2
...
# 9 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/ex_cmds.h" 2
...
# 7 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/command.h" 2
# 9 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/command.c" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/private/converter.h" 1
# 10 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/command.c" 2
...
# 12 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/command.c" 2
...
# 14 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/command.c" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/ex_eval.h" 1
# 15 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/command.c" 2
...
# 16 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/command.c" 2
...
# 17 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/command.c" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/regexp.h" 1
# 18 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/command.c" 2
...
# 9 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/window.h" 2
...
# 20 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/command.c" 2
# 82 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/command.c"
  ...
  FUNC_API_SINCE(10) FUNC_API_FAST
{
  ...
  if (ea.argt & 0x010u) {
    if (*ea.arg != '\000') {
      (*((((args).size == (args).capacity) ? (((args).capacity = ((args).capacity ? (args).capacity << 1 : 8), (args).items = xrealloc((args).items, sizeof((args).items[0]) * (args).capacity)), 0) : 0), ((args).items + ((args).size++))) = (((Object) { .type = kObjectTypeString, .data.string = cstrn_to_string((char *)ea.arg, length) })));
    }
  } else {
    size_t end = 0;
    size_t len = 0;
  ...
  if (cmd != ((void*)0)) {
    (*((((result).size == (result).capacity) ? (((result).capacity = ((result).capacity ? (result).capacity << 1 : 8), (result).items = xrealloc((result).items, sizeof((result).items[0]) * (result).capacity)), 0) : 0), ((result).items + ((result).size++))) = (((KeyValuePair) { .key = cstr_to_string("cmd"), .value = ((Object) { .type = kObjectTypeString, .data.string = cstr_to_string((char *)cmd->uc_name) }) })));
  } else {
    (*((((result).size == (result).capacity) ? (((result).capacity = ((result).capacity ? (result).capacity << 1 : 8), (result).items = xrealloc((result).items, sizeof((result).items[0]) * (result).capacity)), 0) : 0), ((result).items + ((result).size++))) = (((KeyValuePair) { .key = cstr_to_string("cmd"), .value = ((Object) { .type = kObjectTypeString, .data.string = cstr_to_string((char *)get_command_name(((void*)0), ea.cmdidx)) }) })));
  }

  if (ea.argt & 0x001u) {
    Array range = { .size = 0, .capacity = 0, .items = ((void*)0) };
    if (ea.addr_count > 0) {
      if (ea.addr_count > 1) {
  ...
  (*((((result).size == (result).capacity) ? (((result).capacity = ((result).capacity ? (result).capacity << 1 : 8), (result).items = xrealloc((result).items, sizeof((result).items[0]) * (result).capacity)), 0) : 0), ((result).items + ((result).size++))) = (((KeyValuePair) { .key = cstr_to_string("nextcmd"), .value = ((Object) { .type = kObjectTypeString, .data.string = cstr_to_string((char *)ea.nextcmd) }) })));

  Dictionary mods = { .size = 0, .capacity = 0, .items = ((void*)0) };

  Dictionary filter = { .size = 0, .capacity = 0, .items = ((void*)0) };
  ...
  Dictionary magic = { .size = 0, .capacity = 0, .items = ((void*)0) };
...
# 305 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/command.c"
String nvim_cmd(uint64_t channel_id, Dict(cmd) *cmd, Dict(cmd_opts) *opts, Error *err)
  FUNC_API_SINCE(10)
{
  exarg_T ea;
  __builtin___memset_chk (&(ea), 0, sizeof(ea), __builtin_object_size (&(ea), 0));

  CmdParseInfo cmdinfo;
  __builtin___memset_chk (&(cmdinfo), 0, sizeof(cmdinfo), __builtin_object_size (&(cmdinfo), 0));

  char *cmdline = ((void*)0);
  char *cmdname = ((void*)0);
  ArrayOf(String) args = { .size = 0, .capacity = 0, .items = ((void*)0) };

  String retv = (String){ .data = ((void*)0), .size = 0 };
# 344 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/command.c"
  _Bool output;
  do { (output) = api_object_to_bool(opts->output, "'output'", 0, err); if (((err)->type != kErrorTypeNone)) { goto end; } } while (0);


  if (!((cmd->cmd).type != kObjectTypeNil) || cmd->cmd.type != kObjectTypeString
      || cmd->cmd.data.string.data[0] == '\000') {
    do { api_set_error(err, kErrorTypeValidation, "'cmd' must be a non-empty String"); goto end; } while (0);
  }

  cmdname = string_to_cstr(cmd->cmd.data.string);
  ea.cmd = cmdname;

  char *p = find_ex_command(&ea, ((void*)0));



  if (p != ((void*)0) && ea.cmdidx == CMD_SIZE && ((unsigned)(*ea.cmd) >= 'A' && (unsigned)(*ea.cmd) <= 'Z')
      && has_event(EVENT_CMDUNDEFINED)) {
    p = xstrdup(cmdname);
    int ret = apply_autocmds(EVENT_CMDUNDEFINED, p, p, 1, ((void*)0));
    xfree(p);


    p = (ret && !aborting()) ? find_ex_command(&ea, ((void*)0)) : ea.cmd;
  }

  if (p == ((void*)0) || ea.cmdidx == CMD_SIZE) {
    do { api_set_error(err, kErrorTypeValidation, "Command not found: %s", cmdname); goto end; } while (0);
  }
  if (is_cmd_ni(ea.cmdidx)) {
    do { api_set_error(err, kErrorTypeValidation, "Command not implemented: %s", cmdname); goto end; } while (0);
  }
  ...
  if (((cmd->args).type != kObjectTypeNil)) {
    if (cmd->args.type != kObjectTypeArray) {
      do { api_set_error(err, kErrorTypeValidation, "'args' must be an Array"); goto end; } while (0);
    }
    ...
    for (size_t i = 0; i < cmd->args.data.array.size; i++) {
      ...
      case kObjectTypeInteger:
        ...
        __builtin___snprintf_chk (data_str, NUMBUFLEN, 0, __builtin_object_size (data_str, 1 > 1 ? 1 : 0), "%" "ll" "d", elem.data.integer);
        break;
      case kObjectTypeString:
        if (string_iswhite(elem.data.string)) {
          do { api_set_error(err, kErrorTypeValidation, "String command argument must have at least one non-whitespace " "character"); goto end; } while (0);

        }
        data_str = xstrndup(elem.data.string.data, elem.data.string.size);
        break;
      default:
        do { api_set_error(err, kErrorTypeValidation, "Invalid type for command argument"); goto end; } while (0);
        break;
      }
    ...
    if (!argc_valid) {
      do { api_set_error(err, kErrorTypeValidation, "Incorrect number of arguments supplied"); goto end; } while (0);
    }
  }



  set_cmd_addr_type(&ea, args.size > 0 ? args.items[0].data.string.data : ((void*)0));

  if (((cmd->range).type != kObjectTypeNil)) {
    if (!(ea.argt & 0x001u)) {
      do { api_set_error(err, kErrorTypeValidation, "Command cannot accept a range"); goto end; } while (0);
    } else if (cmd->range.type != kObjectTypeArray) {
      do { api_set_error(err, kErrorTypeValidation, "'range' must be an Array"); goto end; } while (0);
    } else if (cmd->range.data.array.size > 2) {
      do { api_set_error(err, kErrorTypeValidation, "'range' cannot contain more than two elements"); goto end; } while (0);
    }
    ...
    for (size_t i = 0; i < range.size; i++) {
      ...
      if (elem.type != kObjectTypeInteger || elem.data.integer < 0) {
        do { api_set_error(err, kErrorTypeValidation, "'range' element must be a non-negative Integer"); goto end; } while (0);
      }
    }
    ...
    if (invalid_range(&ea) != ((void*)0)) {
      do { api_set_error(err, kErrorTypeValidation, "Invalid range provided"); goto end; } while (0);
    }
  }
  if (ea.addr_count == 0) {
    if (ea.argt & 0x020u) {
  ...
  if (((cmd->count).type != kObjectTypeNil)) {
    if (!(ea.argt & 0x400u)) {
      do { api_set_error(err, kErrorTypeValidation, "Command cannot accept a count"); goto end; } while (0);
    } else if (cmd->count.type != kObjectTypeInteger || cmd->count.data.integer < 0) {
      do { api_set_error(err, kErrorTypeValidation, "'count' must be a non-negative Integer"); goto end; } while (0);
    }
    set_cmd_count(&ea, cmd->count.data.integer, 1);
  }

  if (((cmd->reg).type != kObjectTypeNil)) {
    if (!(ea.argt & 0x200u)) {
      do { api_set_error(err, kErrorTypeValidation, "Command cannot accept a register"); goto end; } while (0);
    } else if (cmd->reg.type != kObjectTypeString || cmd->reg.data.string.size != 1) {
      do { api_set_error(err, kErrorTypeValidation, "'reg' must be a single character"); goto end; } while (0);
    }
    char regname = cmd->reg.data.string.data[0];
    if (regname == '=') {
      do { api_set_error(err, kErrorTypeValidation, "Cannot use register \"="); goto end; } while (0);
    } else if (!valid_yank_reg(regname, ea.cmdidx != CMD_put && !((int)(ea.cmdidx) < 0))) {
      do { api_set_error(err, kErrorTypeValidation, "Invalid register: \"%c", regname); goto end; } while (0);
    }
    ea.regname = (uint8_t)regname;
  }

  do { (ea.forceit) = api_object_to_bool(cmd->bang, "'bang'", 0, err); if (((err)->type != kErrorTypeNone)) { goto end; } } while (0);
  if (ea.forceit && !(ea.argt & 0x002u)) {
    do { api_set_error(err, kErrorTypeValidation, "Command cannot accept a bang"); goto end; } while (0);
  }

  if (((cmd->magic).type != kObjectTypeNil)) {
    if (cmd->magic.type != kObjectTypeDictionary) {
      do { api_set_error(err, kErrorTypeValidation, "'magic' must be a Dictionary"); goto end; } while (0);
    }
  ...
  if (((cmd->mods).type != kObjectTypeNil)) {
    if (cmd->mods.type != kObjectTypeDictionary) {
      do { api_set_error(err, kErrorTypeValidation, "'mods' must be a Dictionary"); goto end; } while (0);
    }
    ...
    if (((mods.filter).type != kObjectTypeNil)) {
      if (mods.filter.type != kObjectTypeDictionary) {
        do { api_set_error(err, kErrorTypeValidation, "'mods.filter' must be a Dictionary"); goto end; } while (0);
      }
      ...
      if (((filter.pattern).type != kObjectTypeNil)) {
        if (filter.pattern.type != kObjectTypeString) {
          do { api_set_error(err, kErrorTypeValidation, "'mods.filter.pattern' must be a String"); goto end; } while (0);
        }

        do { (cmdinfo.cmdmod.cmod_filter_force) = api_object_to_bool(filter.force, "'mods.filter.force'", 0, err); if (((err)->type != kErrorTypeNone)) { goto end; } } while (0);
    ...
    if (((mods.tab).type != kObjectTypeNil)) {
      if (mods.tab.type != kObjectTypeInteger) {
        do { api_set_error(err, kErrorTypeValidation, "'mods.tab' must be an Integer"); goto end; } while (0);
    ...
    if (((mods.verbose).type != kObjectTypeNil)) {
      if (mods.verbose.type != kObjectTypeInteger) {
        do { api_set_error(err, kErrorTypeValidation, "'mods.verbose' must be an Integer"); goto end; } while (0);
    ...
    _Bool vertical;
    do { (vertical) = api_object_to_bool(mods.vertical, "'mods.vertical'", 0, err); if (((err)->type != kErrorTypeNone)) { goto end; } } while (0);
    cmdinfo.cmdmod.cmod_split |= (vertical ? 0x02 : 0);

    _Bool horizontal;
    do { (horizontal) = api_object_to_bool(mods.horizontal, "'mods.horizontal'", 0, err); if (((err)->type != kErrorTypeNone)) { goto end; } } while (0);
    cmdinfo.cmdmod.cmod_split |= (horizontal ? 0x04 : 0);

    if (((mods.split).type != kObjectTypeNil)) {
      if (mods.split.type != kObjectTypeString) {
        do { api_set_error(err, kErrorTypeValidation, "'mods.split' must be a String"); goto end; } while (0);
      }
      ...
      if (*mods.split.data.string.data == '\000') {
        ...
        do { api_set_error(err, kErrorTypeValidation, "Invalid value for 'mods.split'"); goto end; } while (0);
      }
    }

    do { if (api_object_to_bool(mods.silent, "'mods.silent'", 0, err)) { cmdinfo.cmdmod.cmod_flags |= (CMOD_SILENT); } if (((err)->type != kErrorTypeNone)) { goto end; } } while (0);
    do { if (api_object_to_bool(mods.emsg_silent, "'mods.emsg_silent'", 0, err)) { cmdinfo.cmdmod.cmod_flags |= (CMOD_ERRSILENT); } if (((err)->type != kErrorTypeNone)) { goto end; } } while (0);
    do { if (api_object_to_bool(mods.unsilent, "'mods.unsilent'", 0, err)) { cmdinfo.cmdmod.cmod_flags |= (CMOD_UNSILENT); } if (((err)->type != kErrorTypeNone)) { goto end; } } while (0);
    do { if (api_object_to_bool(mods.sandbox, "'mods.sandbox'", 0, err)) { cmdinfo.cmdmod.cmod_flags |= (CMOD_SANDBOX); } if (((err)->type != kErrorTypeNone)) { goto end; } } while (0);
    do { if (api_object_to_bool(mods.noautocmd, "'mods.noautocmd'", 0, err)) { cmdinfo.cmdmod.cmod_flags |= (CMOD_NOAUTOCMD); } if (((err)->type != kErrorTypeNone)) { goto end; } } while (0);
    do { if (api_object_to_bool(mods.browse, "'mods.browse'", 0, err)) { cmdinfo.cmdmod.cmod_flags |= (CMOD_BROWSE); } if (((err)->type != kErrorTypeNone)) { goto end; } } while (0);
    do { if (api_object_to_bool(mods.confirm, "'mods.confirm'", 0, err)) { cmdinfo.cmdmod.cmod_flags |= (CMOD_CONFIRM); } if (((err)->type != kErrorTypeNone)) { goto end; } } while (0);
    do { if (api_object_to_bool(mods.hide, "'mods.hide'", 0, err)) { cmdinfo.cmdmod.cmod_flags |= (CMOD_HIDE); } if (((err)->type != kErrorTypeNone)) { goto end; } } while (0);
    do { if (api_object_to_bool(mods.keepalt, "'mods.keepalt'", 0, err)) { cmdinfo.cmdmod.cmod_flags |= (CMOD_KEEPALT); } if (((err)->type != kErrorTypeNone)) { goto end; } } while (0);
    do { if (api_object_to_bool(mods.keepjumps, "'mods.keepjumps'", 0, err)) { cmdinfo.cmdmod.cmod_flags |= (CMOD_KEEPJUMPS); } if (((err)->type != kErrorTypeNone)) { goto end; } } while (0);
    do { if (api_object_to_bool(mods.keepmarks, "'mods.keepmarks'", 0, err)) { cmdinfo.cmdmod.cmod_flags |= (CMOD_KEEPMARKS); } if (((err)->type != kErrorTypeNone)) { goto end; } } while (0);
    do { if (api_object_to_bool(mods.keeppatterns, "'mods.keeppatterns'", 0, err)) { cmdinfo.cmdmod.cmod_flags |= (CMOD_KEEPPATTERNS); } if (((err)->type != kErrorTypeNone)) { goto end; } } while (0);
    do { if (api_object_to_bool(mods.lockmarks, "'mods.lockmarks'", 0, err)) { cmdinfo.cmdmod.cmod_flags |= (CMOD_LOCKMARKS); } if (((err)->type != kErrorTypeNone)) { goto end; } } while (0);
    do { if (api_object_to_bool(mods.noswapfile, "'mods.noswapfile'", 0, err)) { cmdinfo.cmdmod.cmod_flags |= (CMOD_NOSWAPFILE); } if (((err)->type != kErrorTypeNone)) { goto end; } } while (0);

    if ((cmdinfo.cmdmod.cmod_flags & CMOD_SANDBOX) && !(ea.argt & 0x40000u)) {
      do { api_set_error(err, kErrorTypeValidation, "Command cannot be run in sandbox"); goto end; } while (0);
    }
  }
  ...
  do { msglist_T **saved_msg_list = msg_list; msglist_T *private_msg_list; msg_list = &private_msg_list; private_msg_list = ((void*)0); { try_start(); if (output) { msg_silent++; msg_col = 0; } do { const sctx_T save_current_sctx = current_sctx; current_sctx.sc_sid = (channel_id) == ((((uint64_t)1) << (sizeof(uint64_t) * 8 - 1)) + 1) ? (-8) : (-9); current_sctx.sc_lnum = 0; current_channel_id = channel_id; { execute_cmd(&ea, &cmdinfo, 0); }; current_sctx = save_current_sctx; } while (0);; if (output) { capture_ga = save_capture_ga; msg_silent = save_msg_silent; msg_col = save_msg_col; } try_end(err); } msg_list = saved_msg_list; } while (0);
# 689 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/command.c"
  ...
  if (output && capture_local.ga_len > 1) {
    ...
    if (retv.data[0] == '\n') {
      __builtin___memmove_chk (retv.data, retv.data + 1, retv.size - 1, __builtin_object_size (retv.data, 0));
                              ...
                              ArrayOf(String) args)
{
  ...
  StringBuilder cmdline = { .size = 0, .capacity = 0, .items = ((void*)0) };
  ...
  if (cmdinfo->cmdmod.cmod_flags & CMOD_ERRSILENT) {
    do { do { if ((cmdline).capacity < (cmdline).size + strlen((char *)("silent! "))) { (cmdline).capacity = (cmdline).size + strlen((char *)("silent! ")); ((--((cmdline).capacity)), (((cmdline).capacity)|=((cmdline).capacity)>>1, ((cmdline).capacity)|=((cmdline).capacity)>>2, ((cmdline).capacity)|=((cmdline).capacity)>>4, ((cmdline).capacity)|=((cmdline).capacity)>>8, ((cmdline).capacity)|=((cmdline).capacity)>>16), (++((cmdline).capacity))); (((cmdline)).capacity = ((cmdline).capacity), ((cmdline)).items = xrealloc(((cmdline)).items, sizeof(((cmdline)).items[0]) * ((cmdline)).capacity)); } } while (0); __builtin___memcpy_chk ((cmdline).items + (cmdline).size, "silent! ", sizeof((cmdline).items[0]) * strlen((char *)("silent! ")), __builtin_object_size ((cmdline).items + (cmdline).size, 0)); (cmdline).size = (cmdline).size + strlen((char *)("silent! ")); } while (0);
  } else if (cmdinfo->cmdmod.cmod_flags & CMOD_SILENT) {
    do { do { if ((cmdline).capacity < (cmdline).size + strlen((char *)("silent "))) { (cmdline).capacity = (cmdline).size + strlen((char *)("silent ")); ((--((cmdline).capacity)), (((cmdline).capacity)|=((cmdline).capacity)>>1, ((cmdline).capacity)|=((cmdline).capacity)>>2, ((cmdline).capacity)|=((cmdline).capacity)>>4, ((cmdline).capacity)|=((cmdline).capacity)>>8, ((cmdline).capacity)|=((cmdline).capacity)>>16), (++((cmdline).capacity))); (((cmdline)).capacity = ((cmdline).capacity), ((cmdline)).items = xrealloc(((cmdline)).items, sizeof(((cmdline)).items[0]) * ((cmdline)).capacity)); } } while (0); __builtin___memcpy_chk ((cmdline).items + (cmdline).size, "silent ", sizeof((cmdline).items[0]) * strlen((char *)("silent ")), __builtin_object_size ((cmdline).items + (cmdline).size, 0)); (cmdline).size = (cmdline).size + strlen((char *)("silent ")); } while (0);
  }

  if (cmdinfo->cmdmod.cmod_flags & CMOD_UNSILENT) {
    do { do { if ((cmdline).capacity < (cmdline).size + strlen((char *)("unsilent "))) { (cmdline).capacity = (cmdline).size + strlen((char *)("unsilent ")); ((--((cmdline).capacity)), (((cmdline).capacity)|=((cmdline).capacity)>>1, ((cmdline).capacity)|=((cmdline).capacity)>>2, ((cmdline).capacity)|=((cmdline).capacity)>>4, ((cmdline).capacity)|=((cmdline).capacity)>>8, ((cmdline).capacity)|=((cmdline).capacity)>>16), (++((cmdline).capacity))); (((cmdline)).capacity = ((cmdline).capacity), ((cmdline)).items = xrealloc(((cmdline)).items, sizeof(((cmdline)).items[0]) * ((cmdline)).capacity)); } } while (0); __builtin___memcpy_chk ((cmdline).items + (cmdline).size, "unsilent ", sizeof((cmdline).items[0]) * strlen((char *)("unsilent ")), __builtin_object_size ((cmdline).items + (cmdline).size, 0)); (cmdline).size = (cmdline).size + strlen((char *)("unsilent ")); } while (0);
  }

  switch (cmdinfo->cmdmod.cmod_split & (0x80 | 0x40 | 0x08 | 0x10)) {
  case 0x80:
    do { do { if ((cmdline).capacity < (cmdline).size + strlen((char *)("aboveleft "))) { (cmdline).capacity = (cmdline).size + strlen((char *)("aboveleft ")); ((--((cmdline).capacity)), (((cmdline).capacity)|=((cmdline).capacity)>>1, ((cmdline).capacity)|=((cmdline).capacity)>>2, ((cmdline).capacity)|=((cmdline).capacity)>>4, ((cmdline).capacity)|=((cmdline).capacity)>>8, ((cmdline).capacity)|=((cmdline).capacity)>>16), (++((cmdline).capacity))); (((cmdline)).capacity = ((cmdline).capacity), ((cmdline)).items = xrealloc(((cmdline)).items, sizeof(((cmdline)).items[0]) * ((cmdline)).capacity)); } } while (0); __builtin___memcpy_chk ((cmdline).items + (cmdline).size, "aboveleft ", sizeof((cmdline).items[0]) * strlen((char *)("aboveleft ")), __builtin_object_size ((cmdline).items + (cmdline).size, 0)); (cmdline).size = (cmdline).size + strlen((char *)("aboveleft ")); } while (0);
    break;
  case 0x40:
    do { do { if ((cmdline).capacity < (cmdline).size + strlen((char *)("belowright "))) { (cmdline).capacity = (cmdline).size + strlen((char *)("belowright ")); ((--((cmdline).capacity)), (((cmdline).capacity)|=((cmdline).capacity)>>1, ((cmdline).capacity)|=((cmdline).capacity)>>2, ((cmdline).capacity)|=((cmdline).capacity)>>4, ((cmdline).capacity)|=((cmdline).capacity)>>8, ((cmdline).capacity)|=((cmdline).capacity)>>16), (++((cmdline).capacity))); (((cmdline)).capacity = ((cmdline).capacity), ((cmdline)).items = xrealloc(((cmdline)).items, sizeof(((cmdline)).items[0]) * ((cmdline)).capacity)); } } while (0); __builtin___memcpy_chk ((cmdline).items + (cmdline).size, "belowright ", sizeof((cmdline).items[0]) * strlen((char *)("belowright ")), __builtin_object_size ((cmdline).items + (cmdline).size, 0)); (cmdline).size = (cmdline).size + strlen((char *)("belowright ")); } while (0);
    break;
  case 0x08:
    do { do { if ((cmdline).capacity < (cmdline).size + strlen((char *)("topleft "))) { (cmdline).capacity = (cmdline).size + strlen((char *)("topleft ")); ((--((cmdline).capacity)), (((cmdline).capacity)|=((cmdline).capacity)>>1, ((cmdline).capacity)|=((cmdline).capacity)>>2, ((cmdline).capacity)|=((cmdline).capacity)>>4, ((cmdline).capacity)|=((cmdline).capacity)>>8, ((cmdline).capacity)|=((cmdline).capacity)>>16), (++((cmdline).capacity))); (((cmdline)).capacity = ((cmdline).capacity), ((cmdline)).items = xrealloc(((cmdline)).items, sizeof(((cmdline)).items[0]) * ((cmdline)).capacity)); } } while (0); __builtin___memcpy_chk ((cmdline).items + (cmdline).size, "topleft ", sizeof((cmdline).items[0]) * strlen((char *)("topleft ")), __builtin_object_size ((cmdline).items + (cmdline).size, 0)); (cmdline).size = (cmdline).size + strlen((char *)("topleft ")); } while (0);
    break;
  case 0x10:
    do { do { if ((cmdline).capacity < (cmdline).size + strlen((char *)("botright "))) { (cmdline).capacity = (cmdline).size + strlen((char *)("botright ")); ((--((cmdline).capacity)), (((cmdline).capacity)|=((cmdline).capacity)>>1, ((cmdline).capacity)|=((cmdline).capacity)>>2, ((cmdline).capacity)|=((cmdline).capacity)>>4, ((cmdline).capacity)|=((cmdline).capacity)>>8, ((cmdline).capacity)|=((cmdline).capacity)>>16), (++((cmdline).capacity))); (((cmdline)).capacity = ((cmdline).capacity), ((cmdline)).items = xrealloc(((cmdline)).items, sizeof(((cmdline)).items[0]) * ((cmdline)).capacity)); } } while (0); __builtin___memcpy_chk ((cmdline).items + (cmdline).size, "botright ", sizeof((cmdline).items[0]) * strlen((char *)("botright ")), __builtin_object_size ((cmdline).items + (cmdline).size, 0)); (cmdline).size = (cmdline).size + strlen((char *)("botright ")); } while (0);
    break;
  default:
    break;
  }
# 789 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/command.c"
  do { if (cmdinfo->cmdmod.cmod_split & 0x02) { do { do { if ((cmdline).capacity < (cmdline).size + strlen((char *)("vertical "))) { (cmdline).capacity = (cmdline).size + strlen((char *)("vertical ")); ((--((cmdline).capacity)), (((cmdline).capacity)|=((cmdline).capacity)>>1, ((cmdline).capacity)|=((cmdline).capacity)>>2, ((cmdline).capacity)|=((cmdline).capacity)>>4, ((cmdline).capacity)|=((cmdline).capacity)>>8, ((cmdline).capacity)|=((cmdline).capacity)>>16), (++((cmdline).capacity))); (((cmdline)).capacity = ((cmdline).capacity), ((cmdline)).items = xrealloc(((cmdline)).items, sizeof(((cmdline)).items[0]) * ((cmdline)).capacity)); } } while (0); __builtin___memcpy_chk ((cmdline).items + (cmdline).size, "vertical ", sizeof((cmdline).items[0]) * strlen((char *)("vertical ")), __builtin_object_size ((cmdline).items + (cmdline).size, 0)); (cmdline).size = (cmdline).size + strlen((char *)("vertical ")); } while (0); } } while (0);
  do { if (cmdinfo->cmdmod.cmod_split & 0x04) { do { do { if ((cmdline).capacity < (cmdline).size + strlen((char *)("horizontal "))) { (cmdline).capacity = (cmdline).size + strlen((char *)("horizontal ")); ((--((cmdline).capacity)), (((cmdline).capacity)|=((cmdline).capacity)>>1, ((cmdline).capacity)|=((cmdline).capacity)>>2, ((cmdline).capacity)|=((cmdline).capacity)>>4, ((cmdline).capacity)|=((cmdline).capacity)>>8, ((cmdline).capacity)|=((cmdline).capacity)>>16), (++((cmdline).capacity))); (((cmdline)).capacity = ((cmdline).capacity), ((cmdline)).items = xrealloc(((cmdline)).items, sizeof(((cmdline)).items[0]) * ((cmdline)).capacity)); } } while (0); __builtin___memcpy_chk ((cmdline).items + (cmdline).size, "horizontal ", sizeof((cmdline).items[0]) * strlen((char *)("horizontal ")), __builtin_object_size ((cmdline).items + (cmdline).size, 0)); (cmdline).size = (cmdline).size + strlen((char *)("horizontal ")); } while (0); } } while (0);
  do { if (cmdinfo->cmdmod.cmod_flags & CMOD_SANDBOX) { do { do { if ((cmdline).capacity < (cmdline).size + strlen((char *)("sandbox "))) { (cmdline).capacity = (cmdline).size + strlen((char *)("sandbox ")); ((--((cmdline).capacity)), (((cmdline).capacity)|=((cmdline).capacity)>>1, ((cmdline).capacity)|=((cmdline).capacity)>>2, ((cmdline).capacity)|=((cmdline).capacity)>>4, ((cmdline).capacity)|=((cmdline).capacity)>>8, ((cmdline).capacity)|=((cmdline).capacity)>>16), (++((cmdline).capacity))); (((cmdline)).capacity = ((cmdline).capacity), ((cmdline)).items = xrealloc(((cmdline)).items, sizeof(((cmdline)).items[0]) * ((cmdline)).capacity)); } } while (0); __builtin___memcpy_chk ((cmdline).items + (cmdline).size, "sandbox ", sizeof((cmdline).items[0]) * strlen((char *)("sandbox ")), __builtin_object_size ((cmdline).items + (cmdline).size, 0)); (cmdline).size = (cmdline).size + strlen((char *)("sandbox ")); } while (0); } } while (0);
  do { if (cmdinfo->cmdmod.cmod_flags & CMOD_NOAUTOCMD) { do { do { if ((cmdline).capacity < (cmdline).size + strlen((char *)("noautocmd "))) { (cmdline).capacity = (cmdline).size + strlen((char *)("noautocmd ")); ((--((cmdline).capacity)), (((cmdline).capacity)|=((cmdline).capacity)>>1, ((cmdline).capacity)|=((cmdline).capacity)>>2, ((cmdline).capacity)|=((cmdline).capacity)>>4, ((cmdline).capacity)|=((cmdline).capacity)>>8, ((cmdline).capacity)|=((cmdline).capacity)>>16), (++((cmdline).capacity))); (((cmdline)).capacity = ((cmdline).capacity), ((cmdline)).items = xrealloc(((cmdline)).items, sizeof(((cmdline)).items[0]) * ((cmdline)).capacity)); } } while (0); __builtin___memcpy_chk ((cmdline).items + (cmdline).size, "noautocmd ", sizeof((cmdline).items[0]) * strlen((char *)("noautocmd ")), __builtin_object_size ((cmdline).items + (cmdline).size, 0)); (cmdline).size = (cmdline).size + strlen((char *)("noautocmd ")); } while (0); } } while (0);
  do { if (cmdinfo->cmdmod.cmod_flags & CMOD_BROWSE) { do { do { if ((cmdline).capacity < (cmdline).size + strlen((char *)("browse "))) { (cmdline).capacity = (cmdline).size + strlen((char *)("browse ")); ((--((cmdline).capacity)), (((cmdline).capacity)|=((cmdline).capacity)>>1, ((cmdline).capacity)|=((cmdline).capacity)>>2, ((cmdline).capacity)|=((cmdline).capacity)>>4, ((cmdline).capacity)|=((cmdline).capacity)>>8, ((cmdline).capacity)|=((cmdline).capacity)>>16), (++((cmdline).capacity))); (((cmdline)).capacity = ((cmdline).capacity), ((cmdline)).items = xrealloc(((cmdline)).items, sizeof(((cmdline)).items[0]) * ((cmdline)).capacity)); } } while (0); __builtin___memcpy_chk ((cmdline).items + (cmdline).size, "browse ", sizeof((cmdline).items[0]) * strlen((char *)("browse ")), __builtin_object_size ((cmdline).items + (cmdline).size, 0)); (cmdline).size = (cmdline).size + strlen((char *)("browse ")); } while (0); } } while (0);
  do { if (cmdinfo->cmdmod.cmod_flags & CMOD_CONFIRM) { do { do { if ((cmdline).capacity < (cmdline).size + strlen((char *)("confirm "))) { (cmdline).capacity = (cmdline).size + strlen((char *)("confirm ")); ((--((cmdline).capacity)), (((cmdline).capacity)|=((cmdline).capacity)>>1, ((cmdline).capacity)|=((cmdline).capacity)>>2, ((cmdline).capacity)|=((cmdline).capacity)>>4, ((cmdline).capacity)|=((cmdline).capacity)>>8, ((cmdline).capacity)|=((cmdline).capacity)>>16), (++((cmdline).capacity))); (((cmdline)).capacity = ((cmdline).capacity), ((cmdline)).items = xrealloc(((cmdline)).items, sizeof(((cmdline)).items[0]) * ((cmdline)).capacity)); } } while (0); __builtin___memcpy_chk ((cmdline).items + (cmdline).size, "confirm ", sizeof((cmdline).items[0]) * strlen((char *)("confirm ")), __builtin_object_size ((cmdline).items + (cmdline).size, 0)); (cmdline).size = (cmdline).size + strlen((char *)("confirm ")); } while (0); } } while (0);
  do { if (cmdinfo->cmdmod.cmod_flags & CMOD_HIDE) { do { do { if ((cmdline).capacity < (cmdline).size + strlen((char *)("hide "))) { (cmdline).capacity = (cmdline).size + strlen((char *)("hide ")); ((--((cmdline).capacity)), (((cmdline).capacity)|=((cmdline).capacity)>>1, ((cmdline).capacity)|=((cmdline).capacity)>>2, ((cmdline).capacity)|=((cmdline).capacity)>>4, ((cmdline).capacity)|=((cmdline).capacity)>>8, ((cmdline).capacity)|=((cmdline).capacity)>>16), (++((cmdline).capacity))); (((cmdline)).capacity = ((cmdline).capacity), ((cmdline)).items = xrealloc(((cmdline)).items, sizeof(((cmdline)).items[0]) * ((cmdline)).capacity)); } } while (0); __builtin___memcpy_chk ((cmdline).items + (cmdline).size, "hide ", sizeof((cmdline).items[0]) * strlen((char *)("hide ")), __builtin_object_size ((cmdline).items + (cmdline).size, 0)); (cmdline).size = (cmdline).size + strlen((char *)("hide ")); } while (0); } } while (0);
  do { if (cmdinfo->cmdmod.cmod_flags & CMOD_KEEPALT) { do { do { if ((cmdline).capacity < (cmdline).size + strlen((char *)("keepalt "))) { (cmdline).capacity = (cmdline).size + strlen((char *)("keepalt ")); ((--((cmdline).capacity)), (((cmdline).capacity)|=((cmdline).capacity)>>1, ((cmdline).capacity)|=((cmdline).capacity)>>2, ((cmdline).capacity)|=((cmdline).capacity)>>4, ((cmdline).capacity)|=((cmdline).capacity)>>8, ((cmdline).capacity)|=((cmdline).capacity)>>16), (++((cmdline).capacity))); (((cmdline)).capacity = ((cmdline).capacity), ((cmdline)).items = xrealloc(((cmdline)).items, sizeof(((cmdline)).items[0]) * ((cmdline)).capacity)); } } while (0); __builtin___memcpy_chk ((cmdline).items + (cmdline).size, "keepalt ", sizeof((cmdline).items[0]) * strlen((char *)("keepalt ")), __builtin_object_size ((cmdline).items + (cmdline).size, 0)); (cmdline).size = (cmdline).size + strlen((char *)("keepalt ")); } while (0); } } while (0);
  do { if (cmdinfo->cmdmod.cmod_flags & CMOD_KEEPJUMPS) { do { do { if ((cmdline).capacity < (cmdline).size + strlen((char *)("keepjumps "))) { (cmdline).capacity = (cmdline).size + strlen((char *)("keepjumps ")); ((--((cmdline).capacity)), (((cmdline).capacity)|=((cmdline).capacity)>>1, ((cmdline).capacity)|=((cmdline).capacity)>>2, ((cmdline).capacity)|=((cmdline).capacity)>>4, ((cmdline).capacity)|=((cmdline).capacity)>>8, ((cmdline).capacity)|=((cmdline).capacity)>>16), (++((cmdline).capacity))); (((cmdline)).capacity = ((cmdline).capacity), ((cmdline)).items = xrealloc(((cmdline)).items, sizeof(((cmdline)).items[0]) * ((cmdline)).capacity)); } } while (0); __builtin___memcpy_chk ((cmdline).items + (cmdline).size, "keepjumps ", sizeof((cmdline).items[0]) * strlen((char *)("keepjumps ")), __builtin_object_size ((cmdline).items + (cmdline).size, 0)); (cmdline).size = (cmdline).size + strlen((char *)("keepjumps ")); } while (0); } } while (0);
  do { if (cmdinfo->cmdmod.cmod_flags & CMOD_KEEPMARKS) { do { do { if ((cmdline).capacity < (cmdline).size + strlen((char *)("keepmarks "))) { (cmdline).capacity = (cmdline).size + strlen((char *)("keepmarks ")); ((--((cmdline).capacity)), (((cmdline).capacity)|=((cmdline).capacity)>>1, ((cmdline).capacity)|=((cmdline).capacity)>>2, ((cmdline).capacity)|=((cmdline).capacity)>>4, ((cmdline).capacity)|=((cmdline).capacity)>>8, ((cmdline).capacity)|=((cmdline).capacity)>>16), (++((cmdline).capacity))); (((cmdline)).capacity = ((cmdline).capacity), ((cmdline)).items = xrealloc(((cmdline)).items, sizeof(((cmdline)).items[0]) * ((cmdline)).capacity)); } } while (0); __builtin___memcpy_chk ((cmdline).items + (cmdline).size, "keepmarks ", sizeof((cmdline).items[0]) * strlen((char *)("keepmarks ")), __builtin_object_size ((cmdline).items + (cmdline).size, 0)); (cmdline).size = (cmdline).size + strlen((char *)("keepmarks ")); } while (0); } } while (0);
  do { if (cmdinfo->cmdmod.cmod_flags & CMOD_KEEPPATTERNS) { do { do { if ((cmdline).capacity < (cmdline).size + strlen((char *)("keeppatterns "))) { (cmdline).capacity = (cmdline).size + strlen((char *)("keeppatterns ")); ((--((cmdline).capacity)), (((cmdline).capacity)|=((cmdline).capacity)>>1, ((cmdline).capacity)|=((cmdline).capacity)>>2, ((cmdline).capacity)|=((cmdline).capacity)>>4, ((cmdline).capacity)|=((cmdline).capacity)>>8, ((cmdline).capacity)|=((cmdline).capacity)>>16), (++((cmdline).capacity))); (((cmdline)).capacity = ((cmdline).capacity), ((cmdline)).items = xrealloc(((cmdline)).items, sizeof(((cmdline)).items[0]) * ((cmdline)).capacity)); } } while (0); __builtin___memcpy_chk ((cmdline).items + (cmdline).size, "keeppatterns ", sizeof((cmdline).items[0]) * strlen((char *)("keeppatterns ")), __builtin_object_size ((cmdline).items + (cmdline).size, 0)); (cmdline).size = (cmdline).size + strlen((char *)("keeppatterns ")); } while (0); } } while (0);
  do { if (cmdinfo->cmdmod.cmod_flags & CMOD_LOCKMARKS) { do { do { if ((cmdline).capacity < (cmdline).size + strlen((char *)("lockmarks "))) { (cmdline).capacity = (cmdline).size + strlen((char *)("lockmarks ")); ((--((cmdline).capacity)), (((cmdline).capacity)|=((cmdline).capacity)>>1, ((cmdline).capacity)|=((cmdline).capacity)>>2, ((cmdline).capacity)|=((cmdline).capacity)>>4, ((cmdline).capacity)|=((cmdline).capacity)>>8, ((cmdline).capacity)|=((cmdline).capacity)>>16), (++((cmdline).capacity))); (((cmdline)).capacity = ((cmdline).capacity), ((cmdline)).items = xrealloc(((cmdline)).items, sizeof(((cmdline)).items[0]) * ((cmdline)).capacity)); } } while (0); __builtin___memcpy_chk ((cmdline).items + (cmdline).size, "lockmarks ", sizeof((cmdline).items[0]) * strlen((char *)("lockmarks ")), __builtin_object_size ((cmdline).items + (cmdline).size, 0)); (cmdline).size = (cmdline).size + strlen((char *)("lockmarks ")); } while (0); } } while (0);
  do { if (cmdinfo->cmdmod.cmod_flags & CMOD_NOSWAPFILE) { do { do { if ((cmdline).capacity < (cmdline).size + strlen((char *)("noswapfile "))) { (cmdline).capacity = (cmdline).size + strlen((char *)("noswapfile ")); ((--((cmdline).capacity)), (((cmdline).capacity)|=((cmdline).capacity)>>1, ((cmdline).capacity)|=((cmdline).capacity)>>2, ((cmdline).capacity)|=((cmdline).capacity)>>4, ((cmdline).capacity)|=((cmdline).capacity)>>8, ((cmdline).capacity)|=((cmdline).capacity)>>16), (++((cmdline).capacity))); (((cmdline)).capacity = ((cmdline).capacity), ((cmdline)).items = xrealloc(((cmdline)).items, sizeof(((cmdline)).items[0]) * ((cmdline)).capacity)); } } while (0); __builtin___memcpy_chk ((cmdline).items + (cmdline).size, "noswapfile ", sizeof((cmdline).items[0]) * strlen((char *)("noswapfile ")), __builtin_object_size ((cmdline).items + (cmdline).size, 0)); (cmdline).size = (cmdline).size + strlen((char *)("noswapfile ")); } while (0); } } while (0);



  if (eap->argt & 0x001u) {
    if (eap->addr_count == 1) {
      kv_do_printf(&(cmdline), "%" "d", eap->line2);
    } else if (eap->addr_count > 1) {
      kv_do_printf(&(cmdline), "%" "d" ",%" "d", eap->line1, eap->line2);
      eap->addr_count = 2;
    }
  }
  ...
  do { do { if ((cmdline).capacity < (cmdline).size + strlen((char *)(eap->cmd))) { (cmdline).capacity = (cmdline).size + strlen((char *)(eap->cmd)); ((--((cmdline).capacity)), (((cmdline).capacity)|=((cmdline).capacity)>>1, ((cmdline).capacity)|=((cmdline).capacity)>>2, ((cmdline).capacity)|=((cmdline).capacity)>>4, ((cmdline).capacity)|=((cmdline).capacity)>>8, ((cmdline).capacity)|=((cmdline).capacity)>>16), (++((cmdline).capacity))); (((cmdline)).capacity = ((cmdline).capacity), ((cmdline)).items = xrealloc(((cmdline)).items, sizeof(((cmdline)).items[0]) * ((cmdline)).capacity)); } } while (0); __builtin___memcpy_chk ((cmdline).items + (cmdline).size, eap->cmd, sizeof((cmdline).items[0]) * strlen((char *)(eap->cmd)), __builtin_object_size ((cmdline).items + (cmdline).size, 0)); (cmdline).size = (cmdline).size + strlen((char *)(eap->cmd)); } while (0);


  if (eap->argt & 0x002u && eap->forceit) {
    do { do { if ((cmdline).capacity < (cmdline).size + strlen((char *)("!"))) { (cmdline).capacity = (cmdline).size + strlen((char *)("!")); ((--((cmdline).capacity)), (((cmdline).capacity)|=((cmdline).capacity)>>1, ((cmdline).capacity)|=((cmdline).capacity)>>2, ((cmdline).capacity)|=((cmdline).capacity)>>4, ((cmdline).capacity)|=((cmdline).capacity)>>8, ((cmdline).capacity)|=((cmdline).capacity)>>16), (++((cmdline).capacity))); (((cmdline)).capacity = ((cmdline).capacity), ((cmdline)).items = xrealloc(((cmdline)).items, sizeof(((cmdline)).items[0]) * ((cmdline)).capacity)); } } while (0); __builtin___memcpy_chk ((cmdline).items + (cmdline).size, "!", sizeof((cmdline).items[0]) * strlen((char *)("!")), __builtin_object_size ((cmdline).items + (cmdline).size, 0)); (cmdline).size = (cmdline).size + strlen((char *)("!")); } while (0);
  }
  ...
  eap->argc = argc;
  eap->arglens = eap->argc > 0 ? xcalloc(argc, sizeof(size_t)) : ((void*)0);
  size_t argstart_idx = cmdline.size;
  for (size_t i = 0; i < argc; i++) {
    String s = args.items[i].data.string;
    eap->arglens[i] = s.size;
    do { do { if ((cmdline).capacity < (cmdline).size + strlen((char *)(" "))) { (cmdline).capacity = (cmdline).size + strlen((char *)(" ")); ((--((cmdline).capacity)), (((cmdline).capacity)|=((cmdline).capacity)>>1, ((cmdline).capacity)|=((cmdline).capacity)>>2, ((cmdline).capacity)|=((cmdline).capacity)>>4, ((cmdline).capacity)|=((cmdline).capacity)>>8, ((cmdline).capacity)|=((cmdline).capacity)>>16), (++((cmdline).capacity))); (((cmdline)).capacity = ((cmdline).capacity), ((cmdline)).items = xrealloc(((cmdline)).items, sizeof(((cmdline)).items[0]) * ((cmdline)).capacity)); } } while (0); __builtin___memcpy_chk ((cmdline).items + (cmdline).size, " ", sizeof((cmdline).items[0]) * strlen((char *)(" ")), __builtin_object_size ((cmdline).items + (cmdline).size, 0)); (cmdline).size = (cmdline).size + strlen((char *)(" ")); } while (0);
    do { do { if ((cmdline).capacity < (cmdline).size + s.size) { (cmdline).capacity = (cmdline).size + s.size; ((--((cmdline).capacity)), (((cmdline).capacity)|=((cmdline).capacity)>>1, ((cmdline).capacity)|=((cmdline).capacity)>>2, ((cmdline).capacity)|=((cmdline).capacity)>>4, ((cmdline).capacity)|=((cmdline).capacity)>>8, ((cmdline).capacity)|=((cmdline).capacity)>>16), (++((cmdline).capacity))); (((cmdline)).capacity = ((cmdline).capacity), ((cmdline)).items = xrealloc(((cmdline)).items, sizeof(((cmdline)).items[0]) * ((cmdline)).capacity)); } } while (0); __builtin___memcpy_chk ((cmdline).items + (cmdline).size, s.data, sizeof((cmdline).items[0]) * s.size, __builtin_object_size ((cmdline).items + (cmdline).size, 0)); (cmdline).size = (cmdline).size + s.size; } while (0);
  }
  ...
  eap->args = eap->argc > 0 ? xcalloc(argc, sizeof(char *)) : ((void*)0);
  ...
  *cmdlinep = cmdline.items;
  ...
  if (p != eap->arg) {
    ...
    do { void **ptr_ = (void **)&(eap->args); xfree(*ptr_); *ptr_ = ((void*)0); (void)(*ptr_); } while (0);
    do { void **ptr_ = (void **)&(eap->arglens); xfree(*ptr_); *ptr_ = ((void*)0); (void)(*ptr_); } while (0);
    eap->argc = 0;
  }
}
# 910 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/command.c"
  ...
  FUNC_API_SINCE(9)
{
  ...
  curbuf = target_buf;
  create_user_command(name, command, opts, 1, err);
  curbuf = save_curbuf;
}
# 954 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/command.c"
  ...
  FUNC_API_SINCE(9)
{
  ...
  for (int i = 0; i < gap->ga_len; i++) {
    ...
    if (!strcmp(name.data, cmd->uc_name)) {
      ...
      if (i < gap->ga_len) {
        __builtin___memmove_chk (cmd, cmd + 1, (size_t)(gap->ga_len - i) * sizeof(ucmd_T), __builtin_object_size (cmd, 0));
      }
                         ...
                         Error *err)
{
  ...
  if (((opts->range).type != kObjectTypeNil) && ((opts->count).type != kObjectTypeNil)) {
  ...
  if (((opts->complete).type != kObjectTypeNil) && !argt) {
  ...
  } else if (((opts->addr).type != kObjectTypeNil)) {
    api_set_error(err, kErrorTypeValidation, "Invalid value for 'addr'");
    goto err;
  }

  if (api_object_to_bool(opts->bang, "bang", 0, err)) {
    argt |= 0x002u;
  } else if (((err)->type != kErrorTypeNone)) {
    goto err;
  }

  if (api_object_to_bool(opts->bar, "bar", 0, err)) {
    argt |= 0x100u;
  } else if (((err)->type != kErrorTypeNone)) {
    goto err;
  }

  if (api_object_to_bool(opts->register_, "register", 0, err)) {
    argt |= 0x200u;
  } else if (((err)->type != kErrorTypeNone)) {
    goto err;
  }

  if (api_object_to_bool(opts->keepscript, "keepscript", 0, err)) {
    argt |= 0x4000000u;
  } else if (((err)->type != kErrorTypeNone)) {
    goto err;
  }

  _Bool force = api_object_to_bool(opts->force, "force", 1, err);
  if (((err)->type != kErrorTypeNone)) {
    goto err;
  }
  ...
  } else if (((opts->preview).type != kObjectTypeNil)) {
  ...
  if (uc_add_command(name.data, name.size, rep, argt, def, flags, compl, compl_arg, compl_luaref,
                     preview_luaref, addr_type_arg, luaref, force) != 1) {
...
# 1196 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/command.c"
Dictionary nvim_get_commands(Dict(get_commands) *opts, Error *err)
  FUNC_API_SINCE(4)
{
  return nvim_buf_get_commands(-1, opts, err);
}
# 1209 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/command.c"
Dictionary nvim_buf_get_commands(Buffer buffer, Dict(get_commands) *opts, Error *err)
  FUNC_API_SINCE(4)
{
  _Bool global = (buffer == -1);
  _Bool builtin = api_object_to_bool(opts->builtin, "builtin", 0, err);
  if (((err)->type != kErrorTypeNone)) {
