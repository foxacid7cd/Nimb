# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/private/converter.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/private/converter.c" 2
...
# 5 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/private/converter.c" 2
...
# 6 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/private/converter.c" 2
...
# 7 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/private/converter.c" 2
...
# 9 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/private/converter.c" 2
...
# 11 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/private/converter.c" 2
...
# 14 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/private/converter.c" 2
...
# 5 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/lua/converter.h" 2
...
# 15 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/private/converter.c" 2
  ...
  FUNC_ATTR_ALWAYS_INLINE FUNC_ATTR_NONNULL_ALL
{
  ...
  (__builtin_expect(!(list->type == kObjectTypeArray), 0) ? __assert_rtn(__func__, "converter.c", 108, "list->type == kObjectTypeArray") : (void)0);
  (__builtin_expect(!(list->data.array.size < list->data.array.capacity), 0) ? __assert_rtn(__func__, "converter.c", 109, "list->data.array.size < list->data.array.capacity") : (void)0);
  ...
  FUNC_ATTR_ALWAYS_INLINE FUNC_ATTR_NONNULL_ALL
{
  ...
  (__builtin_expect(!(list->data.array.size == list->data.array.capacity), 0) ? __assert_rtn(__func__, "converter.c", 122, "list->data.array.size == list->data.array.capacity") : (void)0);
...
# 146 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/private/converter.c"
  ...
  FUNC_ATTR_ALWAYS_INLINE FUNC_ATTR_NONNULL_ALL
{
  ...
  (__builtin_expect(!(dict->type == kObjectTypeDictionary), 0) ? __assert_rtn(__func__, "converter.c", 151, "dict->type == kObjectTypeDictionary") : (void)0);
  (__builtin_expect(!(dict->data.dictionary.size < dict->data.dictionary.capacity), 0) ? __assert_rtn(__func__, "converter.c", 152, "dict->data.dictionary.size < dict->data.dictionary.capacity") : (void)0);
  ...
  FUNC_ATTR_ALWAYS_INLINE FUNC_ATTR_NONNULL_ALL
{
  ...
  Object *const dict = &((edata->stack).items[(((edata->stack).size) - (0) - 1)]);
  (__builtin_expect(!(dict->type == kObjectTypeDictionary), 0) ? __assert_rtn(__func__, "converter.c", 171, "dict->type == kObjectTypeDictionary") : (void)0);
  (__builtin_expect(!(dict->data.dictionary.size < dict->data.dictionary.capacity), 0) ? __assert_rtn(__func__, "converter.c", 172, "dict->data.dictionary.size < dict->data.dictionary.capacity") : (void)0);
  ...
  FUNC_ATTR_ALWAYS_INLINE FUNC_ATTR_NONNULL_ALL
{
  ...
  (__builtin_expect(!(dict->data.dictionary.size == dict->data.dictionary.capacity), 0) ? __assert_rtn(__func__, "converter.c", 185, "dict->data.dictionary.size == dict->data.dictionary.capacity") : (void)0);

}
# 199 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/private/converter.c"
                                           ...
                                           MPConvStackVal *const cur_mpsv, typval_T *const tv, const int copyID, const char *const objname)
{
  ...
  case VAR_PARTIAL: {
    ...
    (void)pt;
    do { ufunc_T *fp = find_func((pt == ((void*)0) ? ((void*)0) : (char_u *)partial_name(pt))); if (fp != ((void*)0) && (fp->uf_flags & 0x800)) { LuaRef ref = api_new_luaref(fp->uf_luaref); (*((((edata->stack).size == (edata->stack).capacity) ? (((edata->stack).capacity = (((edata->stack).capacity << 1) > ((sizeof((edata->stack).init_array)/sizeof(((edata->stack).init_array)[0])) / ((size_t)(!(sizeof((edata->stack).init_array) % sizeof(((edata->stack).init_array)[0]))))) ? ((edata->stack).capacity << 1) : ((sizeof((edata->stack).init_array)/sizeof(((edata->stack).init_array)[0])) / ((size_t)(!(sizeof((edata->stack).init_array) % sizeof(((edata->stack).init_array)[0])))))), (edata->stack).items = ((edata->stack).capacity == ((sizeof((edata->stack).init_array)/sizeof(((edata->stack).init_array)[0])) / ((size_t)(!(sizeof((edata->stack).init_array) % sizeof(((edata->stack).init_array)[0]))))) ? ((edata->stack).items == (edata->stack).init_array ? (edata->stack).items : _memcpy_free((edata->stack).init_array, (edata->stack).items, (edata->stack).size * sizeof((edata->stack).items[0]))) : ((edata->stack).items == (edata->stack).init_array ? __builtin___memcpy_chk (xmalloc((edata->stack).capacity * sizeof((edata->stack).items[0])), (edata->stack).items, (edata->stack).size * sizeof((edata->stack).items[0]), __builtin_object_size (xmalloc((edata->stack).capacity * sizeof((edata->stack).items[0])), 0)) : xrealloc((edata->stack).items, (edata->stack).capacity * sizeof((edata->stack).items[0]))))), 0) : 0), ((edata->stack).items + ((edata->stack).size++))) = (((Object) { .type = kObjectTypeLuaRef, .data.luaref = ref }))); } else { (*((((edata->stack).size == (edata->stack).capacity) ? (((edata->stack).capacity = (((edata->stack).capacity << 1) > ((sizeof((edata->stack).init_array)/sizeof(((edata->stack).init_array)[0])) / ((size_t)(!(sizeof((edata->stack).init_array) % sizeof(((edata->stack).init_array)[0]))))) ? ((edata->stack).capacity << 1) : ((sizeof((edata->stack).init_array)/sizeof(((edata->stack).init_array)[0])) / ((size_t)(!(sizeof((edata->stack).init_array) % sizeof(((edata->stack).init_array)[0])))))), (edata->stack).items = ((edata->stack).capacity == ((sizeof((edata->stack).init_array)/sizeof(((edata->stack).init_array)[0])) / ((size_t)(!(sizeof((edata->stack).init_array) % sizeof(((edata->stack).init_array)[0]))))) ? ((edata->stack).items == (edata->stack).init_array ? (edata->stack).items : _memcpy_free((edata->stack).init_array, (edata->stack).items, (edata->stack).size * sizeof((edata->stack).items[0]))) : ((edata->stack).items == (edata->stack).init_array ? __builtin___memcpy_chk (xmalloc((edata->stack).capacity * sizeof((edata->stack).items[0])), (edata->stack).items, (edata->stack).size * sizeof((edata->stack).items[0]), __builtin_object_size (xmalloc((edata->stack).capacity * sizeof((edata->stack).items[0])), 0)) : xrealloc((edata->stack).items, (edata->stack).capacity * sizeof((edata->stack).items[0]))))), 0) : 0), ((edata->stack).items + ((edata->stack).size++))) = (((Object){ .type = kObjectTypeNil }))); } goto typval_encode_stop_converting_one_item; } while (0);
  ...
  case VAR_DICT: {
    ...
    if (0
      ...
      case kMPBinary: {
        ...
        if (is_string) {
          do { const size_t len_ = (size_t)(len); const char *const str_ = (const char *)(buf); (__builtin_expect(!(len_ == 0 || str_ != ((void*)0)), 0) ? __assert_rtn(__func__, "typval_encode.c.h", 512, "len_ == 0 || str_ != NULL") : (void)0); (*((((edata->stack).size == (edata->stack).capacity) ? (((edata->stack).capacity = (((edata->stack).capacity << 1) > ((sizeof((edata->stack).init_array)/sizeof(((edata->stack).init_array)[0])) / ((size_t)(!(sizeof((edata->stack).init_array) % sizeof(((edata->stack).init_array)[0]))))) ? ((edata->stack).capacity << 1) : ((sizeof((edata->stack).init_array)/sizeof(((edata->stack).init_array)[0])) / ((size_t)(!(sizeof((edata->stack).init_array) % sizeof(((edata->stack).init_array)[0])))))), (edata->stack).items = ((edata->stack).capacity == ((sizeof((edata->stack).init_array)/sizeof(((edata->stack).init_array)[0])) / ((size_t)(!(sizeof((edata->stack).init_array) % sizeof(((edata->stack).init_array)[0]))))) ? ((edata->stack).items == (edata->stack).init_array ? (edata->stack).items : _memcpy_free((edata->stack).init_array, (edata->stack).items, (edata->stack).size * sizeof((edata->stack).items[0]))) : ((edata->stack).items == (edata->stack).init_array ? __builtin___memcpy_chk (xmalloc((edata->stack).capacity * sizeof((edata->stack).items[0])), (edata->stack).items, (edata->stack).size * sizeof((edata->stack).items[0]), __builtin_object_size (xmalloc((edata->stack).capacity * sizeof((edata->stack).items[0])), 0)) : xrealloc((edata->stack).items, (edata->stack).capacity * sizeof((edata->stack).items[0]))))), 0) : 0), ((edata->stack).items + ((edata->stack).size++))) = (((Object) { .type = kObjectTypeString, .data.string = cbuf_to_string((len_?str_:""), len_) }))); } while (0);
        } else {
          do { const size_t len_ = (size_t)(len); const char *const str_ = (const char *)(buf); (__builtin_expect(!(len_ == 0 || str_ != ((void*)0)), 0) ? __assert_rtn(__func__, "typval_encode.c.h", 514, "len_ == 0 || str_ != NULL") : (void)0); (*((((edata->stack).size == (edata->stack).capacity) ? (((edata->stack).capacity = (((edata->stack).capacity << 1) > ((sizeof((edata->stack).init_array)/sizeof(((edata->stack).init_array)[0])) / ((size_t)(!(sizeof((edata->stack).init_array) % sizeof(((edata->stack).init_array)[0]))))) ? ((edata->stack).capacity << 1) : ((sizeof((edata->stack).init_array)/sizeof(((edata->stack).init_array)[0])) / ((size_t)(!(sizeof((edata->stack).init_array) % sizeof(((edata->stack).init_array)[0])))))), (edata->stack).items = ((edata->stack).capacity == ((sizeof((edata->stack).init_array)/sizeof(((edata->stack).init_array)[0])) / ((size_t)(!(sizeof((edata->stack).init_array) % sizeof(((edata->stack).init_array)[0]))))) ? ((edata->stack).items == (edata->stack).init_array ? (edata->stack).items : _memcpy_free((edata->stack).init_array, (edata->stack).items, (edata->stack).size * sizeof((edata->stack).items[0]))) : ((edata->stack).items == (edata->stack).init_array ? __builtin___memcpy_chk (xmalloc((edata->stack).capacity * sizeof((edata->stack).items[0])), (edata->stack).items, (edata->stack).size * sizeof((edata->stack).items[0]), __builtin_object_size (xmalloc((edata->stack).capacity * sizeof((edata->stack).items[0])), 0)) : xrealloc((edata->stack).items, (edata->stack).capacity * sizeof((edata->stack).items[0]))))), 0) : 0), ((edata->stack).items + ((edata->stack).size++))) = (((Object) { .type = kObjectTypeString, .data.string = cbuf_to_string((len_?str_:""), len_) }))); } while (0);
        }
        xfree(buf);
        break;
      }
...
typval_encode_stop_converting_one_item:
  while (((mpstack).size)) {
    ...
    case kMPConvDict: {
      ...
      cur_mpsv->data.d.hi++;
      do { const size_t len_ = (size_t)(strlen((char *)&di->di_key[0])); const char *const str_ = (const char *)(&di->di_key[0]); (__builtin_expect(!(len_ == 0 || str_ != ((void*)0)), 0) ? __assert_rtn(__func__, "typval_encode.c.h", 692, "len_ == 0 || str_ != NULL") : (void)0); (*((((edata->stack).size == (edata->stack).capacity) ? (((edata->stack).capacity = (((edata->stack).capacity << 1) > ((sizeof((edata->stack).init_array)/sizeof(((edata->stack).init_array)[0])) / ((size_t)(!(sizeof((edata->stack).init_array) % sizeof(((edata->stack).init_array)[0]))))) ? ((edata->stack).capacity << 1) : ((sizeof((edata->stack).init_array)/sizeof(((edata->stack).init_array)[0])) / ((size_t)(!(sizeof((edata->stack).init_array) % sizeof(((edata->stack).init_array)[0])))))), (edata->stack).items = ((edata->stack).capacity == ((sizeof((edata->stack).init_array)/sizeof(((edata->stack).init_array)[0])) / ((size_t)(!(sizeof((edata->stack).init_array) % sizeof(((edata->stack).init_array)[0]))))) ? ((edata->stack).items == (edata->stack).init_array ? (edata->stack).items : _memcpy_free((edata->stack).init_array, (edata->stack).items, (edata->stack).size * sizeof((edata->stack).items[0]))) : ((edata->stack).items == (edata->stack).init_array ? __builtin___memcpy_chk (xmalloc((edata->stack).capacity * sizeof((edata->stack).items[0])), (edata->stack).items, (edata->stack).size * sizeof((edata->stack).items[0]), __builtin_object_size (xmalloc((edata->stack).capacity * sizeof((edata->stack).items[0])), 0)) : xrealloc((edata->stack).items, (edata->stack).capacity * sizeof((edata->stack).items[0]))))), 0) : 0), ((edata->stack).items + ((edata->stack).size++))) = (((Object) { .type = kObjectTypeString, .data.string = cbuf_to_string((len_?str_:""), len_) }))); } while (0);
...
# 200 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/private/converter.c" 2
# 238 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/private/converter.c"
Object vim_to_object(typval_T *obj)
{
  ...
  (void)evo_ret;
  (__builtin_expect(!(evo_ret == 1), 0) ? __assert_rtn(__func__, "converter.c", 245, "evo_ret == OK") : (void)0);
  Object ret = ((edata.stack).items[(0)]);
  (__builtin_expect(!(((edata.stack).size) == 1), 0) ? __assert_rtn(__func__, "converter.c", 247, "kv_size(edata.stack) == 1") : (void)0);
  do { if ((edata.stack).items != (edata.stack).init_array) { do { void **ptr_ = (void **)&((edata.stack).items); xfree(*ptr_); *ptr_ = ((void*)0); (void)(*ptr_); } while (0); } } while (0);
  return ret;
}
