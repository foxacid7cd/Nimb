# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/autocmd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/autocmd.c" 2
...
# 5 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/autocmd.c" 2
...
# 6 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/autocmd.c" 2
...
# 8 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/autocmd.c" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/autocmd.h" 1
...
# 7 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/autocmd.h" 2
# 9 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/autocmd.c" 2
...
# 11 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/autocmd.c" 2
...
# 14 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/autocmd.c" 2
...
# 16 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/autocmd.c" 2
# 36 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/autocmd.c"
static int64_t next_autocmd_id = 1;
# 80 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/autocmd.c"
Array nvim_get_autocmds(Dict(get_autocmds) *opts, Error *err)
  FUNC_API_SINCE(9)
{


  Array autocmd_list = { .size = 0, .capacity = 0, .items = ((void*)0) };
  char *pattern_filters[256];
  char pattern_buflocal[25];

  Array buffers = { .size = 0, .capacity = 0, .items = ((void*)0) };

  _Bool event_set[NUM_EVENTS] = { 0 };
  _Bool check_event = 0;
  ...
  if (opts->event.type != kObjectTypeNil) {
    ...
    if (v.type == kObjectTypeString) {
      ...
      event_set[event_nr] = 1;
    } else if (v.type == kObjectTypeArray) {
      for (size_t (event_v_index) = 0; (event_v_index) < (v.data.array).size; (event_v_index)++) { Object event_v = (v.data.array).items[event_v_index]; { if (event_v.type != kObjectTypeString) { api_set_error(err, kErrorTypeValidation, "Every event must be a string in 'event'"); goto cleanup; } char *__next_ev; event_T event_nr = event_name2nr(event_v.data.string.data, &__next_ev); if (event_nr >= NUM_EVENTS) { api_set_error(err, kErrorTypeValidation, "unexpected event"); goto cleanup; }; event_set[event_nr] = 1; }; }
# 138 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/autocmd.c"
    } else {
      api_set_error(err,
                    kErrorTypeValidation,
  ...
  if (opts->pattern.type != kObjectTypeNil) {
    ...
    if (v.type == kObjectTypeString) {
      ...
      for (size_t (item_index) = 0; (item_index) < (v.data.array).size; (item_index)++) { Object item = (v.data.array).items[item_index]; { if (item.type != kObjectTypeString) { api_set_error(err, kErrorTypeValidation, "Invalid value for 'pattern': must be a string"); goto cleanup; } pattern_filters[pattern_filter_count] = item.data.string.data; pattern_filter_count += 1; }; };
# 175 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/autocmd.c"
    } else {
      api_set_error(err, kErrorTypeValidation,
  ...
  if (opts->buffer.type == kObjectTypeInteger || opts->buffer.type == kObjectTypeBuffer) {
    ...
    __builtin___snprintf_chk ((char *)pattern_buflocal, 25, 0, __builtin_object_size ((char *)pattern_buflocal, 1 > 1 ? 1 : 0), "<buffer=%d>", (int)buf->handle);
    (*((((buffers).size == (buffers).capacity) ? (((buffers).capacity = ((buffers).capacity ? (buffers).capacity << 1 : 8), (buffers).items = xrealloc((buffers).items, sizeof((buffers).items[0]) * (buffers).capacity)), 0) : 0), ((buffers).items + ((buffers).size++))) = (((Object) { .type = kObjectTypeString, .data.string = cstr_to_string((char *)pattern_buflocal) })));
  } else if (opts->buffer.type == kObjectTypeArray) {
    if (opts->buffer.data.array.size > 256) {
      api_set_error(err,
                    kErrorTypeValidation,
                    "Too many buffers. Please limit yourself to %d or fewer", 256);
      goto cleanup;
    }

    for (size_t (bufnr_index) = 0; (bufnr_index) < (opts->buffer.data.array).size; (bufnr_index)++) { Object bufnr = (opts->buffer.data.array).items[bufnr_index]; { if (bufnr.type != kObjectTypeInteger && bufnr.type != kObjectTypeBuffer) { api_set_error(err, kErrorTypeValidation, "Invalid value for 'buffer': must be an integer"); goto cleanup; } buf_T *buf = find_buffer_by_handle((Buffer)bufnr.data.integer, err); if (((err)->type != kErrorTypeNone)) { goto cleanup; } __builtin___snprintf_chk ((char *)pattern_buflocal, 25, 0, __builtin_object_size ((char *)pattern_buflocal, 1 > 1 ? 1 : 0), "<buffer=%d>", (int)buf->handle); (*((((buffers).size == (buffers).capacity) ? (((buffers).capacity = ((buffers).capacity ? (buffers).capacity << 1 : 8), (buffers).items = xrealloc((buffers).items, sizeof((buffers).items[0]) * (buffers).capacity)), 0) : 0), ((buffers).items + ((buffers).size++))) = (((Object) { .type = kObjectTypeString, .data.string = cstr_to_string((char *)pattern_buflocal) }))); }; };
# 212 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/autocmd.c"
  ...
  for (event_T event = (event_T)0; (int)event < (int)NUM_EVENTS; event = (event_T)((int)event + 1)) {
    ...
    for (AutoPat *ap = au_get_autopat_for_event(event); ap != ((void*)0); ap = ap->next) {
      if (ap->cmds == ((void*)0)) {
        continue;
      }
      ...
      if (pattern_filter_count > 0) {
        ...
        for (int i = 0; i < pattern_filter_count; i++) {
          (__builtin_expect(!(i < 256), 0) ? __assert_rtn(__func__, "autocmd.c", 242, "i < AUCMD_MAX_PATTERNS") : (void)0);
          (__builtin_expect(!(pattern_filters[i]), 0) ? __assert_rtn(__func__, "autocmd.c", 243, "pattern_filters[i]") : (void)0);
      ...
      for (AutoCmd *ac = ap->cmds; ac != ((void*)0); ac = ac->next) {
        ...
        Dictionary autocmd_info = { .size = 0, .capacity = 0, .items = ((void*)0) };
        ...
        if (ap->buflocal_nr) {
          (*((((autocmd_info).size == (autocmd_info).capacity) ? (((autocmd_info).capacity = ((autocmd_info).capacity ? (autocmd_info).capacity << 1 : 8), (autocmd_info).items = xrealloc((autocmd_info).items, sizeof((autocmd_info).items[0]) * (autocmd_info).capacity)), 0) : 0), ((autocmd_info).items + ((autocmd_info).size++))) = (((KeyValuePair) { .key = cstr_to_string("buflocal"), .value = ((Object) { .type = kObjectTypeBoolean, .data.boolean = 1 }) })));
          ...
          (*((((autocmd_info).size == (autocmd_info).capacity) ? (((autocmd_info).capacity = ((autocmd_info).capacity ? (autocmd_info).capacity << 1 : 8), (autocmd_info).items = xrealloc((autocmd_info).items, sizeof((autocmd_info).items[0]) * (autocmd_info).capacity)), 0) : 0), ((autocmd_info).items + ((autocmd_info).size++))) = (((KeyValuePair) { .key = cstr_to_string("buflocal"), .value = ((Object) { .type = kObjectTypeBoolean, .data.boolean = 0 }) })));
        }
# 345 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/autocmd.c"
...
# 449 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/autocmd.c"
  ...
  FUNC_API_SINCE(9)
{
  ...
  Array patterns = { .size = 0, .capacity = 0, .items = ((void*)0) };
  Array event_array = { .size = 0, .capacity = 0, .items = ((void*)0) };

  AucmdExecutable aucmd = { .type = CALLABLE_NONE };
  Callback cb = ((Callback){ .type = kCallbackNone });

  if (!unpack_string_or_array(&event_array, &event, "event", 1, err)) {
    goto cleanup;
  }
  ...
  _Bool is_once = api_object_to_bool(opts->once, "once", 0, err);
  _Bool is_nested = api_object_to_bool(opts->nested, "nested", 0, err);
...
# 629 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/autocmd.c"
  ...
  FUNC_API_SINCE(9)
{
  ...
  if (!unpack_string_or_array(&event_array, &opts->event, "event", 0, err)) {
    goto cleanup;
  }
  ...
  if (event_array.size == 0) {
    for (event_T event = (event_T)0; (int)event < (int)NUM_EVENTS; event = (event_T)((int)event + 1)) {
      for (size_t (pat_object_index) = 0; (pat_object_index) < (patterns).size; (pat_object_index)++) { Object pat_object = (patterns).items[pat_object_index]; { char *pat = pat_object.data.string.data; if (!clear_autocmd(event, (char *)pat, au_group, err)) { goto cleanup; } }; };
...
# 687 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/autocmd.c"
  }
...
# 709 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/autocmd.c"
Integer nvim_create_augroup(uint64_t channel_id, String name, Dict(create_augroup) *opts,
                            Error *err)
  FUNC_API_SINCE(9)
{
  char *augroup_name = name.data;
  _Bool clear_autocmds = api_object_to_bool(opts->clear, "clear", 1, err);

  int augroup = -1;
  do { const sctx_T save_current_sctx = current_sctx; current_sctx.sc_sid = (channel_id) == ((((uint64_t)1) << (sizeof(uint64_t) * 8 - 1)) + 1) ? (-8) : (-9); current_sctx.sc_lnum = 0; current_channel_id = channel_id; { augroup = augroup_add(augroup_name); if (augroup == (-2)) { api_set_error(err, kErrorTypeException, "Failed to set augroup"); return -1; } if (clear_autocmds) { for (event_T event = (event_T)0; (int)event < (int)NUM_EVENTS; event = (event_T)((int)event + 1)) { aupat_del_for_event_and_group(event, augroup); } } }; current_sctx = save_current_sctx; } while (0);;
# 731 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/autocmd.c"
  return augroup;
}
# 743 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/autocmd.c"
void nvim_del_augroup_by_id(Integer id, Error *err)
  FUNC_API_SINCE(9)
{
  do { msglist_T **saved_msg_list = msg_list; msglist_T *private_msg_list; msg_list = &private_msg_list; private_msg_list = ((void*)0); { try_start(); char *name = augroup_name((int)id); augroup_del(name, 0); try_end(err); } msg_list = saved_msg_list; } while (0);
...
void nvim_del_augroup_by_name(String name, Error *err)
  FUNC_API_SINCE(9)
{
  do { msglist_T **saved_msg_list = msg_list; msglist_T *private_msg_list; msg_list = &private_msg_list; private_msg_list = ((void*)0); { try_start(); augroup_del(name.data, 0); try_end(err); } msg_list = saved_msg_list; } while (0);




}
# 785 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/autocmd.c"
...
static _Bool check_autocmd_string_array(Array arr, char *k, Error *err)
{
  for (size_t (entry_index) = 0; (entry_index) < (arr).size; (entry_index)++) { Object entry = (arr).items[entry_index]; { if (entry.type != kObjectTypeString) { api_set_error(err, kErrorTypeValidation, "All entries in '%s' must be strings", k); return 0; } const String l = entry.data.string; if (memchr(l.data, '\012', l.size)) { api_set_error(err, kErrorTypeValidation, "String cannot contain newlines"); return 0; } }; }
# 894 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/autocmd.c"
  return 1;
}
...
{
  if (v->type == kObjectTypeString) {
    (*((((*array).size == (*array).capacity) ? (((*array).capacity = ((*array).capacity ? (*array).capacity << 1 : 8), (*array).items = xrealloc((*array).items, sizeof((*array).items[0]) * (*array).capacity)), 0) : 0), ((*array).items + ((*array).size++))) = (copy_object(*v, ((void*)0))));
  } else if (v->type == kObjectTypeArray) {
    if (!check_autocmd_string_array(v->data.array, k, err)) {
      return 0;
    }
    *array = copy_array(v->data.array, ((void*)0));
  } else {
    if (required) {
      api_set_error(err,
                    kErrorTypeValidation,
...
static _Bool get_patterns_from_pattern_or_buf(Array *patterns, Object pattern, Object buffer,
                                             Error *err)
{
  ...
  if (pattern.type != kObjectTypeNil && buffer.type != kObjectTypeNil) {
    ...
    if (v->type == kObjectTypeString) {
      ...
      while (patlen) {
        (*((((*patterns).size == (*patterns).capacity) ? (((*patterns).capacity = ((*patterns).capacity ? (*patterns).capacity << 1 : 8), (*patterns).items = xrealloc((*patterns).items, sizeof((*patterns).items[0]) * (*patterns).capacity)), 0) : 0), ((*patterns).items + ((*patterns).size++))) = (((Object) { .type = kObjectTypeString, .data.string = cbuf_to_string((char *)pat, patlen) })));
...
# 990 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/autocmd.c"
    ...
    __builtin___snprintf_chk ((char *)pattern_buflocal, 25, 0, __builtin_object_size ((char *)pattern_buflocal, 1 > 1 ? 1 : 0), "<buffer=%d>", (int)buf->handle);
    (*((((*patterns).size == (*patterns).capacity) ? (((*patterns).capacity = ((*patterns).capacity ? (*patterns).capacity << 1 : 8), (*patterns).items = xrealloc((*patterns).items, sizeof((*patterns).items[0]) * (*patterns).capacity)), 0) : 0), ((*patterns).items + ((*patterns).size++))) = (((Object) { .type = kObjectTypeString, .data.string = cstr_to_string((char *)pattern_buflocal) })));
  }
...
{
  if (do_autocmd_event(event, pat, 0, 0, "", 1, au_group) == 0) {
