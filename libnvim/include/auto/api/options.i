# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/options.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/options.c" 2
...
# 5 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/options.c" 2
...
# 6 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/options.c" 2
...
# 7 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/options.c" 2
...
# 8 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/options.c" 2
...
# 9 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/options.c" 2
...
# 10 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/options.c" 2
...
# 5 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/options.h" 2
# 12 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/options.c" 2
...
# 13 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/options.c" 2
...
# 14 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/options.c" 2
...
# 16 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/options.c" 2
...
# 17 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/options.c" 2
...
# 19 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/options.c" 2
                                      ...
                                      Error *err)
{
  ...
  } else if (((opts->scope).type != kObjectTypeNil)) {
  ...
  *opt_type = 0;
  ...
  } else if (((opts->win).type != kObjectTypeNil)) {
  ...
  } else if (((opts->buf).type != kObjectTypeNil)) {
    api_set_error(err, kErrorTypeValidation, "invalid value for key: buf");
    return 0;
  }

  if (((opts->scope).type != kObjectTypeNil) && ((opts->buf).type != kObjectTypeNil)) {
    api_set_error(err, kErrorTypeValidation, "scope and buf cannot be used together");
    return 0;
  }

  if (((opts->win).type != kObjectTypeNil) && ((opts->buf).type != kObjectTypeNil)) {
...
# 93 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/options.c"
...
# 155 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/options.c"
  ...
  FUNC_API_SINCE(9)
{
  ...
  if (opt_type == 1 && scope == 0) {
    int flags = get_option_value_strict(name.data, ((void*)0), ((void*)0), opt_type, to);
    if (flags & 0x08) {
      scope = OPT_LOCAL;
    }
  }
  ...
  access_option_value_for(name.data, &numval, &stringval, scope, opt_type, to, 0, err);
}
...
# 237 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/options.c"
...
# 291 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/options.c"
...
# 329 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/options.c"
...
# 349 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/options.c"
...
# 403 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/options.c"
void set_option_to(uint64_t channel_id, void *to, int type, String name, Object value, Error *err)
{
  ...
  do { const sctx_T save_current_sctx = current_sctx; current_sctx.sc_sid = (channel_id) == ((((uint64_t)1) << (sizeof(uint64_t) * 8 - 1)) + 1) ? (-8) : (-9); current_sctx.sc_lnum = 0; current_channel_id = channel_id; { access_option_value_for(name.data, &numval, &stringval, opt_flags, type, to, 0, err); }; current_sctx = save_current_sctx; } while (0);;
...
{
  if (get) {
    return get_option_value(key, numval, stringval, ((void*)0), opt_flags);
  } else {
    char *errmsg;
...
static getoption_T access_option_value_for(char *key, long *numval, char **stringval, int opt_flags,
                                           int opt_type, void *from, _Bool get, Error *err)
{
  _Bool need_switch = 0;
  ...
  case 1:
    ...
    if (need_switch) {
      if (switch_win_noblock(&switchwin, (win_T *)from, win_find_tabpage((win_T *)from), 1)
          == 0) {
