# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/helpers.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/helpers.c" 2
...
# 5 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/helpers.c" 2
...
# 6 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/helpers.c" 2
...
# 9 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/helpers.c" 2
...
# 5 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/private/dispatch.h" 2
...
# 10 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/helpers.c" 2
...
# 11 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/helpers.c" 2
...
# 15 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/helpers.c" 2
...
{
  _Bool ret = 1;
  struct { size_t size; size_t capacity; MPToAPIObjectStackItem *items; MPToAPIObjectStackItem init_array[2]; } stack = { .size = 0, .capacity = 0, .items = ((void*)0) };
...
# 102 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/helpers.c"
    ...
    case MSGPACK_OBJECT_ARRAY: {
      ...
      if (cur.container) {
        if (cur.idx >= size) {
          ...
          (*((((stack).size == (stack).capacity) ? (((stack).capacity = (((stack).capacity << 1) > ((sizeof((stack).init_array)/sizeof(((stack).init_array)[0])) / ((size_t)(!(sizeof((stack).init_array) % sizeof(((stack).init_array)[0]))))) ? ((stack).capacity << 1) : ((sizeof((stack).init_array)/sizeof(((stack).init_array)[0])) / ((size_t)(!(sizeof((stack).init_array) % sizeof(((stack).init_array)[0])))))), (stack).items = ((stack).capacity == ((sizeof((stack).init_array)/sizeof(((stack).init_array)[0])) / ((size_t)(!(sizeof((stack).init_array) % sizeof(((stack).init_array)[0]))))) ? ((stack).items == (stack).init_array ? (stack).items : _memcpy_free((stack).init_array, (stack).items, (stack).size * sizeof((stack).items[0]))) : ((stack).items == (stack).init_array ? __builtin___memcpy_chk (xmalloc((stack).capacity * sizeof((stack).items[0])), (stack).items, (stack).size * sizeof((stack).items[0]), __builtin_object_size (xmalloc((stack).capacity * sizeof((stack).items[0])), 0)) : xrealloc((stack).items, (stack).capacity * sizeof((stack).items[0]))))), 0) : 0), ((stack).items + ((stack).size++))) = (((MPToAPIObjectStackItem) { .mobj = &cur.mobj->via.array.ptr[idx], .aobj = &cur.aobj->data.array.items[idx], .container = 0, })));
    ...
    case MSGPACK_OBJECT_MAP: {
      ...
      if (cur.container) {
        if (cur.idx >= size) {
          ...
          if (ret) {
            (*((((stack).size == (stack).capacity) ? (((stack).capacity = (((stack).capacity << 1) > ((sizeof((stack).init_array)/sizeof(((stack).init_array)[0])) / ((size_t)(!(sizeof((stack).init_array) % sizeof(((stack).init_array)[0]))))) ? ((stack).capacity << 1) : ((sizeof((stack).init_array)/sizeof(((stack).init_array)[0])) / ((size_t)(!(sizeof((stack).init_array) % sizeof(((stack).init_array)[0])))))), (stack).items = ((stack).capacity == ((sizeof((stack).init_array)/sizeof(((stack).init_array)[0])) / ((size_t)(!(sizeof((stack).init_array) % sizeof(((stack).init_array)[0]))))) ? ((stack).items == (stack).init_array ? (stack).items : _memcpy_free((stack).init_array, (stack).items, (stack).size * sizeof((stack).items[0]))) : ((stack).items == (stack).init_array ? __builtin___memcpy_chk (xmalloc((stack).capacity * sizeof((stack).items[0])), (stack).items, (stack).size * sizeof((stack).items[0]), __builtin_object_size (xmalloc((stack).capacity * sizeof((stack).items[0])), 0)) : xrealloc((stack).items, (stack).capacity * sizeof((stack).items[0]))))), 0) : 0), ((stack).items + ((stack).size++))) = (((MPToAPIObjectStackItem) { .mobj = &cur.mobj->via.map.ptr[idx].val, .aobj = &cur.aobj->data.dictionary.items[idx].value, .container = 0, })));
...
static _Bool msgpack_rpc_to_string(const msgpack_object *const obj, String *const arg)
  FUNC_ATTR_NONNULL_ALL
{
...
_Bool msgpack_rpc_to_dictionary(const msgpack_object *const obj, Dictionary *const arg)
  FUNC_ATTR_NONNULL_ALL
{
...
void msgpack_rpc_from_object(const Object result, msgpack_packer *const res)
  FUNC_ATTR_NONNULL_ARG(2)
{
  struct { size_t size; size_t capacity; APIToMPObjectStackItem *items; APIToMPObjectStackItem init_array[2]; } stack = { .size = 0, .capacity = 0, .items = ((void*)0) };
  ((stack).capacity = ((sizeof((stack).init_array)/sizeof(((stack).init_array)[0])) / ((size_t)(!(sizeof((stack).init_array) % sizeof(((stack).init_array)[0]))))), (stack).size = 0, (stack).items = (stack).init_array);
  (*((((stack).size == (stack).capacity) ? (((stack).capacity = (((stack).capacity << 1) > ((sizeof((stack).init_array)/sizeof(((stack).init_array)[0])) / ((size_t)(!(sizeof((stack).init_array) % sizeof(((stack).init_array)[0]))))) ? ((stack).capacity << 1) : ((sizeof((stack).init_array)/sizeof(((stack).init_array)[0])) / ((size_t)(!(sizeof((stack).init_array) % sizeof(((stack).init_array)[0])))))), (stack).items = ((stack).capacity == ((sizeof((stack).init_array)/sizeof(((stack).init_array)[0])) / ((size_t)(!(sizeof((stack).init_array) % sizeof(((stack).init_array)[0]))))) ? ((stack).items == (stack).init_array ? (stack).items : _memcpy_free((stack).init_array, (stack).items, (stack).size * sizeof((stack).items[0]))) : ((stack).items == (stack).init_array ? __builtin___memcpy_chk (xmalloc((stack).capacity * sizeof((stack).items[0])), (stack).items, (stack).size * sizeof((stack).items[0]), __builtin_object_size (xmalloc((stack).capacity * sizeof((stack).items[0])), 0)) : xrealloc((stack).items, (stack).capacity * sizeof((stack).items[0]))))), 0) : 0), ((stack).items + ((stack).size++))) = (((APIToMPObjectStackItem) { &result, 0, 0 })));
  while (((stack).size)) {
    ...
    case kObjectTypeArray: {
      ...
      if (cur.container) {
        if (cur.idx >= size) {
          ...
          cur.idx++;
          ((stack).items[(((stack).size) - (0) - 1)]) = cur;
          (*((((stack).size == (stack).capacity) ? (((stack).capacity = (((stack).capacity << 1) > ((sizeof((stack).init_array)/sizeof(((stack).init_array)[0])) / ((size_t)(!(sizeof((stack).init_array) % sizeof(((stack).init_array)[0]))))) ? ((stack).capacity << 1) : ((sizeof((stack).init_array)/sizeof(((stack).init_array)[0])) / ((size_t)(!(sizeof((stack).init_array) % sizeof(((stack).init_array)[0])))))), (stack).items = ((stack).capacity == ((sizeof((stack).init_array)/sizeof(((stack).init_array)[0])) / ((size_t)(!(sizeof((stack).init_array) % sizeof(((stack).init_array)[0]))))) ? ((stack).items == (stack).init_array ? (stack).items : _memcpy_free((stack).init_array, (stack).items, (stack).size * sizeof((stack).items[0]))) : ((stack).items == (stack).init_array ? __builtin___memcpy_chk (xmalloc((stack).capacity * sizeof((stack).items[0])), (stack).items, (stack).size * sizeof((stack).items[0]), __builtin_object_size (xmalloc((stack).capacity * sizeof((stack).items[0])), 0)) : xrealloc((stack).items, (stack).capacity * sizeof((stack).items[0]))))), 0) : 0), ((stack).items + ((stack).size++))) = (((APIToMPObjectStackItem) { .aobj = &cur.aobj->data.array.items[idx], .container = 0, })));
      ...
      if (cur.container) {
        if (cur.idx >= size) {
          ...
          msgpack_rpc_from_string(cur.aobj->data.dictionary.items[idx].key,
                                  res);
          (*((((stack).size == (stack).capacity) ? (((stack).capacity = (((stack).capacity << 1) > ((sizeof((stack).init_array)/sizeof(((stack).init_array)[0])) / ((size_t)(!(sizeof((stack).init_array) % sizeof(((stack).init_array)[0]))))) ? ((stack).capacity << 1) : ((sizeof((stack).init_array)/sizeof(((stack).init_array)[0])) / ((size_t)(!(sizeof((stack).init_array) % sizeof(((stack).init_array)[0])))))), (stack).items = ((stack).capacity == ((sizeof((stack).init_array)/sizeof(((stack).init_array)[0])) / ((size_t)(!(sizeof((stack).init_array) % sizeof(((stack).init_array)[0]))))) ? ((stack).items == (stack).init_array ? (stack).items : _memcpy_free((stack).init_array, (stack).items, (stack).size * sizeof((stack).items[0]))) : ((stack).items == (stack).init_array ? __builtin___memcpy_chk (xmalloc((stack).capacity * sizeof((stack).items[0])), (stack).items, (stack).size * sizeof((stack).items[0]), __builtin_object_size (xmalloc((stack).capacity * sizeof((stack).items[0])), 0)) : xrealloc((stack).items, (stack).capacity * sizeof((stack).items[0]))))), 0) : 0), ((stack).items + ((stack).size++))) = (((APIToMPObjectStackItem) { .aobj = &cur.aobj->data.dictionary.items[idx].value, .container = 0, })));
