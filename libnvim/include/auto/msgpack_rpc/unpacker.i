# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/unpacker.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/unpacker.c" 2
...
# 5 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/unpacker.c" 2
...
# 8 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/unpacker.c" 2
...
# 11 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/unpacker.h" 2
...
# 11 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/channel_defs.h" 2
...
# 12 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/channel_defs.h" 2
...
# 14 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/unpacker.h" 2
...
# 9 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/unpacker.c" 2
...
static void api_parse_enter(mpack_parser_t *parser, mpack_node_t *node)
{
  ...
  Object *result = ((void*)0);
  String *key_location = ((void*)0);

  mpack_node_t *parent = (((node) - 1)->pos == (size_t)-1 ? ((void*)0) : (node) - 1);
  if (parent) {
    ...
    case MPACK_TOKEN_MAP: {
      ...
      if (!parent->key_visited) {
        ...
        kv->key = (String){ .data = ((void*)0), .size = 0 };
        key_location = &kv->key;
      }
      result = &kv->value;
      break;
    ...
    case MPACK_TOKEN_EXT:
      (__builtin_expect(!(node->tok.type == MPACK_TOKEN_CHUNK), 0) ? __assert_rtn(__func__, "unpacker.c", 67, "node->tok.type == MPACK_TOKEN_CHUNK") : (void)0);
      break;
  ...
  case MPACK_TOKEN_BIN:
  case MPACK_TOKEN_STR: {
    char *mem = arena_alloc(&p->arena, node->tok.length + 1, 0);
  ...
  case MPACK_TOKEN_CHUNK:
    (__builtin_expect(!(parent), 0) ? __assert_rtn(__func__, "unpacker.c", 112, "parent") : (void)0);
    if (parent->tok.type == MPACK_TOKEN_STR || parent->tok.type == MPACK_TOKEN_BIN) {
      char *data = parent->data[0].p;
      __builtin___memcpy_chk (data + parent->pos, node->tok.data.chunk_ptr, node->tok.length, __builtin_object_size (data + parent->pos, 0));
      ...
      __builtin___memcpy_chk (p->ext_buf + parent->pos, node->tok.data.chunk_ptr, node->tok.length, __builtin_object_size (p->ext_buf + parent->pos, 0));
  ...
  case MPACK_TOKEN_ARRAY: {
    ...
    ((arr).capacity = (node->tok.length), (arr).items = (void *)arena_alloc(&p->arena, sizeof((arr).items[0]) * (arr).capacity, 1));
  ...
  case MPACK_TOKEN_MAP: {
    ...
    ((dict).capacity = (node->tok.length), (dict).items = (void *)arena_alloc(&p->arena, sizeof((dict).items[0]) * (dict).capacity, 1));
...
void unpacker_init(Unpacker *p)
{
  ...
  p->unpack_error = (Error){ .type = kErrorTypeNone, .msg = ((void*)0) };
...
_Bool unpacker_parse_header(Unpacker *p)
{
  mpack_token_t tok;
  int result;
  ...
  (__builtin_expect(!(!((&p->unpack_error)->type != kErrorTypeNone)), 0) ? __assert_rtn(__func__, "unpacker.c", 199, "!ERROR_SET(&p->unpack_error)") : (void)0);
  ...
  if (p->type != kMessageTypeResponse) {
    ...
    if (p->method_name_len > 0) {
      result = mpack_read(&p->reader, &data, &size, &tok); if (result) { goto error; };
      (__builtin_expect(!(tok.type == MPACK_TOKEN_CHUNK), 0) ? __assert_rtn(__func__, "unpacker.c", 240, "tok.type == MPACK_TOKEN_CHUNK") : (void)0);
    }
...
# 297 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/unpacker.c"
_Bool unpacker_advance(Unpacker *p)
{
  (__builtin_expect(!(p->state >= 0), 0) ? __assert_rtn(__func__, "unpacker.c", 299, "p->state >= 0") : (void)0);
  if (p->state == 0) {
...
_Bool unpacker_parse_redraw(Unpacker *p)
{
  mpack_token_t tok;
  int result;
...
# 386 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/unpacker.c"
redo:
  switch (p->state) {
  case 10:
    result = mpack_rtoken(&data, &size, &tok); if (result == MPACK_EOF) { return 0; } else if (result || (tok.type != MPACK_TOKEN_ARRAY && !(MPACK_TOKEN_ARRAY == MPACK_TOKEN_STR && tok.type == MPACK_TOKEN_BIN) && !(MPACK_TOKEN_ARRAY == MPACK_TOKEN_SINT && tok.type == MPACK_TOKEN_UINT))) { p->state = -1; return 0; };
  ...
  case 11:
    ...
    result = mpack_rtoken(&data, &size, &tok); if (result == MPACK_EOF) { return 0; } else if (result || (tok.type != MPACK_TOKEN_STR && !(MPACK_TOKEN_STR == MPACK_TOKEN_STR && tok.type == MPACK_TOKEN_BIN) && !(MPACK_TOKEN_STR == MPACK_TOKEN_SINT && tok.type == MPACK_TOKEN_UINT))) { p->state = -1; return 0; };
    if (tok.length > size) {
      return 0;
    }

    p->ui_handler = ui_client_get_redraw_handler(data, tok.length, ((void*)0));
    data += tok.length;
    size -= tok.length;
    ...
    if (p->ui_handler.fn != ui_client_event_grid_line) {
      ...
      if (p->grid_line_event) {
        arena_mem_free(arena_finish(&p->arena));
        p->grid_line_event = ((void*)0);
      }
      return 1;
    } else {
      p->state = 13;
      p->arena = (Arena){ .cur_blk = ((void*)0), .pos = 0, .size = 0 };
      p->grid_line_event = arena_alloc(&p->arena, sizeof *p->grid_line_event, 1);
      g = p->grid_line_event;
    }
    {} __attribute__((fallthrough));
  ...
  case 13:
    ...
    for (int i = 0; i < 3; i++) {
      result = mpack_rtoken(&data, &size, &tok); if (result == MPACK_EOF) { return 0; } else if (result || (tok.type != MPACK_TOKEN_UINT && !(MPACK_TOKEN_UINT == MPACK_TOKEN_STR && tok.type == MPACK_TOKEN_BIN) && !(MPACK_TOKEN_UINT == MPACK_TOKEN_SINT && tok.type == MPACK_TOKEN_UINT))) { p->state = -1; return 0; };
  ...
  case 14:
    (__builtin_expect(!(g->icell < g->ncells), 0) ? __assert_rtn(__func__, "unpacker.c", 454, "g->icell < g->ncells") : (void)0);
    ...
    if (cellarrsize >= 2) {
      result = mpack_rtoken(&data, &size, &tok); if (result == MPACK_EOF) { return 0; } else if (result || (tok.type != MPACK_TOKEN_SINT && !(MPACK_TOKEN_SINT == MPACK_TOKEN_STR && tok.type == MPACK_TOKEN_BIN) && !(MPACK_TOKEN_SINT == MPACK_TOKEN_SINT && tok.type == MPACK_TOKEN_UINT))) { p->state = -1; return 0; };
    ...
    if (g->icell == g->ncells - 1 && cellsize == 1 && cellbuf[0] == ' ' && repeat > 1) {
      ...
      for (int r = 0; r < repeat; r++) {
        ...
        __builtin___memcpy_chk (grid_line_buf_char[g->coloff], cellbuf, cellsize, __builtin_object_size (grid_line_buf_char[g->coloff], 0));
