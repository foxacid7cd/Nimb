# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/server.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/server.c" 2
...
# 5 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/server.c" 2
...
# 6 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/server.c" 2
...
# 7 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/server.c" 2
...
# 8 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/server.c" 2
...
# 10 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/server.c" 2
...
# 11 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/server.c" 2
...
# 13 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/server.c" 2
...
# 18 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/server.c" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/server.h" 1
# 19 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/server.c" 2
...
_Bool server_init(const char *listen_addr)
{
  ...
  if (0 != rv) {
    listen_addr = server_address_new(((void*)0));
    if (!listen_addr) {
      return 0;
    }
  ...
  if (os_env_exists("__NVIM_TEST_LOG")) {
    logmsg(4, ((void*)0), __func__, 60, 1, "test log message");
  }
...
char *server_address_new(const char *name)
{
  ...
  int r = __builtin___snprintf_chk (fmt, sizeof(fmt), 0, __builtin_object_size (fmt, 1 > 1 ? 1 : 0), "%s/%s.%" "ll" "u" ".%" "u", dir, name ? name : "nvim", os_get_pid(), count++);

  xfree(dir);

  if ((size_t)r >= sizeof(fmt)) {
    logmsg(4, ((void*)0), __func__, 107, 1, "truncated server address");
  }
  return xstrdup(fmt);
}
...
# 135 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/msgpack_rpc/server.c"
int server_start(const char *addr)
{
  if (addr == ((void*)0) || addr[0] == '\0') {
    logmsg(3, ((void*)0), __func__, 138, 1, "Empty or NULL address");
    return 1;
  }

  _Bool isname = !strstr(addr, ":") && !strstr(addr, "/") && !strstr(addr, "\\");
  char *addr_gen = isname ? server_address_new(addr) : ((void*)0);
  ...
  for (int i = 0; i < watchers.ga_len; i++) {
    if (!strcmp(watcher->addr, ((SocketWatcher **)watchers.ga_data)[i]->addr)) {
      logmsg(4, ((void*)0), __func__, 155, 1, "Already listening on %s", watcher->addr);
  ...
  if (result < 0) {
    logmsg(3, ((void*)0), __func__, 166, 1, "Failed to start server: %s: %s", uv_strerror(result), watcher->addr);
    socket_watcher_close(watcher, free_server);
    return result;
  }
...
_Bool server_stop(char *endpoint)
{
  ...
  if (!watcher_found) {
    logmsg(3, ((void*)0), __func__, 205, 1, "Not listening on %s", addr);
    return 0;
  }
