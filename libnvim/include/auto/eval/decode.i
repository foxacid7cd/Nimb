# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/decode.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/decode.c" 2
...
# 63 "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.0.sdk/usr/include/stdlib.h" 2 3 4
...
# 5 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/decode.c" 2
# 1 "/Applications/Xcode-14.1.0.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/14.0.0/include/stddef.h" 1 3
# 6 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/decode.c" 2
...
# 8 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/decode.c" 2
...
# 9 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/decode.c" 2
...
# 10 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/decode.c" 2
...
# 11 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/decode.c" 2
...
# 12 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/decode.c" 2
...
# 13 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/decode.c" 2
...
# 54 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/decode.c"
...
# 98 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/decode.c"
static inline int json_decoder_pop(ValuesStackItem obj, ValuesStack *const stack,
                                   ...
                                   _Bool *const next_map_special, _Bool *const didcomma,
  ...
  FUNC_ATTR_NONNULL_ALL
{
  ...
  if (last_container.container.v_type == VAR_LIST) {
    if (tv_list_len(last_container.container.vval.v_list) != 0
        && !obj.didcomma) {
      semsg(libintl_gettext((char *)("E474: Expected comma before list item: %s")), val_location);
      tv_clear(&obj.val);
      return 0;
    }
    (__builtin_expect(!(last_container.special_val == ((void*)0)), 0) ? __assert_rtn(__func__, "decode.c", 125, "last_container.special_val == NULL") : (void)0);
    tv_list_append_owned_tv(last_container.container.vval.v_list, obj.val);
  } else if (last_container.stack_index == ((*stack).size) - 2) {
    if (!obj.didcolon) {
      semsg(libintl_gettext((char *)("E474: Expected colon before dictionary value: %s")),
            val_location);
      tv_clear(&obj.val);
      return 0;
    }
    ...
    if (last_container.special_val == ((void*)0)) {
      ...
      (__builtin_expect(!(!(key.is_special_string || key.val.vval.v_string == ((void*)0) || *key.val.vval.v_string == '\000')), 0) ? __assert_rtn(__func__, "decode.c", 139, "!(key.is_special_string || key.val.vval.v_string == NULL || *key.val.vval.v_string == NUL)") : (void)0);
    ...
    if (!obj.is_special_string && obj.val.v_type != VAR_STRING) {
      semsg(libintl_gettext((char *)("E474: Expected string key: %s")), *pp);
      tv_clear(&obj.val);
      return 0;
    } else if (!obj.didcomma
               && (last_container.special_val == ((void*)0)
                   && ((last_container.container.vval.v_dict)->dv_hashtab.ht_used != 0))) {
      semsg(libintl_gettext((char *)("E474: Expected comma before dictionary key: %s")), val_location);
      tv_clear(&obj.val);
      return 0;
    }
...
# 226 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/decode.c"
...
# 256 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/decode.c"
typval_T decode_string(const char *const s, const size_t len, const TriState hasnul,
                       const _Bool binary, const _Bool s_allocated)
  FUNC_ATTR_WARN_UNUSED_RESULT
{
  (__builtin_expect(!(s != ((void*)0) || len == 0), 0) ? __assert_rtn(__func__, "decode.c", 260, "s != NULL || len == 0") : (void)0);
  ...
  if (really_hasnul) {
    ...
    return (typval_T) {
      .v_type = VAR_STRING,
      .v_lock = VAR_UNLOCKED,
      .vval = { .v_string = ((s == ((void*)0) || s_allocated) ? (char *)s : xmemdupz(s, len)) },
    };
  }
}
# 314 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/decode.c"
  ...
  FUNC_ATTR_NONNULL_ALL FUNC_ATTR_WARN_UNUSED_RESULT FUNC_ATTR_ALWAYS_INLINE
{
  ...
  while (p < e && *p != '"') {
    if (*p == '\\') {
      p++;
      if (p == e) {
        semsg(libintl_gettext((char *)("E474: Unfinished escape sequence: %.*s")),
              (int)buf_len, buf);
      ...
      case 'u':
        if (p + 4 >= e) {
          semsg(libintl_gettext((char *)("E474: Unfinished unicode escape sequence: %.*s")),
                (int)buf_len, buf);
          goto parse_json_string_fail;
                   ...
                   || !ascii_isxdigit(p[3])
                   || !ascii_isxdigit(p[4])) {
          semsg(libintl_gettext((char *)("E474: Expected four hex digits after \\u: %.*s")),
                ((int)((e) - (p - 1))), (p - 1));
          goto parse_json_string_fail;
        }
      ...
      case 'f':
        ...
        break;
      default:
        semsg(libintl_gettext((char *)("E474: Unknown escape sequence: %.*s")), ((int)((e) - (p - 1))), (p - 1));
        goto parse_json_string_fail;
      }
    } else {
      ...
      if (p_byte < 0x20) {
        semsg(libintl_gettext((char *)("E474: ASCII control characters cannot be present " "inside string: %.*s")), ((int)((e) - (p))), (p));
      ...
      if (ch >= 0x80 && p_byte == ch
        ...
        semsg(libintl_gettext((char *)("E474: Only UTF-8 strings allowed: %.*s")), ((int)((e) - (p))), (p));
        goto parse_json_string_fail;
      } else if (ch > 0x10FFFF) {
        semsg(libintl_gettext((char *)("E474: Only UTF-8 code points up to U+10FFFF " "are allowed to appear unescaped: %.*s")), ((int)((e) - (p))), (p));

        goto parse_json_string_fail;
      }
      const size_t ch_len = (size_t)utf_char2len(ch);
      (__builtin_expect(!(ch_len == (size_t)(ch ? utf_ptr2len(p) : 1)), 0) ? __assert_rtn(__func__, "decode.c", 393, "ch_len == (size_t)(ch ? utf_ptr2len(p) : 1)") : (void)0);
      len += ch_len;
      p += ch_len;
    }
  }
  if (p == e || *p != '"') {
    semsg(libintl_gettext((char *)("E474: Expected string end: %.*s")), (int)buf_len, buf);
    goto parse_json_string_fail;
  }
  if (len == 0) {
  ...
  for (const char *t = s; t < p; t++) {
    ...
    if (*t == '\\') {
      ...
      case 'u': {
        ...
        t += 4;
        uvarnumber_T ch;
        vim_str2nr(ubuf, ((void*)0), ((void*)0),
                   STR2NR_HEX | STR2NR_FORCE, ((void*)0), &ch, 4, 1);
        if (ch == 0) {
          hasnul = 1;
        }
  ...
  *str_end = '\000';
  typval_T obj = decode_string(str, (size_t)(str_end - str), hasnul ? kTrue : kFalse, 0, 1);
...
# 519 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/decode.c"
  ...
  FUNC_ATTR_NONNULL_ALL FUNC_ATTR_WARN_UNUSED_RESULT FUNC_ATTR_ALWAYS_INLINE
{
  ...
  if (p != ints + 1 && *ints == '0') {
    semsg(libintl_gettext((char *)("E474: Leading zeroes are not allowed: %.*s")), ((int)((e) - (s))), (s));
...
parse_json_number_check:
  if (p == ints) {
    semsg(libintl_gettext((char *)("E474: Missing number after minus sign: %.*s")), ((int)((e) - (s))), (s));
    goto parse_json_number_fail;
  } else if (p == fracs || (fracs != ((void*)0) && exps_s == fracs + 1)) {
    semsg(libintl_gettext((char *)("E474: Missing number after decimal dot: %.*s")), ((int)((e) - (s))), (s));
    goto parse_json_number_fail;
  } else if (p == exps) {
    semsg(libintl_gettext((char *)("E474: Missing exponent: %.*s")), ((int)((e) - (s))), (s));
    goto parse_json_number_fail;
  }
  typval_T tv = {
    .v_type = VAR_NUMBER,
  ...
  if (fracs || exps) {
    ...
    if (exp_num_len != num_len) {
      semsg(libintl_gettext((char *)("E685: internal error: while converting number \"%.*s\" " "to float string2float consumed %zu bytes in place of %zu")),
    ...
    varnumber_T nr;
    int num_len;
    vim_str2nr(s, ((void*)0), &num_len, 0, &nr, ((void*)0), (int)(p - s), 1);
    if ((int)exp_num_len != num_len) {
      semsg(libintl_gettext((char *)("E685: internal error: while converting number \"%.*s\" " "to integer vim_str2nr consumed %i bytes in place of %zu")),
...
# 646 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/decode.c"
  ...
  FUNC_ATTR_NONNULL_ALL FUNC_ATTR_WARN_UNUSED_RESULT
{
  ...
  if (p == e) {
    emsg(libintl_gettext((char *)("E474: Attempt to decode a blank string")));
    return 0;
  }
  int ret = 1;
...
json_decode_string_cycle_start:
    (__builtin_expect(!(*p == '{' || next_map_special == 0), 0) ? __assert_rtn(__func__, "decode.c", 667, "*p == '{' || next_map_special == false") : (void)0);
    switch (*p) {
    case '}':
    case ']': {
      if (((container_stack).size) == 0) {
        semsg(libintl_gettext((char *)("E474: No container to close: %.*s")), ((int)((e) - (p))), (p));
        goto json_decode_string_fail;
      }
      ContainerStackItem last_container = ((container_stack).items[(((container_stack).size) - (0) - 1)]);
      if (*p == '}' && last_container.container.v_type != VAR_DICT) {
        semsg(libintl_gettext((char *)("E474: Closing list with curly bracket: %.*s")), ((int)((e) - (p))), (p));
        goto json_decode_string_fail;
      } else if (*p == ']' && last_container.container.v_type != VAR_LIST) {
        semsg(libintl_gettext((char *)("E474: Closing dictionary with square bracket: %.*s")),
              ((int)((e) - (p))), (p));
        goto json_decode_string_fail;
      } else if (didcomma) {
        semsg(libintl_gettext((char *)("E474: Trailing comma: %.*s")), ((int)((e) - (p))), (p));
        goto json_decode_string_fail;
      } else if (didcolon) {
        semsg(libintl_gettext((char *)("E474: Expected value after colon: %.*s")), ((int)((e) - (p))), (p));
        goto json_decode_string_fail;
      } else if (last_container.stack_index != ((stack).size) - 1) {
        (__builtin_expect(!(last_container.stack_index < ((stack).size) - 1), 0) ? __assert_rtn(__func__, "decode.c", 690, "last_container.stack_index < kv_size(stack) - 1") : (void)0);
        semsg(libintl_gettext((char *)("E474: Expected value: %.*s")), ((int)((e) - (p))), (p));
        goto json_decode_string_fail;
      }
      if (((stack).size) == 1) {
        p++;
        ...
        (__builtin_expect(!(!next_map_special), 0) ? __assert_rtn(__func__, "decode.c", 704, "!next_map_special") : (void)0);
        break;
      }
    }
    case ',': {
      if (((container_stack).size) == 0) {
        semsg(libintl_gettext((char *)("E474: Comma not inside container: %.*s")), ((int)((e) - (p))), (p));
        goto json_decode_string_fail;
      }
      ContainerStackItem last_container = ((container_stack).items[(((container_stack).size) - (0) - 1)]);
      if (didcomma) {
        semsg(libintl_gettext((char *)("E474: Duplicate comma: %.*s")), ((int)((e) - (p))), (p));
        goto json_decode_string_fail;
      } else if (didcolon) {
        semsg(libintl_gettext((char *)("E474: Comma after colon: %.*s")), ((int)((e) - (p))), (p));
        goto json_decode_string_fail;
      } else if (last_container.container.v_type == VAR_DICT
                 && last_container.stack_index != ((stack).size) - 1) {
        semsg(libintl_gettext((char *)("E474: Using comma in place of colon: %.*s")), ((int)((e) - (p))), (p));
        goto json_decode_string_fail;
        ...
        semsg(libintl_gettext((char *)("E474: Leading comma: %.*s")), ((int)((e) - (p))), (p));
        goto json_decode_string_fail;
      }
      didcomma = 1;
      continue;
    ...
    case ':': {
      if (((container_stack).size) == 0) {
        semsg(libintl_gettext((char *)("E474: Colon not inside container: %.*s")), ((int)((e) - (p))), (p));
        goto json_decode_string_fail;
      }
      ContainerStackItem last_container = ((container_stack).items[(((container_stack).size) - (0) - 1)]);
      if (last_container.container.v_type != VAR_DICT) {
        semsg(libintl_gettext((char *)("E474: Using colon not in dictionary: %.*s")), ((int)((e) - (p))), (p));
        goto json_decode_string_fail;
      } else if (last_container.stack_index != ((stack).size) - 2) {
        semsg(libintl_gettext((char *)("E474: Unexpected colon: %.*s")), ((int)((e) - (p))), (p));
        goto json_decode_string_fail;
      } else if (didcomma) {
        semsg(libintl_gettext((char *)("E474: Colon after comma: %.*s")), ((int)((e) - (p))), (p));
        goto json_decode_string_fail;
      } else if (didcolon) {
        semsg(libintl_gettext((char *)("E474: Duplicate colon: %.*s")), ((int)((e) - (p))), (p));
        goto json_decode_string_fail;
      }
      didcolon = 1;
      continue;
    ...
    case 'n':
      if ((p + 3) >= e || strncmp(p + 1, "ull", 3) != 0) {
        semsg(libintl_gettext((char *)("E474: Expected null: %.*s")), ((int)((e) - (p))), (p));
        goto json_decode_string_fail;
      }
      p += 3;
    ...
    case 't':
      if ((p + 3) >= e || strncmp(p + 1, "rue", 3) != 0) {
        semsg(libintl_gettext((char *)("E474: Expected true: %.*s")), ((int)((e) - (p))), (p));
        goto json_decode_string_fail;
      }
      p += 3;
    ...
    case 'f':
      if ((p + 4) >= e || strncmp(p + 1, "alse", 4) != 0) {
        semsg(libintl_gettext((char *)("E474: Expected false: %.*s")), ((int)((e) - (p))), (p));
        goto json_decode_string_fail;
      }
      p += 4;
    ...
    default:
      semsg(libintl_gettext((char *)("E474: Unidentified byte: %.*s")), ((int)((e) - (p))), (p));
      goto json_decode_string_fail;
    }
    didcomma = 0;
    didcolon = 0;
...
json_decode_string_after_cycle:
  for (; p < e; p++) {
    ...
    case '\015':
      break;
    default:
      semsg(libintl_gettext((char *)("E474: Trailing characters: %.*s")), ((int)((e) - (p))), (p));
      goto json_decode_string_fail;
    }
  }
  ...
  semsg(libintl_gettext((char *)("E474: Unexpected end of input: %.*s")), (int)buf_len, buf);
...
# 916 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/decode.c"
