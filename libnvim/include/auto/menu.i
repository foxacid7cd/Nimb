# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/menu.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/menu.c" 2
...
# 8 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/menu.c" 2
...
# 9 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/menu.c" 2
...
# 10 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/menu.c" 2
...
# 12 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/menu.c" 2
...
# 13 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/menu.c" 2
...
# 14 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/menu.c" 2
...
# 15 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/menu.c" 2
...
# 16 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/menu.c" 2
...
# 18 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/menu.c" 2
...
# 20 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/menu.c" 2


# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/menu.h" 1
# 23 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/menu.c" 2
...
# 25 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/menu.c" 2
...
# 26 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/menu.c" 2
...
# 27 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/menu.c" 2
...
# 29 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/menu.c" 2
...
# 31 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/menu.c" 2
...
static char e_notsubmenu[] = "E327: Part of menu-item path is not sub-menu";
static char e_nomenu[] = "E329: No menu \"%s\"";


static _Bool menu_is_winbar(const char *const name)
...
void ex_menu(exarg_T *eap)
{
  ...
  menu_path = arg;
  if (*menu_path == '.') {
    semsg(libintl_gettext((char *)(e_invarg2)), menu_path);
    goto theend;
  }
  ...
  if (*map_to == '\000' && !unmenu && enable == kNone) {
    ...
    semsg(libintl_gettext((char *)(e_trailing_arg)), map_to);
    goto theend;
  }
  ...
  if (enable != kNone) {
    ...
    if (menu_is_popup(menu_path)) {
      for (i = 0; i < MENU_INDEX_TIP; i++) {
        if (modes & (1 << i)) {
          p = popup_mode_name(menu_path, i);
          remove_menu(root_menu_ptr, p, MENU_ALL_MODES, 1);
          xfree(p);
        }
      }
    }
    ...
    if (strcasecmp((char *)(map_to), (char *)("<nop>")) == 0) {
      ...
      map_to = replace_termcodes(map_to, strlen(map_to), &map_buf,
                                 REPTERM_DO_LT, ((void*)0), ((vim_strchr((char *)p_cpo, 'B') == ((void*)0)) ? 0 : 0x01));
    }
    menuarg.modes = modes;
                         ...
                         const char *const call_data)
{
  ...
  while (*name) {
    ...
    if (*dname == '\000') {
      ...
      emsg(libintl_gettext((char *)("E792: Empty menu name")));
      goto erret;
    }
    ...
    while (menu != ((void*)0)) {
      if (menu_name_equal(name, menu) || menu_name_equal(dname, menu)) {
        if (*next_name == '\000' && menu->children != ((void*)0)) {
          if (!sys_menu) {
            emsg(libintl_gettext((char *)("E330: Menu path must not lead to a sub-menu")));
          }
          goto erret;
        }
        if (*next_name != '\000' && menu->children == ((void*)0)) {
          if (!sys_menu) {
            emsg(libintl_gettext((char *)(e_notsubmenu)));
          }
          goto erret;
        }
        break;
    ...
    if (menu == ((void*)0)) {
      if (*next_name == '\000' && parent == ((void*)0)) {
        emsg(libintl_gettext((char *)("E331: Must not add menu items directly to menu bar")));
        goto erret;
      }

      if (menu_is_separator(dname) && *next_name != '\000') {
        emsg(libintl_gettext((char *)("E332: Separator cannot be part of a menu path")));
        goto erret;
      }
  ...
  if (menu != ((void*)0) && modes) {
    p = (call_data == ((void*)0)) ? ((void*)0) : xstrdup(call_data);
...
static int menu_enable_recurse(vimmenu_T *menu, char *name, int modes, int enable)
{
  ...
  if (*name != '\000' && *name != '*' && menu == ((void*)0)) {
    semsg(libintl_gettext((char *)(e_nomenu)), name);
    return 0;
  }
  ...
  while ((menu = *menup) != ((void*)0)) {
    if (*name == '\000' || menu_name_equal(name, menu)) {
      ...
      if ((menu->modes & modes) != 0x0) {
        ...
        if (!silent) {
          emsg(libintl_gettext((char *)(e_menuothermode)));
        }
        return 0;
      }
...
# 651 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/menu.c"
    ...
    for (int bit = 0; bit < MENU_MODES; bit++) {
      if ((menu->modes & modes & (1 << bit)) != 0) {
        ...
        tv_dict_add_allocated_str(impl, ("rhs"), (sizeof("rhs") - 1),
                                  str2special_save(menu->strings[bit], 0, 0));
...
_Bool menu_get(char *const path_name, int modes, list_T *list)
{
...
char *set_context_in_menu_cmd(expand_T *xp, const char *cmd, char *arg, _Bool forceit)
  FUNC_ATTR_NONNULL_ALL
{
  char *after_dot;
  char *p;
  char *path_name = ((void*)0);
  char *name;
  int unmenu;
  vimmenu_T *menu;
  int expand_menus;
...
# 1159 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/menu.c"
...
static char *popup_mode_name(char *name, int idx)
{
  ...
  (__builtin_expect(!(len >= 4), 0) ? __assert_rtn(__func__, "menu.c", 1279, "len >= 4") : (void)0);

  char *mode_chars = menu_mode_chars[idx];
  size_t mode_chars_len = strlen(mode_chars);
  char *p = xstrnsave(name, len + mode_chars_len);
  __builtin___memmove_chk (p + 5 + mode_chars_len, p + 5, len - 4, __builtin_object_size (p + 5 + mode_chars_len, 0));
...
# 1303 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/menu.c"
  ...
  FUNC_ATTR_NONNULL_ARG(1)
{
  ...
  if (p != ((void*)0)) {
    ...
    (__builtin_expect(!(p >= str), 0) ? __assert_rtn(__func__, "menu.c", 1316, "p >= str") : (void)0);
...
_Bool menu_is_menubar(const char *const name)
  FUNC_ATTR_PURE FUNC_ATTR_WARN_UNUSED_RESULT FUNC_ATTR_NONNULL_ALL
{
...
_Bool menu_is_popup(const char *const name)
  FUNC_ATTR_PURE FUNC_ATTR_WARN_UNUSED_RESULT FUNC_ATTR_NONNULL_ALL
{
...
_Bool menu_is_toolbar(const char *const name)
  FUNC_ATTR_PURE FUNC_ATTR_WARN_UNUSED_RESULT FUNC_ATTR_NONNULL_ALL
{
...
void show_popupmenu(void)
{
  ...
  apply_autocmds(EVENT_MENUPOPUP, mode, ((void*)0), 0, curbuf);

  vimmenu_T *menu;

  for (menu = root_menu; menu != ((void*)0); menu = menu->next) {
    if (strncmp((char *)("PopUp"), (char *)(menu->name), (size_t)(5)) == 0 && strncmp((char *)(menu->name + 5), (char *)(mode), (size_t)(mode_len)) == 0) {
      break;
    }
  }
  ...
  FUNC_ATTR_NONNULL_ARG(2)
{
  ...
  if (idx == MENU_INDEX_INVALID || eap == ((void*)0)) {
    idx = MENU_INDEX_NORMAL;
  }

  if (menu->strings[idx] != ((void*)0) && (menu->modes & (1 << idx))) {
    ...
    semsg(libintl_gettext((char *)("E335: Menu not defined for %s mode")), mode);
  }
}
  ...
  FUNC_ATTR_NONNULL_ALL
{
  ...
  while (*name) {
    ...
    while (menu != ((void*)0)) {
      if (menu_name_equal(name, menu)) {
        if (*p == '\000' && menu->children != ((void*)0)) {
          emsg(libintl_gettext((char *)("E333: Menu path must lead to a menu item")));
          gave_emsg = 1;
          menu = ((void*)0);
  ...
  if (menu == ((void*)0)) {
    if (!gave_emsg) {
      semsg(libintl_gettext((char *)("E334: Menu not found: %s")), name_arg);
    }
    return ((void*)0);
  }
...
vimmenu_T *menu_find(const char *path_name)
{
    ...
    while (menu != ((void*)0)) {
      if (menu_name_equal(name, menu)) {
        if (menu->children == ((void*)0)) {
          ...
          if (*p == '\000') {
            emsg(libintl_gettext((char *)("E336: Menu path must lead to a sub-menu")));
          } else {
            emsg(libintl_gettext((char *)(e_notsubmenu)));
          }
          menu = ((void*)0);
  ...
  if (menu == ((void*)0)) {
    emsg(libintl_gettext((char *)("E337: Menu not found - check menu names")));
  }
theend:
  xfree(saved_name);
  return menu;
...
# 1709 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/menu.c"
  ...
  if (strncmp((char *)(arg), (char *)("clear"), (size_t)(5)) == 0 && ends_excmd(*skipwhite(arg + 5))) {
    ...
    *arg = '\000';
    ...
    if (arg == to) {
      ...
      (__builtin_expect(!(arg >= to), 0) ? __assert_rtn(__func__, "menu.c", 1736, "arg >= to") : (void)0);
  ...
  FUNC_ATTR_NONNULL_ALL
{
  if (*menu_name == '\000') {
    ...
    for (const vimmenu_T *topmenu = menu; topmenu != ((void*)0); topmenu = topmenu->next) {
...
void f_menu_info(typval_T *argvars, typval_T *rettv, EvalFuncData fptr)
{
  ...
  const int modes = get_menu_cmd_modes(which, *which == '!', ((void*)0), ((void*)0));
