# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/tui/input.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/tui/input.c" 2
...
# 5 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/tui/input.c" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/api/vim.h" 1
# 6 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/tui/input.c" 2
...
# 9 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/tui/input.c" 2
...
# 10 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/tui/input.c" 2
...
# 12 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/tui/input.c" 2
...
# 13 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/tui/input.c" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/os/input.h" 1
# 14 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/tui/input.c" 2
...
# 15 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/tui/input.c" 2
...
# 5 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/tui/tui.h" 2
...
# 6 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/tui/tui.h" 2
...
# 16 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/tui/input.c" 2
...
# 22 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/tui/input.c" 2
...
# 23 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/tui/input.c" 2
...
static Map_KittyKey_cstr_t kitty_key_map = { { 0, 0, 0, 0, ((void*)0), ((void*)0), ((void*)0) } };
...
# 151 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/tui/input.c"
...
static void tinput_wait_enqueue(void **argv)
{
  ...
  if (input->paste) {
    ...
    if (ui_client_channel_id) {
      ...
      (*((((args).size == (args).capacity) ? (((args).capacity = ((args).capacity ? (args).capacity << 1 : 8), (args).items = xrealloc((args).items, sizeof((args).items[0]) * (args).capacity)), 0) : 0), ((args).items + ((args).size++))) = (((Object) { .type = kObjectTypeString, .data.string = keys })));
      (*((((args).size == (args).capacity) ? (((args).capacity = ((args).capacity ? (args).capacity << 1 : 8), (args).items = xrealloc((args).items, sizeof((args).items[0]) * (args).capacity)), 0) : 0), ((args).items + ((args).size++))) = (((Object) { .type = kObjectTypeBoolean, .data.boolean = 1 })));
      (*((((args).size == (args).capacity) ? (((args).capacity = ((args).capacity ? (args).capacity << 1 : 8), (args).items = xrealloc((args).items, sizeof((args).items[0]) * (args).capacity)), 0) : 0), ((args).items + ((args).size++))) = (((Object) { .type = kObjectTypeInteger, .data.integer = input->paste })));
      rpc_send_event(ui_client_channel_id, "nvim_paste", args);
    } else {
      multiqueue_put_event(main_loop.events, event_create(tinput_paste_event, 3, keys.data, keys.size, (intptr_t)input->paste));;
    ...
    for (size_t len = 0, _r = 1; _r; _r = 0) for (char *buf = rbuffer_read_ptr(input->key_buffer, &len); input->key_buffer->size; buf = rbuffer_read_ptr(input->key_buffer, &len)) {
      ...
      if (ui_client_channel_id) {
        ...
        (*((((args).size == (args).capacity) ? (((args).capacity = ((args).capacity ? (args).capacity << 1 : 8), (args).items = xrealloc((args).items, sizeof((args).items[0]) * (args).capacity)), 0) : 0), ((args).items + ((args).size++))) = (((Object) { .type = kObjectTypeString, .data.string = copy_string(keys, ((void*)0)) })));
...
static void handle_kitty_key_protocol(TermInput *input, TermKeyKey *key)
{
  ...
  if (name) {
    ...
    len += (size_t)__builtin___snprintf_chk (buf + len, sizeof(buf) - len, 0, __builtin_object_size (buf + len, 1 > 1 ? 1 : 0), "%s>", name);
...
static void forward_modified_utf8(TermInput *input, TermKeyKey *key)
{
  ...
  if (key->type == TERMKEY_TYPE_KEYSYM
    ...
    (__builtin_expect(!(key->modifiers), 0) ? __assert_rtn(__func__, "input.c", 352, "key->modifiers") : (void)0);
    if (key->code.codepoint >= 0xE000 && key->code.codepoint <= 0xF8FF
      ...
      if ((key->modifiers & TERMKEY_KEYMOD_CTRL)
        ...
        (__builtin_expect(!(len <= 62), 0) ? __assert_rtn(__func__, "input.c", 366, "len <= 62") : (void)0);
...
static void forward_mouse_event(TermInput *input, TermKeyKey *key)
{
  ...
  case TERMKEY_MOUSE_PRESS:
    if (button == 4) {
      ...
      len += (size_t)__builtin___snprintf_chk (buf + len, sizeof(buf) - len, 0, __builtin_object_size (buf + len, 1 > 1 ? 1 : 0), "ScrollWheelLeft");
    } else if (button == 7) {
      len += (size_t)__builtin___snprintf_chk (buf + len, sizeof(buf) - len, 0, __builtin_object_size (buf + len, 1 > 1 ? 1 : 0), "ScrollWheelRight");
    } else {
  ...
  case TERMKEY_MOUSE_RELEASE:
    len += (size_t)__builtin___snprintf_chk (buf + len, sizeof(buf) - len, 0, __builtin_object_size (buf + len, 1 > 1 ? 1 : 0), button ? "Release" : "MouseMove");
...
# 555 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/tui/input.c"
...
# 627 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/tui/input.c"
  ...
  do {
    ...
    if (input->paste) {
      for (size_t len = 0, _r = 1; _r; _r = 0) for (char *ptr = rbuffer_read_ptr(input->read_stream.buffer, &len); input->read_stream.buffer->size; ptr = rbuffer_read_ptr(input->read_stream.buffer, &len)) {
        ...
        (__builtin_expect(!(consumed <= input->read_stream.buffer->size), 0) ? __assert_rtn(__func__, "input.c", 753, "consumed <= input->read_stream.buffer->size") : (void)0);
    ...
    for (size_t len = 0, _r = 1; _r; _r = 0) for (char *ptr = rbuffer_read_ptr(input->read_stream.buffer, &len); input->read_stream.buffer->size; ptr = rbuffer_read_ptr(input->read_stream.buffer, &len)) {
      ...
      (__builtin_expect(!(consumed <= input->read_stream.buffer->size), 0) ? __assert_rtn(__func__, "input.c", 768, "consumed <= input->read_stream.buffer->size") : (void)0);
      rbuffer_consumed(input->read_stream.buffer, consumed);
