# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/ui_compositor.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/ui_compositor.c" 2
...
# 10 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/ui_compositor.c" 2
...
# 11 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/ui_compositor.c" 2
...
# 12 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/ui_compositor.c" 2
...
# 13 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/ui_compositor.c" 2
...
# 15 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/ui_compositor.c" 2
...
# 16 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/ui_compositor.c" 2
...
# 18 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/ui_compositor.c" 2
...
# 19 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/ui_compositor.c" 2
...
# 20 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/ui_compositor.c" 2
...
# 22 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/ui_compositor.c" 2
...
# 23 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/ui_compositor.c" 2
...
# 27 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/ui_compositor.c" 2
...
# 28 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/ui_compositor.c" 2
...
# 29 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/ui_compositor.c" 2

# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/ui_compositor.h" 1
# 31 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/ui_compositor.c" 2
...
static Map_uint32_t_ptr_t ui_event_cbs = { { 0, 0, 0, 0, ((void*)0), ((void*)0), ((void*)0) } };
...
void ui_comp_init(void)
{
  ...
  compositor->ui_ext[kUIMultigrid] = 0;
...
void ui_comp_free_all_mem(void)
{
  ...
  { khint_t __i; for (__i = (khint_t)(0); __i != ((&(&ui_event_cbs)->table)->n_buckets); ++__i) { if (!(!(((&(&ui_event_cbs)->table)->flags[(__i)>>4]>>(((__i)&0xfU)<<1))&3))) continue; (event_cb) = ((&(&ui_event_cbs)->table)->vals[__i]); { free_ui_event_callback(event_cb); }; } }


  map_uint32_t_ptr_t_destroy(&ui_event_cbs);
}
...
_Bool ui_comp_put_grid(ScreenGrid *grid, int row, int col, int height, int width, _Bool valid,
                      _Bool on_top)
{
  _Bool moved;
...
{
  (__builtin_expect(!(grid != &default_grid), 0) ? __assert_rtn(__func__, "ui_compositor.c", 215, "grid != &default_grid") : (void)0);
  if (grid->comp_index == 0) {
...
static void ui_comp_raise_grid(ScreenGrid *grid, size_t new_index)
{
  ...
  for (size_t i = old_index; i < new_index; i++) {
    ...
    int endcol = ((grid->comp_col + grid->cols) < (grid2->comp_col + grid2->cols) ? (grid->comp_col + grid->cols) : (grid2->comp_col + grid2->cols));
...
static void compose_line(Integer row, Integer startcol, Integer endcol, LineFlags flags)
{
  ...
  while (col < endcol) {
    ...
    for (size_t i = 0; i < ((layers).size); i++) {
      ...
      grid_width = ((g->cols) < (g->comp_width) ? (g->cols) : (g->comp_width));
    ...
    (__builtin_expect(!(grid != ((void*)0)), 0) ? __assert_rtn(__func__, "ui_compositor.c", 384, "grid != NULL") : (void)0);
    (__builtin_expect(!(until > col), 0) ? __assert_rtn(__func__, "ui_compositor.c", 385, "until > col") : (void)0);
    (__builtin_expect(!(until <= default_grid.cols), 0) ? __assert_rtn(__func__, "ui_compositor.c", 386, "until <= default_grid.cols") : (void)0);
  ...
  (__builtin_expect(!(endcol <= chk_width), 0) ? __assert_rtn(__func__, "ui_compositor.c", 453, "endcol <= chk_width") : (void)0);
  (__builtin_expect(!(row < chk_height), 0) ? __assert_rtn(__func__, "ui_compositor.c", 454, "row < chk_height") : (void)0);
                          ...
                          int syn_id, _Bool delay)
{
  ...
  endcol = ((endcol) < (default_grid.cols) ? (endcol) : (default_grid.cols));
                             ...
                             const schar_T *chunk, const sattr_T *attrs)
{
  ...
  (__builtin_expect(!(endcol <= clearcol), 0) ? __assert_rtn(__func__, "ui_compositor.c", 552, "endcol <= clearcol") : (void)0);
  ...
  if (flags & kLineFlagInvalid || covered || curgrid->blending) {
    ...
    for (int i = 0; i < endcol - startcol; i++) {
      (__builtin_expect(!(attrs[i] >= 0), 0) ? __assert_rtn(__func__, "ui_compositor.c", 582, "attrs[i] >= 0") : (void)0);
    }
...
_Bool ui_comp_set_screen_valid(_Bool valid)
{
  _Bool old_val = valid_screen;
  valid_screen = valid;
  if (!valid) {
    msg_sep_row = -1;
  }
                                ...
                                String sep_char)
{
  ...
  if (row > msg_current_row && ui_comp_should_draw()) {
    compose_area(((msg_current_row - 1) > (0) ? (msg_current_row - 1) : (0)), row, 0, default_grid.cols);
...
static void ui_comp_event(UI *ui, char *name, Array args)
{
  ...
  { khint_t __i; for (__i = (khint_t)(0); __i != ((&(&ui_event_cbs)->table)->n_buckets); ++__i) { if (!(!(((&(&ui_event_cbs)->table)->flags[(__i)>>4]>>(((__i)&0xfU)<<1))&3))) continue; (event_cb) = ((&(&ui_event_cbs)->table)->vals[__i]); { Object res = nlua_call_ref(event_cb->cb, name, args, 0, &err); if (res.type == kObjectTypeBoolean && res.data.boolean == 1) { handled = 1; } }; } }
...
{
  __builtin___memset_chk (compositor->ui_ext, 0, ((sizeof(compositor->ui_ext)/sizeof((compositor->ui_ext)[0])) / ((size_t)(!(sizeof(compositor->ui_ext) % sizeof((compositor->ui_ext)[0]))))), __builtin_object_size (compositor->ui_ext, 0));

  for (size_t i = 0; i < kUILinegrid; i++) {
    UIEventCallback *event_cb;

    { khint_t __i; for (__i = (khint_t)(0); __i != ((&(&ui_event_cbs)->table)->n_buckets); ++__i) { if (!(!(((&(&ui_event_cbs)->table)->flags[(__i)>>4]>>(((__i)&0xfU)<<1))&3))) continue; (event_cb) = ((&(&ui_event_cbs)->table)->vals[__i]); { if (event_cb->ext_widgets[i]) { compositor->ui_ext[i] = 1; break; } }; } }
...
void ui_comp_add_cb(uint32_t ns_id, LuaRef cb, _Bool *ext_widgets)
{
  UIEventCallback *event_cb = xcalloc(1, sizeof(UIEventCallback));
  event_cb->cb = cb;
  __builtin___memcpy_chk (event_cb->ext_widgets, ext_widgets, ((sizeof(event_cb->ext_widgets)/sizeof((event_cb->ext_widgets)[0])) / ((size_t)(!(sizeof(event_cb->ext_widgets) % sizeof((event_cb->ext_widgets)[0]))))), __builtin_object_size (event_cb->ext_widgets, 0));
  if (event_cb->ext_widgets[kUIMessages]) {
    event_cb->ext_widgets[kUICmdline] = 1;
  }

  UIEventCallback **item = (UIEventCallback **)map_uint32_t_ptr_t_ref(&ui_event_cbs, ns_id, 1);
  if (*item) {
