# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/ui_client.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/ui_client.c" 2
...
# 5 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/ui_client.c" 2
...
# 6 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/ui_client.c" 2
...
# 7 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/ui_client.c" 2
...
# 9 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/ui_client.c" 2
...
# 10 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/ui_client.c" 2
...
# 11 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/ui_client.c" 2
...
# 14 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/ui_client.c" 2
...
# 15 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/ui_client.c" 2
# 25 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/ui_client.c"
void ui_client_init(uint64_t chan)
{
  ...
  (*((((opts).size == (opts).capacity) ? (((opts).capacity = ((opts).capacity ? (opts).capacity << 1 : 8), (opts).items = xrealloc((opts).items, sizeof((opts).items[0]) * (opts).capacity)), 0) : 0), ((opts).items + ((opts).size++))) = (((KeyValuePair) { .key = cstr_to_string("rgb"), .value = ((Object) { .type = kObjectTypeBoolean, .data.boolean = 1 }) })));
  (*((((opts).size == (opts).capacity) ? (((opts).capacity = ((opts).capacity ? (opts).capacity << 1 : 8), (opts).items = xrealloc((opts).items, sizeof((opts).items[0]) * (opts).capacity)), 0) : 0), ((opts).items + ((opts).size++))) = (((KeyValuePair) { .key = cstr_to_string("ext_linegrid"), .value = ((Object) { .type = kObjectTypeBoolean, .data.boolean = 1 }) })));
  (*((((opts).size == (opts).capacity) ? (((opts).capacity = ((opts).capacity ? (opts).capacity << 1 : 8), (opts).items = xrealloc((opts).items, sizeof((opts).items[0]) * (opts).capacity)), 0) : 0), ((opts).items + ((opts).size++))) = (((KeyValuePair) { .key = cstr_to_string("ext_termcolors"), .value = ((Object) { .type = kObjectTypeBoolean, .data.boolean = 1 }) })));
...
UIClientHandler ui_client_get_redraw_handler(const char *name, size_t name_len, Error *error)
{
  ...
  if (hash < 0) {
    return (UIClientHandler){ ((void*)0), ((void*)0) };
  }
...
static HlAttrs ui_client_dict2hlattrs(Dictionary d, _Bool rgb)
{
  ...
  return dict2hlattrs(&dict, 1, ((void*)0), &err);
}
...
void ui_client_event_grid_resize(Array args)
{
  if (args.size < 3
    ...
    logmsg(4, ((void*)0), __func__, 95, 1, "Error handling ui event 'grid_resize'");
    return;
  }
