# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/debugger.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/debugger.c" 2
...
# 9 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/debugger.c" 2
...
# 10 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/debugger.c" 2
...
# 11 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/debugger.c" 2
...
# 12 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/debugger.c" 2
...
# 13 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/debugger.c" 2
...
# 14 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/debugger.c" 2
...
# 15 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/debugger.c" 2
...
# 16 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/debugger.c" 2
...
# 17 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/debugger.c" 2



# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/regexp.h" 1
# 21 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/debugger.c" 2
...
void do_debug(char *cmd)
{
  ...
  _Bool save_redir_off = redir_off;
...
# 78 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/debugger.c"
  RedrawingDisabled++;
  no_wait_return++;
  did_emsg = 0;
  cmd_silent = 0;
  ...
  if (!debug_did_msg) {
    msg(libintl_gettext((char *)("Entering Debug mode.  Type \"cont\" to continue.")));
  }
  ...
  if ((((estack_T *)exestack.ga_data)[exestack.ga_len - 1].es_lnum) != 0) {
    smsg(libintl_gettext((char *)("line %" "ll" "d" ": %s")), (int64_t)(((estack_T *)exestack.ga_data)[exestack.ga_len - 1].es_lnum), cmd);
  } else {
  ...
  for (;;) {
    ...
    xfree(cmdline);
    cmdline = getcmdline_prompt('>', ((void*)0), 0, EXPAND_NOTHING, ((void*)0),
    ...
    if (cmdline != ((void*)0)) {
      ...
      n = debug_break_level;
      debug_break_level = -1;
      (void)do_cmdline(cmdline, getexline, ((void*)0), 0x01|0x10);
      debug_break_level = n;
    }
    lines_left = Rows - 1;
  }
...
static void do_checkbacktracelevel(void)
{
  if (debug_backtrace_level < 0) {
    debug_backtrace_level = 0;
    msg(libintl_gettext((char *)("frame is zero")));
  } else {
    char *sname = estack_sfile(ESTACK_NONE);
...
# 491 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/debugger.c"
static int dbg_parsearg(char *arg, garray_T *gap)
{
  ...
  if (here) {
    ...
    bp->dbg_lnum = getdigits_int32(&p, 1, 0);
    p = skipwhite(p);
  } else {
    bp->dbg_lnum = 0;
  }
...
void ex_breakadd(exarg_T *eap)
{
  ...
  if (dbg_parsearg(eap->arg, gap) == 1) {
    ...
    if (bp->dbg_type != 3) {
      char *pat = file_pat_to_reg_pat(bp->dbg_name, ((void*)0), ((void*)0), 0);
      if (pat != ((void*)0)) {
...
void ex_breakdel(exarg_T *eap)
{
  ...
  if (todel < 0) {
    semsg(libintl_gettext((char *)("E161: Breakpoint not found: %s")), eap->arg);
  } else {
    while (!((gap)->ga_len <= 0)) {
...
void ex_breaklist(exarg_T *eap)
{
  if (((&dbg_breakp)->ga_len <= 0)) {
    msg(libintl_gettext((char *)("No breakpoints defined")));
  } else {
    for (int i = 0; i < dbg_breakp.ga_len; i++) {
      struct debuggy *bp = &(((struct debuggy *)dbg_breakp.ga_data)[i]);
      if (bp->dbg_type == 2) {
        home_replace(((void*)0), bp->dbg_name, (char *)NameBuff, 4096, 1);
      }
      if (bp->dbg_type != 3) {
...
linenr_T dbg_find_breakpoint(_Bool file, char *fname, linenr_T after)
{
  return debuggy_find(file, (char_u *)fname, after, &dbg_breakp, ((void*)0));
}
...
_Bool has_profiling(_Bool file, char *fname, _Bool *fp)
{
  return debuggy_find(file, (char_u *)fname, (linenr_T)0, &prof_ga, fp)
         != (linenr_T)0;
}
# 750 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/debugger.c"
