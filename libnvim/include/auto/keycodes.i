# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/keycodes.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/keycodes.c" 2
...
# 5 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/keycodes.c" 2
...
# 6 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/keycodes.c" 2
...
# 7 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/keycodes.c" 2
...
# 9 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/keycodes.c" 2
...
# 10 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/keycodes.c" 2
...
# 11 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/keycodes.c" 2
# 1 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/eval/vars.h" 1
# 12 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/keycodes.c" 2
...
# 16 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/keycodes.c" 2
# 25 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/keycodes.c"
...
static struct mousetable {
  ...
  { KE_LEFTMOUSE, MOUSE_LEFT, 1, 0 },
  { KE_LEFTDRAG, MOUSE_LEFT, 0, 1 },
  { KE_LEFTRELEASE, MOUSE_LEFT, 0, 0 },
  { KE_MIDDLEMOUSE, MOUSE_MIDDLE, 1, 0 },
  { KE_MIDDLEDRAG, MOUSE_MIDDLE, 0, 1 },
  { KE_MIDDLERELEASE, MOUSE_MIDDLE, 0, 0 },
  { KE_RIGHTMOUSE, MOUSE_RIGHT, 1, 0 },
  { KE_RIGHTDRAG, MOUSE_RIGHT, 0, 1 },
  { KE_RIGHTRELEASE, MOUSE_RIGHT, 0, 0 },
  { KE_X1MOUSE, MOUSE_X1, 1, 0 },
  { KE_X1DRAG, MOUSE_X1, 0, 1 },
  { KE_X1RELEASE, MOUSE_X1, 0, 0 },
  { KE_X2MOUSE, MOUSE_X2, 1, 0 },
  { KE_X2DRAG, MOUSE_X2, 0, 1 },
  { KE_X2RELEASE, MOUSE_X2, 0, 0 },

  { KE_MOUSEMOVE, MOUSE_RELEASE, 0, 1 },

  { KE_IGNORE, MOUSE_RELEASE, 0, 0 },
  { 0, 0, 0, 0 },
};
...
# 394 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/keycodes.c"
...
# 564 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/keycodes.c"
unsigned int trans_special(const char_u **const srcp, const size_t src_len, char_u *const dst,
                           const int flags, const _Bool escape_ks, _Bool *const did_simplify)
...
unsigned int special_to_buf(int key, int modifiers, _Bool escape_ks, char_u *dst)
{
  unsigned int dlen = 0;
  ...
  if (((key) < 0)) {
    ...
    (__builtin_expect(!(after >= dst && (uintmax_t)(after - dst) <= (2147483647 *2U +1U)), 0) ? __assert_rtn(__func__, "keycodes.c", 599, "after >= dst && (uintmax_t)(after - dst) <= UINT_MAX") : (void)0);
...
# 617 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/keycodes.c"
int find_special_key(const char_u **const srcp, const size_t src_len, int *const modp,
                     const int flags, _Bool *const did_simplify)
  FUNC_ATTR_WARN_UNUSED_RESULT FUNC_ATTR_NONNULL_ARG(1, 3)
{
  ...
  const _Bool in_string = flags & FSK_IN_STRING;
  int modifiers;
  int bit;
  int key;
  uvarnumber_T n;
  ...
  for (bp = src + 1; bp <= end && (*bp == '-' || ascii_isident(*bp)); bp++) {
    ...
    if (end - bp > 3 && bp[0] == 't' && bp[1] == '_') {
      ...
      vim_str2nr((char *)bp + 5, ((void*)0), &l, STR2NR_ALL, ((void*)0), ((void*)0), 0, 1);
      if (l == 0) {
  ...
  if (bp <= end && *bp == '>') {
    ...
    if (bp >= last_dash) {
      if (strncasecmp((char *)(last_dash + 1), (char *)("char-"), (size_t)(5)) == 0
        ...
        vim_str2nr((char *)last_dash + 6, ((void*)0), &l, STR2NR_ALL, ((void*)0), &n, 0, 1);
        if (l == 0) {
          emsg(libintl_gettext((char *)(e_invarg)));
          return 0;
        }
...
# 814 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/keycodes.c"
...
# 873 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/keycodes.c"
char *replace_termcodes(const char *const from, const size_t from_len, char **const bufp,
                        const int flags, _Bool *const did_simplify, const int cpo_flags)
  FUNC_ATTR_NONNULL_ARG(1, 3)
{
  ...
  const _Bool do_backslash = !(cpo_flags & 0x01);
  const _Bool do_special = !(flags & REPTERM_NO_SPECIAL);

  _Bool allocated = (*bufp == ((void*)0));
...
# 1024 "/Users/foxacid/ghq/github.com/foxacid7cd/Nims/Targets/libNims/src/nvim/keycodes.c"
...
void log_key(int log_level, int key)
{
  ...
  logmsg((log_level), ((void*)0), __func__, 1096, 1, "input: %s", keyname);
}
