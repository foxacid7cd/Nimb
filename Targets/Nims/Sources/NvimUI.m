...
- (void) grid:(int64_t)grid rawLineWithRow:(int64_t)row startColumn:(int64_t)startColumn endColumn:(int64_t)endColumn
  clearColumn:(int64_t)clearColumn clearAttribute:(int64_t) clearAttribute flags:(int64_t)flags chunk:(void *)chunk attributes:(void *)attributes {
