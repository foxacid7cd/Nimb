...
//{
//  NvimUI *object = (__bridge NvimUI *)ui->data;
//  [object grid:grid resizeWithWidth:width height:height];
//}
//
//void nims_ui_grid_clear(UI *ui, Integer grid)
//{
//  NvimUI *object = (__bridge NvimUI *)ui->data;
//  [object clearGrid:grid];
//}
//
//void nims_ui_grid_cursor_goto(UI *ui, Integer grid, Integer row, Integer col)
//{
//  NvimUI *object = (__bridge NvimUI *)ui->data;
//  [object grid:grid cursorGoToRow:row column:col];
//}
//
//void nims_ui_grid_scroll(UI *ui, Integer grid, Integer top, Integer bot, Integer left, Integer right, Integer rows, Integer cols)
//{
//  NvimUI *object = (__bridge NvimUI *)ui->data;
//  [object grid:grid scrollWithTop:top left:left right:right rows:rows columns:cols];
//}
//
...
//{
//  NvimUI *object = (__bridge NvimUI *)ui->data;
//  [object grid:grid rawLineWithRow:row startColumn:startcol endColumn:endcol clearColumn:clearcol clearAttribute:clearattr flags:flags chunk:chunk attributes:attrs];
//}
//
...
//{}
//
//static void nims_ui_scheduler(Event event, void *data)
//{
//  NvimUI *object = (__bridge NvimUI *)data;
//  Loop *loop = [[object data] loop];
//  loop_schedule_fast(loop, event);
//}
//
...
//  loop_init(&loop, NULL);
//
//  NvimUIData *data = [[NvimUIData alloc] initWithBridge:bridge andLoop:&loop];
//  [object setData:data];
//
//  CONTINUE(bridge);
//
...
void nims_ui_attach(NvimUI *object)
{
